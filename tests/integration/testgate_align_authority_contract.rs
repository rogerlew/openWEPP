...
const CONTRACTS: &[(&str, &str, &str, &str, &str)] = &[
    ...
    (
        ...
        "stage-receipt-heavy.json",
        "openwepp:gate-policy:stage-receipt:1",
        "openwepp-gate-stage-receipt-v1",
    ),
    (
        "package-audit",
        "package-audit.schema.json",
        "package-audit-unknown-state.json",
        "openwepp:gate-policy:package-audit:1",
        "openwepp-package-audit-v1",
    ),
    (
        "pre-heavy-audit",
        "pre-heavy-audit.schema.json",
        "pre-heavy-audit-waived.json",
        "openwepp:gate-policy:pre-heavy-audit:1",
        "openwepp-pre-heavy-audit-v1",
    ),
    (
        "workflow-qualification",
        "workflow-qualification.schema.json",
        "workflow-qualification-waived.json",
        "openwepp:gate-policy:workflow-qualification:1",
        "openwepp-testgate-workflow-qualification-v1",
    ),
    (
        "workflow-qualification-subject-freeze",
        "workflow-qualification-subject-freeze.schema.json",
        "workflow-qualification-subject-freeze-traversal.json",
        "openwepp:gate-policy:workflow-qualification-subject-freeze:1",
        "openwepp-testgate-subject-freeze-v1",
    ),
    (
        "workflow-qualification-controller",
        "workflow-qualification-controller.schema.json",
        "workflow-qualification-controller-negative-spawn.json",
        "openwepp:gate-policy:workflow-qualification-controller:1",
        "openwepp-testgate-qualification-controller-v1",
    ),
    (
