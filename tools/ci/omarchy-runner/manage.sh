...
readonly EXPECTED_IMAGE_ID="sha256:8bd3a534015517ec14912ad8c06eda59586e39829c5f7037cc1912fe94912c9a"
...
setup_runner() {
  ...
  remote docker run --detach --name "${CONTAINER}" --restart unless-stopped \
    ...
    --tmpfs "/cache/target:rw,nosuid,nodev,size=8g,uid=10001,gid=10001,mode=0700" \
