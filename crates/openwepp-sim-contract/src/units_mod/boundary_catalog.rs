...
pub fn hphys0274_required_boundary_aliases() -> &'static [&'static str] {
    &[
        ...
        "surface_liquid.ofe_area_m2",
        "surface_liquid.interval_s",
        "Dp",
        "hillslope_wat.Dp",
        "Pe",
        "UpStrmQ",
        ...
        "snow.layer.mass_swe_m",
        "snow.layer.thickness_m",
        "snow.routed_melt_m",
...
pub fn canonical_boundary_unit_entries() -> Vec<BoundaryUnitEntry> {
    use DimensionClass::{
        Area, Count, Density, Depth, Direction, EnergyPerArea, Fraction, HydraulicConductivity,
        MassPerArea, RadiationDaily, RadiationHourly, Rate, Temperature, Time, Unitless,
        VolumetricWaterContent, WindSpeed,
    };
    use DomainClass::{
    ...
    vec![
        BoundaryUnitEntry::new(
            "surface_liquid.store_mass",
            &["surface_liquid.liquid_kg_m2_tile"],
            "kg H2O m^-2 tile-ground",
            MassPerArea,
            NonNegativeFinite,
            "openwepp-hillslope-orchestrator",
            "openwepp-land-surface-energy",
            "SC-SURFACELIQUID-001",
            "SC-SURFACELIQUID-001#INV-SURFACELIQUID-001",
            TypedRequired,
            None,
            &[],
        ),
        BoundaryUnitEntry::new(
            "surface_liquid.store_capacity",
            &["surface_liquid.capacity_kg_m2_tile"],
            "kg H2O m^-2 tile-ground",
            MassPerArea,
            PositiveFinite,
        ...
        BoundaryUnitEntry::new(
            "surface_liquid.resource_amount",
            &["surface_liquid.amount_kg_m2_ofe_ground"],
            "kg H2O m^-2 OFE-ground interval",
            MassPerArea,
            NonNegativeFinite,
            "openwepp-land-surface-energy",
            "openwepp-hillslope-orchestrator",
            "SC-SURFACELIQUID-001",
            "SC-SURFACELIQUID-001#INV-SURFACELIQUID-004",
            TypedRequired,
            None,
            &[],
        ),
        BoundaryUnitEntry::new(
            "surface_liquid.condensation_credit",
            &["surface_liquid.condensation_kg_m2_ofe_ground"],
            "kg H2O m^-2 OFE-ground interval",
            MassPerArea,
            NonNegativeFinite,
        ...
        BoundaryUnitEntry::new(
            "surface_liquid.parcel_mass",
            &["surface_liquid.parcel_mass_kg_m2_basis_ofe"],
            "kg H2O m^-2 basis-OFE-ground",
            MassPerArea,
            NonNegativeFinite,
            "openwepp-hillslope-orchestrator",
            "openwepp-hillslope-orchestrator",
            "SC-SURFACELIQUID-001",
            "SC-SURFACELIQUID-001#INV-SURFACELIQUID-008",
            TypedRequired,
            None,
            &[],
        ),
        BoundaryUnitEntry::new(
            "surface_liquid.parcel_temperature",
            &["surface_liquid.parcel_temperature_k"],
            "K",
            Temperature,
            PositiveFinite,
        ...
        BoundaryUnitEntry::new(
            "surface_liquid.parcel_enthalpy",
            &["surface_liquid.parcel_enthalpy_j_m2_basis_ofe"],
            "J m^-2 basis-OFE-ground",
            EnergyPerArea,
            SignedFinite,
            "openwepp-hillslope-orchestrator",
            "openwepp-land-surface-energy",
        ...
        BoundaryUnitEntry::new(
            ...
            "openwepp-hillslope-orchestrator",
            "SC-SURFACELIQUID-001",
            "SC-SURFACELIQUID-001#INV-SURFACELIQUID-007",
            TypedRequired,
            None,
            &[],
        ),
        BoundaryUnitEntry::new(
            "surface_liquid.interval",
            &["surface_liquid.interval_s"],
            "s",
            Time,
            PositiveFinite,
            ...
            "openwepp-hillslope-orchestrator",
            "SC-SURFACELIQUID-001",
            "SC-SURFACELIQUID-001#INV-SURFACELIQUID-006",
            TypedRequired,
            None,
            &[],
        ),
        ...
        BoundaryUnitEntry::new(
            ...
            "snow density and Stage 3 consumers",
            "SC-SNOWENERGY-001",
            "SC-SNOWENERGY-001#INV-SNOWENERGY-027",
            ScalarException,
            Some(
                "typed DirectSnowLayerState vector element; named SWE-to-area-mass conversion governs lifecycle selection",
            ),
            &[],
        ),
        BoundaryUnitEntry::new(
            ...
            "SC-SNOWENERGY-001#INV-SNOWENERGY-027",
            ScalarException,
            Some("typed DirectSnowLayerState vector element with aggregate closure guard"),
            &[],
        ),
        BoundaryUnitEntry::new(
            "snow_hourly_rain",
