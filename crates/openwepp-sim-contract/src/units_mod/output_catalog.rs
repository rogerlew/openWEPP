...
pub fn canonical_output_unit_entries() -> Vec<OutputUnitEntry> {
    ...
    vec![
        OutputUnitEntry::publication_only(
            ...
            PUB_ONLY,
            "SC-OUTPUT-WAT5-001",
            "SC-OUTPUT-WAT5-001#INV-WAT5-002",
        ),
        OutputUnitEntry::publication_only(
            "hillslope_wat_subhourly",
            "interval_duration_s",
        ...
        OutputUnitEntry::publication_only(
            ...
            PUB_ONLY,
            "SC-OUTPUT-WAT5-001",
            "SC-OUTPUT-WAT5-001#INV-WAT5-003",
        ),
        OutputUnitEntry::publication_only(
            "hillslope_wat_subhourly",
        ...
        OutputUnitEntry::publication_only(
            ...
            PUB_ONLY,
            "SC-OUTPUT-WAT5-001",
            "SC-OUTPUT-WAT5-001#INV-WAT5-004",
        ),
        OutputUnitEntry::publication_only(
            "hillslope_wat_subhourly",
        ...
        OutputUnitEntry::publication_only(
            ...
            PUB_ONLY,
            "SC-OUTPUT-WAT5-001",
            "SC-OUTPUT-WAT5-001#INV-WAT5-005",
        ),
        OutputUnitEntry::publication_only(
            "hillslope_wat_subhourly",
        ...
        OutputUnitEntry::publication_only(
            ...
            PUB_ONLY,
            "SC-OUTPUT-WAT5-001",
            "SC-OUTPUT-WAT5-001#INV-WAT5-007",
        ),
        OutputUnitEntry::publication_only(
            "hillslope_wat_subhourly",
        ...
        OutputUnitEntry::publication_only(
            ...
            "sbrunv",
            "m^3",
            "publication output converts outlet lateral/subsurface depth to volume using outlet OFE area",
            "SC-SUBHYD-001",
