...
const ADAPTIVE_COMPOSITIONAL_STAGE3_MODEL_ID: &str = "adaptive_compositional_stage3_v1";
...
pub enum SnowMeltModel {
    /// Sole production Stage-3 operator. Liquid/energy transitions are owned
    /// by the adaptive complete-owner evaluator, not a CoE daily melt model.
    AdaptiveCompositionalStage3V1,
    LegacyCoe,
...
impl SnowMeltModel {
    ...
    pub const fn id(self) -> &'static str {
        match self {
            Self::AdaptiveCompositionalStage3V1 => ADAPTIVE_COMPOSITIONAL_STAGE3_MODEL_ID,
...
fn brock2000_temperature_age_albedo(
    ...
    let alpha_deep = BROCK2000_DEEP_INTERCEPT - BROCK2000_DEEP_LOG_COEFFICIENT * ta_for_log.log10();
