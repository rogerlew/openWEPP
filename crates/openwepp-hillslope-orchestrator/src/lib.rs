...
const WB17_STAGE_SYMBOL_S1: &str = "s1";
const WB17_STAGE_SYMBOL_S2: &str = "s2";
const WB17_STAGE_SYMBOL_TU: &str = "tu";
const WB17_STAGE_SYMBOL_TV: &str = "tv";
const WB17_FLUX_SYMBOL_ETP: &str = "Etp";
const WB17_FLUX_SYMBOL_UPI: &str = "UPi";
const WB17_FLUX_SYMBOL_UI: &str = "Ui";
const WB13_STATE_SYMBOL_WATCON: &str = "watcon";
const WB13_STATE_SYMBOL_TOTAL_SOIL: &str = "Total-Soil";
const WB13_STATE_SYMBOL_SOIL_WATER_TOTAL: &str = "SoilWaterTotal";
const WB17_STAGE_ONE_DEFICIT_SCALE: f64 = 0.4;
const WB17_STAGE_TWO_DEFICIT_SCALE: f64 = 0.6;
const WB17_STAGE_TWO_DENOMINATOR: f64 = 0.0035;
const WB13_DEPTH_TO_MM: f64 = 1000.0;
...
const EROD14_SYMBOL_WAVE2_ENABLED: &str = "erod14_wave2_enabled";
const EROD14_SYMBOL_CLASS_COUNT: &str = "erod14_class_count";
const EROD14_SYMBOL_XTOP: &str = "erod14_xtop";
const EROD14_SYMBOL_XBOT: &str = "erod14_xbot";
const EROD14_SYMBOL_XDETST: &str = "erod14_xdetst";
const EROD14_SYMBOL_LDTOP: &str = "erod14_ldtop";
const EROD14_SYMBOL_LDBOT: &str = "erod14_ldbot";
const EROD14_SYMBOL_LDDEND: &str = "erod14_lddend";
const EROD14_SYMBOL_QOUT: &str = "erod14_qout";
const EROD14_SYMBOL_QIN: &str = "erod14_qin";
const EROD14_SYMBOL_QOSTAR: &str = "erod14_qostar";
const EROD14_SYMBOL_SLP_LEN: &str = "erod14_slplen";
const EROD14_SYMBOL_KTRATO: &str = "erod14_ktrato";
const EROD14_SYMBOL_AINTC: &str = "erod14_ainftc";
const EROD14_SYMBOL_BINTC: &str = "erod14_binftc";
const EROD14_SYMBOL_CINTC: &str = "erod14_cinftc";
const EROD14_SYMBOL_BETA: &str = "erod14_beta";
const EROD14_SYMBOL_QJ_MINUS_1: &str = "erod14_Qj_minus_1";
const EROD14_SYMBOL_VJ: &str = "erod14_Vj";
const EROD14_SYMBOL_QJ: &str = "erod14_Qj";
const EROD14_SYMBOL_FH: &str = "erod14_Fh";
const EROD14_SYMBOL_FP: &str = "erod14_Fp";
const EROD14_SYMBOL_CASE: &str = "erod14_case";
const EROD14_SYMBOL_SUMG: &str = "erod14_sumg";
const EROD14_SYMBOL_ER: &str = "ER";
const EROD14_SYMBOL_SSA_SOIL: &str = "erod14_ssa_soil";
const EROD14_ROOT_FALL: &str = "erod14_fall";
const EROD14_ROOT_FRCFLW: &str = "erod14_frcflw";
const EROD14_ROOT_FRAC: &str = "erod14_frac";
const EROD14_ROOT_FIDEL: &str = "erod14_fidel";
const EROD14_ROOT_TCF1: &str = "erod14_tcf1";
const EROD14_ROOT_SSA_CLASS: &str = "erod14_ssa_class";
...
const EROD14_MAX_PHI: f64 = 100_000.0;
const EROD14_MAX_REPROPORTION_ITERS: usize = 64;
