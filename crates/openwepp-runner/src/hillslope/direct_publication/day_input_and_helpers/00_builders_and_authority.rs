...
struct DirectProductionGrowthCropAuthority {
    ...
    forest_litter_forcing:
        Option<openwepp_input_contract::parsers::management::ForestSurfaceLitterForcing>,
}
...
include!("00e_native_canopy_trace.rs");
...
struct DirectProductionResidueCoverProjection {
    ...
    needle_litter_input_kg_m2: f64,
    fine_woody_litter_input_kg_m2: f64,
...
fn direct_production_typed_growth_crop_authority(
    ...
    Ok(DirectProductionGrowthCropAuthority {
        ...
        forest_litter_forcing: management_projection
            .forest_litter_forcing
