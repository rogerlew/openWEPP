...
"#;
    ...
    let (report, _temp_run_dir) = execute_fixture_with_runfile_report(runfile, "simimpl04_simpipe");
    ...
    assert_json_string(
        &manifest_json,
        "/execution_provenance/simpipe_guard_id",
        "HS-SIMPIPE-E-001",
    );
}
...
fn execute_fixture_with_runfile_report(
    ...
    .expect("fixture run should succeed before provenance assertions");
