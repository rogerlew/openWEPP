...
pub use v2::{
    ...
    V2ReceiptReportRoots, V2RecoveryAction, V2ReleaseIdentity, V2ReleaseVerification, V2ReportPlan,
    V2ReportSummary, V2Repository, V2ReviewRoots, V2TrustDomain, V2ValidationSummary, admit_report,
    ...
    amend_principal_at_generation, amend_role, amend_role_at_generation, copy_v2_test_fixture,
    inspect_report, rebind_implementation, rebind_invalid_v2_test_fixture, rebind_v2_test_fixture,
