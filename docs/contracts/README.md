...
| openWEPP runner boundary | [openwepp-runner-contract.md](openwepp-runner-contract.md) | openWEPP owns in-repo `open_wepp_runner`; engine selection is explicit (`legacy_wepp` vs `openwepp`); no silent fallback across engines/contracts. |
