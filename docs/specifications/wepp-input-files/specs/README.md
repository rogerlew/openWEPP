# openWEPP WEPP Input Specs

This directory contains the openWEPP-owned canonical specifications for legacy WEPP text input files.

Current scope:
- climate station statistics (`cligenparms.md`)
