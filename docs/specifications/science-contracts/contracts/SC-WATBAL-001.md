...
| `ARCH22-TYPED-PRODUCTION-SURFACE-ADDENDUM` | `lines 1896-1916` `ARCH22 Typed Production-Surface Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL03-PRODUCTION-EXECUTION-OWNERSHIP-AND-INTAKE-GUARDRAIL-ADDENDUM` | `lines 1917-1948` `SIMIMPL03 Production Execution Ownership and Intake Guardrail Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `EROD13-WAVE-1-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `lines 1949-1961` `EROD13 Wave-1 Active Producer-Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `EROD14-WAVE-2-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `lines 1962-1975` `EROD14 Wave-2 Active Producer-Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL14-CONTINUOUS-RUNNER-AND-WB13-SPAN-KEY-ADDENDUM` | `lines 1976-1991` `SIMIMPL14 Continuous Runner and WB13 Span/Key Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL15-REPLAY-COMPARATOR-TOOLING-ALIGNMENT-ADDENDUM` | `lines 1992-2009` `SIMIMPL15 Replay Comparator Tooling Alignment Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL16-REPLAY-CONTRACT-DERIVED-TEST-COVERAGE-CLOSURE-ADDENDUM` | `lines 2010-2023` `SIMIMPL16 Replay Contract-Derived Test-Coverage Closure Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL18-RAIN-SNOW-PARTITION-AND-STORAGE-STATE-MUTATION-CLOSURE-ADDENDU` | `lines 2024-2039` `SIMIMPL18 Rain/Snow Partition and Storage-State Mutation Closure Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `SIMIMPL21-WB11-ET-SOIL-WATER-BASELINE-ORDERING-AND-LINEAGE-ADDENDUM` | `lines 2040-2055` `SIMIMPL21 WB11 ET/Soil-Water Baseline Ordering and Lineage Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
