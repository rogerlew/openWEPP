...
| `HPHYS0299-WATER-BALANCE-UNIT-PROVENANCE-ADDENDUM` | `lines 307-315` `HPHYS0299 Water-Balance Unit/Provenance Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0300-WATER-BALANCE-RAW-POST-RAW-ADDENDUM` | `lines 316-333` `HPHYS0300 Water-Balance Raw/Post-Raw Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0301-H39-RAIN-RELEASE-WATER-BALANCE-ADDENDUM` | `lines 334-344` `HPHYS0301 H39 Rain-Release Water-Balance Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0302-COMPARATOR-SURFACE-WATER-BALANCE-ADDENDUM` | `lines 345-355` `HPHYS0302 Comparator-Surface Water-Balance Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0305-PAIRED-MELT-TERM-STATE-ADDENDUM` | `lines 356-370` `HPHYS0305 Paired Melt-Term/State Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0306-BRANCH-ACTIVE-MELT-TERM-OBSERVE-ADDENDUM` | `lines 371-390` `HPHYS0306 Branch-Active Melt-Term Observe Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0307-MELT-CALL-BRANCH-ACTIVATION-LINEAGE-ADDENDUM` | `lines 391-410` `HPHYS0307 Melt-Call Branch Activation Lineage Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0308-BRANCH-EXTRA-STATE-ORDERING-ADDENDUM` | `lines 411-607` `HPHYS0308 Branch-Extra State-Ordering Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0202-PROFILEFC-PROFILEWP-LAYER-AGGREGATION-LINEAGE-CLOSURE-HISTORIC` | `lines 1481-1497` `HPHYS0202 ProfileFC/ProfileWP Layer-Aggregation Lineage Closure (Historical)` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0205-CORRECTED-LAYER-AUTHORITY-CLOSURE-HISTORICAL` | `lines 1498-1518` `HPHYS0205 Corrected-Layer Authority Closure (Historical)` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0206-CORRECTED-LAYER-NORMALIZATION-AND-MAPPING-CLOSURE-HISTORICAL` | `lines 1519-1540` `HPHYS0206 Corrected-Layer Normalization and Mapping Closure (Historical)` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0216-PROFILEFC-LAYER-AUTHORITY-REALIGNMENT` | `lines 1563-1582` `HPHYS0216 ProfileFC Layer-Authority Realignment` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0216D-PROFILEFC-LAYER-TAIL-AUTHORITY-RECONCILIATION` | `lines 1583-1600` `HPHYS0216D ProfileFC Layer+Tail Authority Reconciliation` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
