...
| `EROD14-WAVE-2-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `lines 1962-1975` `EROD14 Wave-2 Active Producer-Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT03 batch 6 narrower HOLD: Wave-2 runoff/runon producer-coupling exports are live cross-domain obligations. Owner: SCSTRUCT03-EROD14-BEI-PROMOTION. Next gate: promote/map WATBAL producer and SED consumer binding IDs before relocation. |
