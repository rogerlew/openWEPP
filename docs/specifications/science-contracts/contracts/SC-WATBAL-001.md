...
| `WB12-RECONCILIATION-AUTHORITY-ADDENDUM` | `lines 901-913` `WB12 Reconciliation Authority Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB12-DETERMINISTIC-RECONCILIATION-RULES` | `lines 914-952` `WB12 Deterministic Reconciliation Rules` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `CLIM05-SNOW-COUPLED-RECONCILIATION-ADDENDUM` | `lines 953-954` `CLIM05 Snow-Coupled Reconciliation Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `CLIM05-REQUIRED-COUPLING-SURFACE` | `lines 955-960` `CLIM05 Required Coupling Surface` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `CLIM05-DETERMINISTIC-COUPLING-RULE` | `lines 961-977` `CLIM05 Deterministic Coupling Rule` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `CLIM06-REQUIRED-COUPLING-SURFACES` | `lines 980-987` `CLIM06 Required Coupling Surfaces` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `CLIM06-DETERMINISTIC-COUPLING-RULES` | `lines 988-1021` `CLIM06 Deterministic Coupling Rules` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `WB14-REQUIRED-COUPLING-SURFACES` | `lines 1024-1033` `WB14 Required Coupling Surfaces` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB14-DETERMINISTIC-COUPLING-RULES` | `lines 1034-1096` `WB14 Deterministic Coupling Rules` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB15-CANOPY-INTERCEPTION-COUPLING-ADDENDUM` | `lines 1097-1098` `WB15 Canopy Interception Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB15-REQUIRED-COUPLING-SURFACES` | `lines 1099-1106` `WB15 Required Coupling Surfaces` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB15-DETERMINISTIC-COUPLING-RULES` | `lines 1107-1163` `WB15 Deterministic Coupling Rules` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `IRRIG10-IRRIGATION-STORAGE-COUPLING-ADDENDUM` | `lines 1164-1165` `IRRIG10 Irrigation Storage-Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `IRRIG10-REQUIRED-COUPLING-SURFACES` | `lines 1166-1201` `IRRIG10 Required Coupling Surfaces` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB16-PEAK-RUNOFF-CLOSURE-DIAGNOSTICS-ADDENDUM` | `lines 1202-1203` `WB16 Peak Runoff Closure-Diagnostics Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `WB16-REQUIRED-COUPLING-SURFACES` | `lines 1204-1307` `WB16 Required Coupling Surfaces` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0218-WB19-DRFC-EQUIVALENT-THRESHOLD-CLOSURE-ADDENDUM` | `lines 1655-1670` `HPHYS0218 WB19 `drfc`-Equivalent Threshold Closure Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0221-WB19-WATER-YIELD-SATURATED-DEPTH-COUPLING-ADDENDUM` | `lines 1671-1694` `HPHYS0221 WB19 Water-Yield + Saturated-Depth Coupling Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0234-WB13-SUBSURFACE-FLUX-AUTHORITY-ANTI-SHADOW-ADDENDUM` | `lines 1774-1789` `HPHYS0234 WB13 Subsurface Flux-Authority Anti-Shadow Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0235-WB18-HOURLY-ITERATIVE-LANE-REANCHORING-ADDENDUM` | `lines 1790-1802` `HPHYS0235 WB18 Hourly Iterative-Lane Reanchoring Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0248-WB18-HOURLY-RESTRICTIVE-BOTTOM-ADDENDUM` | `lines 1803-1820` `HPHYS0248 WB18 Hourly Restrictive-Bottom Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0238-WB19-HOURLY-ITERATIVE-LATERAL-DRAINAGE-ADDENDUM` | `lines 2056-2068` `HPHYS0238 WB19 Hourly Iterative Lateral/Drainage Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0239-WB19-WB12-WB13-ORDERING-AND-FLUX-AUTHORITY-HANDOFF-ADDENDUM` | `lines 2069-2085` `HPHYS0239 WB19->WB12->WB13 Ordering and Flux-Authority Handoff Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0240-HOURLY-RUNOFF-CARRYOVER-ADDENDUM` | `lines 2086-2097` `HPHYS0240 Hourly Runoff Carryover Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0241-MOFE-HOURLY-CARRY-ARRAY-ROUTING-CONTINUITY-ADDENDUM` | `lines 2098-2121` `HPHYS0241 MOFE Hourly Carry-Array Routing Continuity Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0242-WB14-WB12-HOURLY-CADENCE-AND-ORDERING-ADDENDUM` | `lines 2122-2142` `HPHYS0242 WB14/WB12 Hourly Cadence and Ordering Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
...
| `HPHYS0256-WB19-LATQCC-LANE-BRANCH-ADDENDUM` | `lines 2280-2293` `HPHYS0256 WB19 Latqcc Lane-Branch Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0258-WB19-REALIZED-LATERAL-PUBLICATION-ADDENDUM` | `lines 2294-2309` `HPHYS0258 WB19 Realized Lateral Publication Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
| `HPHYS0259-WB19-TRACE-RESIDUAL-LOCALIZATION-ADDENDUM` | `lines 2310-2324` `HPHYS0259 WB19 Trace Residual Localization Addendum` | `active` | `undecidable` | `none` | `science-review-follow-on` | SCSTRUCT02 routed: binding status or precise canonical mapping requires science review; narrative remains in core and is not sidecar-eligible. |
