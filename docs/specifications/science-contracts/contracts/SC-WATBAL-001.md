...
| INV-WATBAL-057 | HPHYS0271 day-36 melt-forcing closure invariant: WB13 `RM`/`Snow-Water`, WB17 `Ep`, and aggregate-storage residual classifications for the H1 sim-day 36 snowpack break must consume `SC-SNOWFREEZE-001#INV-SNOWFREEZE-017` term-level melt and hourly-forcing evidence. Evidence that assigns day-36 residual ownership to publication, ET, storage, or negative-melt redistribution without proving the `melt.for` trigger/magnitude lineage is invalid. | governance-hold | INV-WATBAL-054, INV-WATBAL-055, INV-WATBAL-056, SC-SNOWFREEZE-001#INV-SNOWFREEZE-017, REF-WATBAL-CH5-BAL, REF-WATBAL-CH5-SNOW, REF-WATBAL-LEGACY-WB13 | `[DIRECT][Static] + [INFERENCE][Static]` |
...
| `INV-WATBAL-057` | governance | H1 day-36 melt-forcing classifier spanning WB13 `RM`/`Snow-Water`, raw/redistributed melt, `melt.for` terms, hourly forcing, and downstream `Ep`/storage context | Explicit `HOLD` when residual ownership is asserted without day-36 melt-term/hourly-forcing evidence; no WB17 `Ep`, aggregate-storage, WB13 publication, or negative-melt compensation edits | HPHYS0271 day-36 melt-forcing gate | `[DIRECT][Static] + [INFERENCE][Static]` |
