...
|---|---|---|---|---|---|---|
| `HPHYS0298-WATER-BALANCE-DISPOSITION-ADDENDUM` | `lines 282-306` `HPHYS0298 Water-Balance Disposition Addendum` | `active` | `maps-to-existing-INV` | `INV-WATBAL-087` | `none` | same-section invariant references provide a preliminary binding exposure map; relocation still requires conservation crosswalk |
| `HPHYS0299-WATER-BALANCE-UNIT-PROVENANCE-ADDENDUM` | `lines 307-315` `HPHYS0299 Water-Balance Unit/Provenance Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0300-WATER-BALANCE-RAW-POST-RAW-ADDENDUM` | `lines 316-333` `HPHYS0300 Water-Balance Raw/Post-Raw Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0301-H39-RAIN-RELEASE-WATER-BALANCE-ADDENDUM` | `lines 334-344` `HPHYS0301 H39 Rain-Release Water-Balance Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0302-COMPARATOR-SURFACE-WATER-BALANCE-ADDENDUM` | `lines 345-355` `HPHYS0302 Comparator-Surface Water-Balance Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0305-PAIRED-MELT-TERM-STATE-ADDENDUM` | `lines 356-370` `HPHYS0305 Paired Melt-Term/State Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0306-BRANCH-ACTIVE-MELT-TERM-OBSERVE-ADDENDUM` | `lines 371-390` `HPHYS0306 Branch-Active Melt-Term Observe Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0307-MELT-CALL-BRANCH-ACTIVATION-LINEAGE-ADDENDUM` | `lines 391-410` `HPHYS0307 Melt-Call Branch Activation Lineage Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0308-BRANCH-EXTRA-STATE-ORDERING-ADDENDUM` | `lines 411-607` `HPHYS0308 Branch-Extra State-Ordering Addendum` | `active` | `undecidable` | `none` | `semantic-map-required` | section includes 94 invariant tokens, likely from reproduced guard/index material; broad scrape is not a precise binding map |
| `EROD12-CROSS-DOMAIN-OWNERSHIP-AND-GUARD-CLOSURE-ADDENDUM` | `lines 608-900` `EROD12 Cross-Domain Ownership and Guard Closure Addendum` | `active` | `undecidable` | `none` | `semantic-map-required` | section includes 24 invariant tokens, likely from reproduced guard/index material; broad scrape is not a precise binding map |
| `WB12-RECONCILIATION-AUTHORITY-ADDENDUM` | `lines 901-913` `WB12 Reconciliation Authority Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB12-DETERMINISTIC-RECONCILIATION-RULES` | `lines 914-952` `WB12 Deterministic Reconciliation Rules` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM05-SNOW-COUPLED-RECONCILIATION-ADDENDUM` | `lines 953-954` `CLIM05 Snow-Coupled Reconciliation Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM05-REQUIRED-COUPLING-SURFACE` | `lines 955-960` `CLIM05 Required Coupling Surface` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM05-DETERMINISTIC-COUPLING-RULE` | `lines 961-977` `CLIM05 Deterministic Coupling Rule` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM06-FROZEN-SOIL-INFILTRATION-COUPLING-ADDENDUM` | `lines 978-979` `CLIM06 Frozen-Soil Infiltration Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM06-REQUIRED-COUPLING-SURFACES` | `lines 980-987` `CLIM06 Required Coupling Surfaces` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `CLIM06-DETERMINISTIC-COUPLING-RULES` | `lines 988-1021` `CLIM06 Deterministic Coupling Rules` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB14-INFILTRATION-AND-HYETOGRAPH-COUPLING-ADDENDUM` | `lines 1022-1023` `WB14 Infiltration and Hyetograph Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB14-REQUIRED-COUPLING-SURFACES` | `lines 1024-1033` `WB14 Required Coupling Surfaces` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB14-DETERMINISTIC-COUPLING-RULES` | `lines 1034-1096` `WB14 Deterministic Coupling Rules` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB15-CANOPY-INTERCEPTION-COUPLING-ADDENDUM` | `lines 1097-1098` `WB15 Canopy Interception Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB15-REQUIRED-COUPLING-SURFACES` | `lines 1099-1106` `WB15 Required Coupling Surfaces` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB15-DETERMINISTIC-COUPLING-RULES` | `lines 1107-1163` `WB15 Deterministic Coupling Rules` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `IRRIG10-IRRIGATION-STORAGE-COUPLING-ADDENDUM` | `lines 1164-1165` `IRRIG10 Irrigation Storage-Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `IRRIG10-REQUIRED-COUPLING-SURFACES` | `lines 1166-1201` `IRRIG10 Required Coupling Surfaces` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB16-PEAK-RUNOFF-CLOSURE-DIAGNOSTICS-ADDENDUM` | `lines 1202-1203` `WB16 Peak Runoff Closure-Diagnostics Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `WB16-REQUIRED-COUPLING-SURFACES` | `lines 1204-1307` `WB16 Required Coupling Surfaces` | `historical` | `undecidable` | `none` | `science-review-follow-on` | heading/text says historical or superseded but no precise canonical binding IDs are exposed; do not relocate until semantically adjudicated |
| `WB13-DAILY-OUTPUT-SURFACE-AUTHORITY-ADDENDUM` | `lines 1308-1480` `WB13 Daily Output-Surface Authority Addendum` | `active` | `maps-to-existing-INV` | `INV-WATBAL-026, INV-WATBAL-029, INV-WATBAL-064` | `none` | same-section invariant references provide a preliminary binding exposure map; relocation still requires conservation crosswalk |
| `HPHYS0202-PROFILEFC-PROFILEWP-LAYER-AGGREGATION-LINEAGE-CLOSURE-HISTORIC` | `lines 1481-1497` `HPHYS0202 ProfileFC/ProfileWP Layer-Aggregation Lineage Closure (Historical)` | `historical` | `undecidable` | `none` | `science-review-follow-on` | heading/text says historical or superseded but no precise canonical binding IDs are exposed; do not relocate until semantically adjudicated |
| `HPHYS0205-CORRECTED-LAYER-AUTHORITY-CLOSURE-HISTORICAL` | `lines 1498-1518` `HPHYS0205 Corrected-Layer Authority Closure (Historical)` | `historical` | `undecidable` | `none` | `science-review-follow-on` | heading/text says historical or superseded but no precise canonical binding IDs are exposed; do not relocate until semantically adjudicated |
| `HPHYS0206-CORRECTED-LAYER-NORMALIZATION-AND-MAPPING-CLOSURE-HISTORICAL` | `lines 1519-1540` `HPHYS0206 Corrected-Layer Normalization and Mapping Closure (Historical)` | `historical` | `undecidable` | `none` | `science-review-follow-on` | heading/text says historical or superseded but no precise canonical binding IDs are exposed; do not relocate until semantically adjudicated |
| `HPHYS0207-FC-WP-DEPTH-AUTHORITY-AND-NORMALIZED-TAIL-CLOSURE` | `lines 1541-1562` `HPHYS0207 FC/WP Depth-Authority and Normalized-Tail Closure` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0216-PROFILEFC-LAYER-AUTHORITY-REALIGNMENT` | `lines 1563-1582` `HPHYS0216 ProfileFC Layer-Authority Realignment` | `historical` | `undecidable` | `none` | `science-review-follow-on` | heading/text says historical or superseded but no precise canonical binding IDs are exposed; do not relocate until semantically adjudicated |
| `HPHYS0216D-PROFILEFC-LAYER-TAIL-AUTHORITY-RECONCILIATION` | `lines 1583-1600` `HPHYS0216D ProfileFC Layer+Tail Authority Reconciliation` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0203-PHYSICS-ROBUSTNESS-VALIDATION-ADDENDUM` | `lines 1601-1624` `HPHYS0203 Physics-Robustness Validation Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0208-FC-THRESHOLD-COUPLED-RESIDUAL-CLOSURE-ADDENDUM` | `lines 1625-1654` `HPHYS0208 FC-Threshold Coupled Residual Closure Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0218-WB19-DRFC-EQUIVALENT-THRESHOLD-CLOSURE-ADDENDUM` | `lines 1655-1670` `HPHYS0218 WB19 `drfc`-Equivalent Threshold Closure Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0221-WB19-WATER-YIELD-SATURATED-DEPTH-COUPLING-ADDENDUM` | `lines 1671-1694` `HPHYS0221 WB19 Water-Yield + Saturated-Depth Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
...
| `HPHYS0224-WB19-REALIZED-WITHDRAWAL-SOIL-WATER-CAP-ADDENDUM` | `lines 1712-1728` `HPHYS0224 WB19 Realized-Withdrawal Soil-Water Cap Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0225-WB19-LAYER-POOL-AVAILABLE-CAP-AUTHORITY-ADDENDUM` | `lines 1729-1743` `HPHYS0225 WB19 Layer-Pool Available-Cap Authority Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0226-WB19-LATERAL-SATURATED-THICKNESS-RESPONSE-ADDENDUM` | `lines 1744-1756` `HPHYS0226 WB19 Lateral Saturated-Thickness Response Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0227-WB19-FC-WP-COCA-WATER-YIELD-COUPLING-ADDENDUM` | `lines 1757-1773` `HPHYS0227 WB19 FC/WP + COCA Water-Yield Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0234-WB13-SUBSURFACE-FLUX-AUTHORITY-ANTI-SHADOW-ADDENDUM` | `lines 1774-1789` `HPHYS0234 WB13 Subsurface Flux-Authority Anti-Shadow Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0235-WB18-HOURLY-ITERATIVE-LANE-REANCHORING-ADDENDUM` | `lines 1790-1802` `HPHYS0235 WB18 Hourly Iterative-Lane Reanchoring Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0248-WB18-HOURLY-RESTRICTIVE-BOTTOM-ADDENDUM` | `lines 1803-1820` `HPHYS0248 WB18 Hourly Restrictive-Bottom Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0209-PROFILEWP-NEAR-CLOSED-ADJUDICATION-ADDENDUM` | `lines 1821-1840` `HPHYS0209 ProfileWP Near-Closed Adjudication Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
...
| `MOFE04-MULTI-OFE-WB13-WAT-PUBLICATION-POLICY-ADDENDUM` | `lines 1864-1895` `MOFE04 Multi-OFE WB13/WAT Publication Policy Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `ARCH22-TYPED-PRODUCTION-SURFACE-ADDENDUM` | `lines 1896-1916` `ARCH22 Typed Production-Surface Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL03-PRODUCTION-EXECUTION-OWNERSHIP-AND-INTAKE-GUARDRAIL-ADDENDUM` | `lines 1917-1948` `SIMIMPL03 Production Execution Ownership and Intake Guardrail Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `EROD13-WAVE-1-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `lines 1949-1961` `EROD13 Wave-1 Active Producer-Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `EROD14-WAVE-2-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `lines 1962-1975` `EROD14 Wave-2 Active Producer-Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL14-CONTINUOUS-RUNNER-AND-WB13-SPAN-KEY-ADDENDUM` | `lines 1976-1991` `SIMIMPL14 Continuous Runner and WB13 Span/Key Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL15-REPLAY-COMPARATOR-TOOLING-ALIGNMENT-ADDENDUM` | `lines 1992-2009` `SIMIMPL15 Replay Comparator Tooling Alignment Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL16-REPLAY-CONTRACT-DERIVED-TEST-COVERAGE-CLOSURE-ADDENDUM` | `lines 2010-2023` `SIMIMPL16 Replay Contract-Derived Test-Coverage Closure Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL18-RAIN-SNOW-PARTITION-AND-STORAGE-STATE-MUTATION-CLOSURE-ADDENDU` | `lines 2024-2039` `SIMIMPL18 Rain/Snow Partition and Storage-State Mutation Closure Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `SIMIMPL21-WB11-ET-SOIL-WATER-BASELINE-ORDERING-AND-LINEAGE-ADDENDUM` | `lines 2040-2055` `SIMIMPL21 WB11 ET/Soil-Water Baseline Ordering and Lineage Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0238-WB19-HOURLY-ITERATIVE-LATERAL-DRAINAGE-ADDENDUM` | `lines 2056-2068` `HPHYS0238 WB19 Hourly Iterative Lateral/Drainage Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0239-WB19-WB12-WB13-ORDERING-AND-FLUX-AUTHORITY-HANDOFF-ADDENDUM` | `lines 2069-2085` `HPHYS0239 WB19->WB12->WB13 Ordering and Flux-Authority Handoff Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0240-HOURLY-RUNOFF-CARRYOVER-ADDENDUM` | `lines 2086-2097` `HPHYS0240 Hourly Runoff Carryover Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0241-MOFE-HOURLY-CARRY-ARRAY-ROUTING-CONTINUITY-ADDENDUM` | `lines 2098-2121` `HPHYS0241 MOFE Hourly Carry-Array Routing Continuity Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0242-WB14-WB12-HOURLY-CADENCE-AND-ORDERING-ADDENDUM` | `lines 2122-2142` `HPHYS0242 WB14/WB12 Hourly Cadence and Ordering Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
...
| `HPHYS0250-WB13-FINAL-EP-COUPLING-ADDENDUM` | `lines 2176-2189` `HPHYS0250 WB13 Final-Ep Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0251-SWU-UPTAKE-MAGNITUDE-COUPLING-ADDENDUM` | `lines 2190-2207` `HPHYS0251 SWU Uptake Magnitude Coupling Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0252-WB19-STORAGE-AVAILABILITY-CONTINUATION-ADDENDUM` | `lines 2208-2231` `HPHYS0252 WB19 Storage-Availability Continuation Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0254-WB11-INITIAL-STORAGE-PROJECTION-ADDENDUM` | `lines 2232-2255` `HPHYS0254 WB11 Initial-Storage Projection Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0255-MOFE-STORAGE-PROJECTION-ADDENDUM` | `lines 2256-2279` `HPHYS0255 MOFE Storage Projection Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0256-WB19-LATQCC-LANE-BRANCH-ADDENDUM` | `lines 2280-2293` `HPHYS0256 WB19 Latqcc Lane-Branch Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0258-WB19-REALIZED-LATERAL-PUBLICATION-ADDENDUM` | `lines 2294-2309` `HPHYS0258 WB19 Realized Lateral Publication Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0259-WB19-TRACE-RESIDUAL-LOCALIZATION-ADDENDUM` | `lines 2310-2324` `HPHYS0259 WB19 Trace Residual Localization Addendum` | `active` | `unpromoted-binding` | `none` | `flagged-binding-addition-or-semantic-map-required` | binding-language section lacks same-section canonical WATBAL binding IDs; retained in core pending Phase 2 mapping/promotion |
| `HPHYS0260-WB17-WB18-STORAGE-TRACE-RESIDUAL-LOCALIZATION-ADDENDUM` | `lines 2325-2504` `HPHYS0260 WB17/WB18/Storage Trace Residual Localization Addendum` | `active` | `undecidable` | `none` | `semantic-map-required` | section includes 63 invariant tokens, likely from reproduced guard/index material; broad scrape is not a precise binding map |
