...
| Channel per-node controls | `ws10_channel_{id}_chnn`, `ws10_channel_{id}_ctlslp`, `ws10_channel_{id}_chnk`, `ws10_channel_{id}_icntrl`, `ws10_channel_{id}_flgout` |
