...
- OBL-SNOWFREEZE-C-013: The v131 plausibility consumer must independently
  ...
  block persistence. No production/public consumer may read the evidence.
  `[INFERENCE][Static]`
