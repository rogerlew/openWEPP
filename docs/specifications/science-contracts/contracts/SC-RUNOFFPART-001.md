...
| `EROD14-WAVE-2-ACTIVE-PRODUCER-COUPLING-ADDENDUM` | `SC-RUNOFFPART-001.md#erod14-wave-2-active-producer-coupling-addendum` | `active` | `maps-to-existing-INV` | `INV-RUNOFFPART-007, INV-RUNOFFPART-008, INV-RUNOFFPART-009` | `none` | SCSTRUCT09 map-in-core: Wave-2 multi-OFE producer surfaces map to case-classification, aggregation, and coupling invariants; enrichment transition context remains active core detail. |
