...
last_updated_utc: 2026-07-19T00:00:00Z
---
...
| `INV-MANAGEMENT-YAML-006` | Every native forest declares a complete `generalized_gsi_v1` phenology block; schema/parser/runtime projection preserves exact values and fails closed on missing, partial, non-finite, unordered, or out-of-domain operands. | schema + adapter + PL projection | Typed validation failure before native forest runtime activation. | `E-RUST-SCHEMA-01`, `E-RUST-ADAPTER-01`, `SC-PLANT-001#INV-PLANT-033` |
