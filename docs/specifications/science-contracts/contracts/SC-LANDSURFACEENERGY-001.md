...
|SC-LANDSURFACEENERGY-001/nonlinear-solve.md|normative|admission|selected|
...
|SC-LANDSURFACEENERGY-001/qualification.md|normative|physical capture|selected|
...
|Executable identity|identity verification|[qualification](SC-LANDSURFACEENERGY-001/replay-evidence.md#qualification)|Frozen capture protocol; scientific claims expand physics/closure.|
|Frozen-litter closure|closure review|[physical capture](SC-LANDSURFACEENERGY-001/qualification.md#qualification)|Physical operands, errors, support and receipt origin; implementation expands full evaluator/solver.|
...
<a id="change-log"></a>
## Change Log
2026-09-25 v39: accepted `COLD-CANOPY-M1-TR-SVD-BVLS-02` finite-precision active-face amendment after distinct independent correctness and QA review; it preserves `01` as historical evidence and defines a premeasurement, scale-aware all-coordinate approximate-KKT test for the detached diagnostic only. Production HOLD.
