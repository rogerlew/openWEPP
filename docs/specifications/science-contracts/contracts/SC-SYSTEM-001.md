...
Status: `phase1-triage-deferred`
Evidence mode: `Static`

This index is intentionally conservative. It does not relocate addendum
narrative. Rows routed to `science-review-follow-on` are retained in the binding
core and block sidecar consolidation until semantic mapping, flagged binding
promotion, or science-review follow-on resolves them. This preserves binding
semantics by failing closed rather than moving live obligations to a non-binding
sidecar.

| Entry ID | Source | Status | Binding classification | Canonical binding IDs | Review gate | Notes |
|---|---|---|---|---|---|---|
| `WS11-CHANNEL-ROUTING-PHYSICS-EQUIVALENCE-INTEGRATION-ADDENDUM` | `lines 426-493` `WS11 Channel-Routing Physics-Equivalence Integration Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: section carries WS11 routing, guard, and test-vector obligations but no same-section `INV-SYSTEM-*`/`OBL-SYSTEM-*` reference. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map to precise existing binding IDs or promote explicit system binding authority before relocation. |
| `WS12-IMPOUNDMENT-PHYSICS-EQUIVALENCE-INTEGRATION-ADDENDUM` | `lines 494-533` `WS12 Impoundment Physics-Equivalence Integration Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: section carries WS12 impoundment continuity, guard, and vector obligations but no same-section `INV-SYSTEM-*`/`OBL-SYSTEM-*` reference. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `ARCH22-TYPED-PRODUCTION-SURFACE-ADDENDUM` | `lines 534-555` `ARCH22 Typed Production-Surface Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: typed production-surface migration obligations lack a same-section system binding ID. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `EROD12-CROSS-DOMAIN-OWNERSHIP-AND-GUARD-CLOSURE-ADDENDUM` | `lines 556-563` `EROD12 Cross-Domain Ownership and Guard Closure Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: cross-domain ownership and guard-closure table carries active boundary obligations without same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL03-PRODUCTION-RUNNER-AND-PUBLICATION-PROVENANCE-ADDENDUM` | `lines 564-587` `SIMIMPL03 Production Runner and Publication-Provenance Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: execution ownership, provenance, and consolidated-intake governance rules lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL14-CONTINUOUS-REPLAY-SPAN-AND-KEY-DOMAIN-ADDENDUM` | `lines 588-601` `SIMIMPL14 Continuous Replay-Span and Key-Domain Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: replay-span/key-domain obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL15-REPLAY-COMPARATOR-TOOLING-ALIGNMENT-ADDENDUM` | `lines 602-617` `SIMIMPL15 Replay Comparator Tooling Alignment Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: replay policy, candidate-source, and semantic-alias obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL16-REPLAY-CONTRACT-DERIVED-TEST-COVERAGE-CLOSURE-ADDENDUM` | `lines 618-630` `SIMIMPL16 Replay Contract-Derived Test-Coverage Closure Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: replay test-coverage closure obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL18-BASELINE-YEAR-POLICY-AND-PRECIPITATION-SPAN-CLOSURE-ADDENDUM` | `lines 631-644` `SIMIMPL18 Baseline-Year Policy and Precipitation-Span Closure Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: baseline-year policy and full-span precipitation obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `SIMIMPL21-WB13-ET-SOIL-WATER-PUBLICATION-LINEAGE-ADDENDUM` | `lines 645-659` `SIMIMPL21 WB13 ET/Soil-Water Publication Lineage Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: WB13 ET/soil-water publication-lineage obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0202-WB13-PROFILE-FC-WP-PUBLICATION-LINEAGE-ADDENDUM-HISTORICAL` | `lines 660-673` `HPHYS0202 WB13 Profile FC/WP Publication-Lineage Addendum (Historical)` | `historical` | `historical-or-superseded` | `none` | `science-review-follow-on` | SCSTRUCT04: heading marks this row historical, but the row lacks a same-section system binding ID mapping. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: confirm historical residue mapping before any relocation. |
| `HPHYS0205-CORRECTED-LAYER-PROJECTION-ADDENDUM-HISTORICAL` | `lines 674-688` `HPHYS0205 Corrected-Layer Projection Addendum (Historical)` | `historical` | `historical-or-superseded` | `none` | `science-review-follow-on` | SCSTRUCT04: heading marks this row historical, but the row lacks a same-section system binding ID mapping. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: confirm historical residue mapping before any relocation. |
| `HPHYS0206-NORMALIZED-LAYER-MAPPING-AND-FAIL-CLOSED-ADDENDUM-HISTORICAL` | `lines 689-703` `HPHYS0206 Normalized-Layer Mapping and Fail-Closed Addendum (Historical)` | `historical` | `historical-or-superseded` | `none` | `science-review-follow-on` | SCSTRUCT04: heading marks this row historical, but the row lacks a same-section system binding ID mapping. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: confirm historical residue mapping before any relocation. |
| `HPHYS0207-NORMALIZED-PROFILE-FC-WP-DEPTH-AUTHORITY-ADDENDUM` | `lines 704-718` `HPHYS0207 Normalized-Profile FC/WP Depth-Authority Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: profile FC/WP depth-authority obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0216D-PROFILEFC-LAYER-TAIL-BOUNDARY-AUTHORITY-ADDENDUM` | `lines 719-733` `HPHYS0216D ProfileFC Layer+Tail Boundary Authority Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: profile FC layer+tail boundary obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0203-WB13-ROBUSTNESS-GOVERNANCE-ADDENDUM` | `lines 734-748` `HPHYS0203 WB13 Robustness Governance Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: WB13 robustness governance obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0208-COUPLED-WB13-PUBLICATION-LINEAGE-ADDENDUM` | `lines 749-762` `HPHYS0208 Coupled WB13 Publication Lineage Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: coupled WB13 publication-lineage obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0218-WB19-DRFC-THRESHOLD-GOVERNANCE-ADDENDUM` | `lines 763-774` `HPHYS0218 WB19 drfc Threshold Governance Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: WB19 threshold governance obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0221-WB19-COUPLED-SATURATED-DEPTH-GOVERNANCE-ADDENDUM` | `lines 775-792` `HPHYS0221 WB19 Coupled Saturated-Depth Governance Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: WB19 coupled saturated-depth obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0209-PROFILEWP-NEAR-CLOSED-PUBLICATION-ADJUDICATION-ADDENDUM` | `lines 793-806` `HPHYS0209 ProfileWP Near-Closed Publication Adjudication Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: ProfileWP publication adjudication obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `MOFE04-MULTI-OFE-WB13-WAT-PUBLICATION-BOUNDARY-CARRY-ADDENDUM` | `lines 807-825` `MOFE04 Multi-OFE WB13/WAT Publication Boundary-Carry Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: MOFE WB13/WAT publication policy obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0255-MOFE-STORAGE-LINEAGE-PUBLICATION-ADDENDUM` | `lines 826-839` `HPHYS0255 MOFE Storage-Lineage Publication Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: MOFE storage-lineage publication obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `MOFE05-WATERSHED-CONTRIBUTOR-METADATA-INTAKE-VALIDATION-ADDENDUM` | `lines 840-875` `MOFE05 Watershed Contributor Metadata Intake Validation Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: contributor metadata intake and test-vector obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `HPHYS0241-MOFE-HOURLY-CARRY-METADATA-ADDENDUM` | `lines 876-896` `HPHYS0241 MOFE Hourly Carry Metadata Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: MOFE hourly carry metadata obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `EROD13-WAVE-1-ACTIVE-BOUNDARY-CARRY-ADDENDUM` | `lines 897-909` `EROD13 Wave-1 Active Boundary-Carry Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: Wave-1 active boundary-carry obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `EROD14-WAVE-2-ACTIVE-BOUNDARY-CARRY-ADDENDUM` | `lines 910-926` `EROD14 Wave-2 Active Boundary-Carry Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: Wave-2 active boundary-carry obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
| `EROD15-WAVE-3-HBP-BOUNDARY-CARRY-ADDENDUM` | `lines 927-947` `EROD15 Wave-3 HBP Boundary-Carry Addendum` | `active` | `unpromoted-binding` | `none` | `science-review-follow-on` | SCSTRUCT04: Wave-3 HBP boundary-carry obligations lack same-section system binding IDs. Owner: SCSTRUCT05-SYSTEM-BEI-SCIENCE-REVIEW. Next gate: map/promote before relocation. |
...
3. Raw parser-theta substitution for authoritative FC/WP publication symbols is
   prohibited when normalized corrected-lineage projection is required.
