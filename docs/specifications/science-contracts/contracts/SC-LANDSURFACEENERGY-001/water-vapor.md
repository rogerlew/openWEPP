...
|---|---|---|---|
| interface.md#interface | all water/vapor work | units and owner limits | whole mechanism chapter |
| soil-coupling.md#soil-coupling | ground/soil transfer or closure | opposite G and thermal state | whole mechanism chapter |
| surface-energy.md#surface-energy | component physical evaluation or closure | radiative and turbulent operands | whole mechanism chapter |
| litter-phase.md#litter-phase | frozen-litter vapor/phase or closure | phase-specific vapor and spill | whole mechanism chapter |
| ../SC-WATBAL-001.md#wb14-infiltration-and-hyetograph-coupling-addendum | ingress partition or closure | sole WB14 owner | named section plus destination scope; retain applicable single-file whole-contract/frozen-kickoff requirements |
| ../SC-WATBAL-001.md#purpose | cross-contract water scope | water scope | named section plus destination scope; retain applicable single-file whole-contract/frozen-kickoff requirements |
| ../SC-SURFACELIQUID-001.md#algorithm-specification | surface-water custody or closure | accepted water protocol | named section plus destination scope; retain applicable single-file whole-contract/frozen-kickoff requirements |
| ../SC-SURFACELIQUID-001.md#purpose-and-scientific-scope | cross-contract surface scope | surface owner scope | named section plus destination scope; retain applicable single-file whole-contract/frozen-kickoff requirements |
...
| <a id="INV-LANDSURFACEENERGY-104"></a> `INV-LANDSURFACEENERGY-104` | Signed vapor mass and `v*[h_l+L_v]` energy preserve sign; condensation has one explicit hydrology credit. | [Original authority](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1093-L1093) | [INFERENCE][Static]; [original rule/context](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1093-L1093) | Existing coupled domain/closure guards in [ordered solve](nonlinear-solve.md#ordered-numerical-algorithm-active-branches-and-error-precedence) and [typed errors](water-vapor.md#independent-closure-and-errors); [source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1093-L1093) | Existing typed domain/convergence/closure failure: [error map](water-vapor.md#independent-closure-and-errors); no partial state or promotion |
| <a id="INV-LANDSURFACEENERGY-105"></a> `INV-LANDSURFACEENERGY-105` | Root and ground requests share beginning stores before ingress; accepted current ingress is partitioned exactly once after the capped solve. | [Original authority](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1094-L1094) | [INFERENCE][Static]; [original rule/context](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1094-L1094) | Existing coupled domain/closure guards in [ordered solve](nonlinear-solve.md#ordered-numerical-algorithm-active-branches-and-error-precedence) and [typed errors](water-vapor.md#independent-closure-and-errors); [source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1094-L1094) | Existing typed domain/convergence/closure failure: [error map](water-vapor.md#independent-closure-and-errors); no partial state or promotion |
| <a id="INV-LANDSURFACEENERGY-107"></a> `INV-LANDSURFACEENERGY-107` | Local tile closure precedes one `f_t` weighting to OFE ground; no cross-OFE aggregate is called stand ground. | [Original authority](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1096-L1096) | [INFERENCE][Static]; [original rule/context](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1096-L1096) | Existing coupled domain/closure guards in [ordered solve](nonlinear-solve.md#ordered-numerical-algorithm-active-branches-and-error-precedence) and [typed errors](water-vapor.md#independent-closure-and-errors); [source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L1096-L1096) | Existing typed domain/convergence/closure failure: [error map](water-vapor.md#independent-closure-and-errors); no partial state or promotion |

<a id="canonical-obligations"></a>
## Canonical obligations
| Obligation ID | Statement | Applicability | Authority | Enforcement/failure | Test bindings |
|---|---|---|---|---|---|
| <a id="OBL-LANDSURFACEENERGY-P-001"></a> `OBL-LANDSURFACEENERGY-P-001` | produce immutable, source-identified records for all water and energy operands and a sealed start-to-end ledger. | All LSE producer paths; retain named model/regime and reviewed terminal-cutover limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L311-L312) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L311-L312) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L311-L312) |
| <a id="OBL-LANDSURFACEENERGY-P-002"></a> `OBL-LANDSURFACEENERGY-P-002` | validate before mutation and commit energy and water state atomically. | All LSE producer paths; retain named model/regime and reviewed terminal-cutover limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L313-L314) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L313-L314) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L313-L314) |
| <a id="OBL-LANDSURFACEENERGY-P-003"></a> `OBL-LANDSURFACEENERGY-P-003` | expose branch, interval, tolerances, residuals, and exact component lineage without silent defaults or clamps. | All LSE producer paths; retain named model/regime and reviewed terminal-cutover limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L315-L316) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L315-L316) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L315-L316) |
| <a id="OBL-LANDSURFACEENERGY-P-004"></a> `OBL-LANDSURFACEENERGY-P-004` | reject all schema-v8 terminal payloads until a reviewed atomic cutover revises both snow and receiving-surface authority. | All LSE producer paths; retain named model/regime and reviewed terminal-cutover limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L317-L318) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L317-L318) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L317-L318) |
| <a id="OBL-LANDSURFACEENERGY-C-001"></a> `OBL-LANDSURFACEENERGY-C-001` | ET supplies one actual evaporation debit and consumes no second latent debit. | ET consumers of actual evaporation and latent energy; retain the Statement and linked source model/regime, failure and qualification limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L326-L327) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L326-L327) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L326-L327) |
| <a id="OBL-LANDSURFACEENERGY-C-002"></a> `OBL-LANDSURFACEENERGY-C-002` | infiltration/runoff consumes one water offer, returns sealed partition terms, and remains sole water-partition owner. | Infiltration/runoff consumers of the LSE water offer; retain the Statement and linked source model/regime, failure and qualification limits | [Original clause](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L328-L329) | Existing local mechanism guards and [coupled error map](water-vapor.md#independent-closure-and-errors); [original obligation](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L328-L329) | [Shared test-vector obligations](interface.md#test-vector-obligations) and [owning detailed requirements](interface.md#test-vector-obligations), including their named fixture/test and real-consumer requirements; [original source](https://github.com/rogerlew/openWEPP/blob/b932db101cce07d0860b45b5ecaa8ddb7f455b58/docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md#L328-L329) |
