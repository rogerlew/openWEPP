...
| `INV-LANDSURFACEENERGY-002` | future LSE input validator | runtime | `LSEB-E-001`; currently `HOLD` | `GAP-LANDSURFACEENERGY-003/004`; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
| `INV-LANDSURFACEENERGY-010` | future independent energy reconstruction | runtime | `LSEB-E-011`; currently `HOLD` | `GAP-LANDSURFACEENERGY-001/004`; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
...
| `INV-LANDSURFACEENERGY-030` | owner-boundary assertions | test | blocked promotion | focused test + adjacent contracts; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
| `INV-LANDSURFACEENERGY-031` | dual science review and owner assertions | governance | blocked promotion | package review artifacts; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
| `INV-LANDSURFACEENERGY-032` | real-consumer reachability gate | governance | blocked promotion | `GAP-LANDSURFACEENERGY-004` |
| `INV-LANDSURFACEENERGY-040` | gap-label assertion and package disposition | governance | `NON_PROMOTABLE` | focused test + disposition; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
...
| `INV-LANDSURFACEENERGY-138` | covered-column Jacobian probe-domain validator | runtime/test | centered interior, unique inward closed-bound derivative, or typed reject | covered solver contract/unit/runtime vectors; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
...
| `INV-LANDSURFACEENERGY-154` | immutable represented-snow classifier, standard Stage-3 covered-column charge, native identity/receipt join, inactive-litter custody validator, and terminal split | runtime/test/governance | one charged standard map or typed rejection with byte-exact owner rollback | typed classification, zero litter-phase calls, exact optical/lower-boundary retention, no second envelope, unchanged V3/V4 bytes, snow-free transition; [liquid-canopy seams/checks](../SC-VEGETATION-001.md#liquid-canopy-guard-check-references) |
...
The coupled canopy boundary retains [GAP-VEGETATION-005](../SC-VEGETATION-001.md#gap-register-and-promotability-labels)
for cold active-leaf, supercooled-liquid and intercepted ice/mixed-phase authority.
Vegetation science owns that `AUTHORITY_MISSING / OUTSIDE_CURRENT_MODEL /
NON_PROMOTABLE` gap with LSE energy/custody review. Its next gate is separately
adopted phase/state/physiology authority and complete initial-state obligations;
the admitted warm-surface families are not reopened.
