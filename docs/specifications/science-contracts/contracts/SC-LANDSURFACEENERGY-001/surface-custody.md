...
| soil-custody.md#soil-custody | exact dyadic representation | canonical arithmetic/wire definition | whole mechanism chapter |
| litter-phase.md#litter-phase | active phase/fusion/spill or closure | accepted operands and spill | whole mechanism chapter |
| water-vapor.md#water-vapor | retained ingress or closure | physical basis and parcel receipts | whole mechanism chapter |
