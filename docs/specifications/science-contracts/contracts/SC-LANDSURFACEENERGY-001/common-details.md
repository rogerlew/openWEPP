...
| qualification.md#qualification | historical/current experiment retention, executable identity or capture limits | complete experiment requirements | whole chapter |
