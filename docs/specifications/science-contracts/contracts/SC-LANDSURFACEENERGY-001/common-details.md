...
For physical rules, solver correctness and accepted-primitive closure read these complete sections: [variables](common-details.md#variables), [algorithm](common-details.md#state), [algorithm](common-details.md#algorithm), [branch](common-details.md#guards), [symbol](common-details.md#aliases), [constants](common-details.md#constants), [unit](common-details.md#units), [tolerance](common-details.md#tolerances), [calibration](common-details.md#calibration), [test](common-details.md#tests). Read Authority Anchors for source-provenance claims, Invariant Guard Map for enforcement-path review, and Purpose/Scope/Gap Register for historical applicability or promotability adjudication. All universal canonical definitions are in interface.
