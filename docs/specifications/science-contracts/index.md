...
| `SC-PLANT-001` | Plant Growth Process Contract | `approved` | `active` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-PLANT-001.md` | `static` | `2026-07-27` |  | CP-GSI02 defines native GSI canopy/height/LAI/biomass, litter closure, YAML authority, and real-consumer ordering. |
