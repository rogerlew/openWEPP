...
| `SC-COUPLEDTIME-001` | Coupled Time Support, Event, and Atomic Chronology Contract | `approved` | `active` | openWEPP maintainers + time/numerics + transaction/restart reviewers | `docs/specifications/science-contracts/contracts/SC-COUPLEDTIME-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-25` |  | v3 remains released; candidate v4 prospectively binds current-search support, absolute-tick full-prefix replay, physical-child ordinal, read-only discovery, exact mutation/ordinal authority, and the terminal receipt chain. Candidate v5 separately defines Batch V2 group topology, exact survivor installation, zero-prefix witness, and typed unsupported rollback; review pending. |
...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `approved` | `active` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-25` |  | v18 remains released; candidate v19 prospectively binds covered terminal modes and full-prefix replay. Candidate v20 separately defines complete-state same-support BE/CN construction, residual classes, active-set guards and rejected-trial component evidence; review pending. |
...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-25` |  | v137 prospectively adds canonical snow-owner V4 pending parcels and staged custody. Candidate v138 separately defines all-lane Batch V2 carrier/hydrology/joint semantics, phase active-set agreement, canonical hashes and exact survivor installation; review pending. |
