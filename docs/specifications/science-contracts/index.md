...
| `SC-PLANT-001` | Plant Growth Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-PLANT-001.md` | `static` | `2026-07-17` |  | Includes the CP-GSI01 generalized foliar-phenology process-kernel amendment; canopy/biomass/litter integration remains held. |
