...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-06` |  | v128 realizes two typed default-off internal evaluation operators with exact disabled schema-v4 preservation and schema-v5 observability; persistence, production melt ownership, terminal receipt, public consumers, and cutover remain held. |
