...
| `SC-PLANT-001` | Plant Growth Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-PLANT-001.md` | `static` | `2026-05-23` |  | PL10b+PL11 projection authority now includes PL12 typed decomposition-transition context-consumption invariant (`INV-PLANT-016`); promotion remains blocked by cross-contract gap `GAP-PLANT-004`. |
