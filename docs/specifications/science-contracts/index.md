...
| `SC-ROUTE-001` | Watershed Routing and Channel Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-ROUTE-001.md` | `static` | `2026-05-25` |  | EROD14 amendment added active Wave-2 consumer-coupling authority for enrichment payload continuity (`sed_frac_*`, `ER`, class-wise closure surfaces) with explicit hard-fail posture for malformed payloads; WS11 branch authority and existing `WKERNEL-WS10-CHANNEL-E-001..003` continuity remain active. |
...
| `SC-SED-001` | Hillslope Erosion Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SED-001.md` | `static` | `2026-05-25` |  | EROD14 Wave-2 amendment added multi-OFE/enrichment runtime authority for `INV-SED-008..009`, including case-classification semantics, class-wise reproportion/mass-conservation closure, and typed guard continuity (`HKERNEL-EROD14-WAVE2-E-001..003`) while retaining Wave-1 guard continuity (`HKERNEL-EROD13-CORE-E-001..003`). |
...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-25` |  | EROD14 amendment added Wave-2 active boundary-carry authority for enrichment/class-conservation exports (`sed_frac_*`, `ER`, `erod14_sumg`) under `erod14_wave2_enabled` with typed hard-fail continuity (`HKERNEL-EROD14-WAVE2-E-001..003`); SIMIMPL03/WS11/WS12/ARCH22 posture remains active. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-25` |  | EROD14 amendment added Wave-2 runoff producer-coupling continuity for enrichment ingress surfaces (`erod14_qout`, `erod14_qin`) with typed hard-fail guard continuity (`HKERNEL-EROD14-WAVE2-E-001..003`); SIMIMPL03 governance and canonical WB13 authority remain active with companion-gap context (`GAP-WATBAL-002`). |
