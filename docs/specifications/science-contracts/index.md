...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-07` |  | v134 admits only default-off evaluator-owned persistent continuity mechanics with snowfall/liquid custody, dormancy/reappearance, schema-v7 evidence, and exact snapshot/restore. Unresolved physical magnitude/recipient, production, ownership, and cutover claims remain held. |
