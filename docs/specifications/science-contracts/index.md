...
| `SC-RESIDUE-001` | Residue Management Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-RESIDUE-001.md` | `static` | `2026-05-23` |  | PL12 added scheduler decomposition-transition algorithm authority and guard table for projected annual/perennial payload consumption; remains non-promotable while `GAP-RESIDUE-002` and `GAP-RESIDUE-003` are open. |
