...
| `SC-SURFACELIQUID-001` | Persistent Snow-Free Surface-Liquid Hydrology Custody Contract | `in_review` | `draft` | openWEPP maintainers + hydrology/land-surface-energy reviewer | `docs/specifications/science-contracts/contracts/SC-SURFACELIQUID-001.md` | `static+contract_vectors` | `2026-08-23` |  | v8 child-slab/complete-owner cycle is in review; v7 remains the released runtime baseline and short-cadence production guard. |
