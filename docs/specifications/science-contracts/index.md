...
| `SC-LANDSURFACEENERGY-001` | Land-Surface Energy-Balance Process Contract | `approved` | `active` | openWEPP maintainers + land-surface-energy/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-30` |  | v14 retains v13's first-domain-valid halved no-update witness and admits immutable snow-free forest-litter LSE V3 authority: phase-specific vapor, bounded kinetic phase transfer, fusion/ending-capacity energy closure, successor identities, and vapor--phase--ingress--WB14 chronology with unchanged legacy bytes, 60-second floor, tolerances, receipts, and rollback. |
...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `approved` | `active` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-30` |  | v31 retains the exact 60-second floor, unchanged cap/tolerances, independent closure, and authentic-only publication while admitting one terminal-one-volume coordinated `W/H` midpoint from immutable beginning and complete support operands; rejected v30 interpolation is not authority. |
...
| `SC-SURFACELIQUID-001` | Persistent Snow-Free Surface-Liquid Hydrology Custody Contract | `approved` | `active` | openWEPP maintainers + hydrology/land-surface-energy reviewer | `docs/specifications/science-contracts/contracts/SC-SURFACELIQUID-001.md` | `static+contract_vectors` | `2026-08-30` |  | v14 admits tagged surface-owner/restart V2 liquid/ice custody, exact zero-ice migration, phase-specific vapor, bounded kinetic phase/fusion closure, vapor--phase--ingress--liquid-only-WB14 chronology, successor receipts/restart/rollback, and unchanged V1/legacy bytes and 60-second floor. |
