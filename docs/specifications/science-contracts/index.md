...
| `SC-HYDRAULICS-001` | Overland Hydraulics Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-HYDRAULICS-001.md` | `static` | `2026-05-23` |  | WB16 amendment added peak-flow coupling readiness authority requiring canonical `peakro`/`watdur` intake with WB16 trace-symbol and typed guard posture; remains non-promotable while `GAP-HYD-003` is open. |
...
| `SC-ROUTE-001` | Watershed Routing and Channel Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-ROUTE-001.md` | `static` | `2026-05-23` |  | WB16 amendment added hillslope peak-flow intake authority (`peakro`, `watdur`) plus trace/typed-guard requirements for routing coupling readiness; remains non-promotable while `GAP-ROUTE-002`, `GAP-ROUTE-003`, and `GAP-ROUTE-005` are open. |
