...
| `SC-LANDSURFACEENERGY-001` | Land-Surface Energy-Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + land-surface-energy/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md` | `static` | `pending` |  | Snow-free surface control-volume conservation/custody authority with a censored post-snow boundary; unresolved constitutive families and receiving-surface handoffs remain non-promotable. |
