...
| `SC-HYDRAULICS-001` | Overland Hydraulics Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-HYDRAULICS-001.md` | `static` | `2026-05-23` |  | ARCH22 typed production-surface authority remains active; EROD11/EROD12 closure amendments now disposition `GAP-HYD-001`..`GAP-HYD-004` to `closed` and add explicit cross-domain ownership/guard closure semantics for required erosion-lane boundaries. |
...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-23` |  | WB20 parity governance authority (`INV-SYSTEM-016`) and prior ARCH22/PL14R/PL15R governance remain active; EROD12 addendum now records explicit Wave-0 erosion-lane cross-domain ownership/guard closure while `GAP-SYSTEM-001` stays non-promotable for broader non-Wave-0 watershed release posture. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-23` |  | WB20 lane-scoped WB12 closure semantics remain active; EROD12 addendum now records explicit cross-domain ownership/guard closure for required erosion-lane hydrology boundary exports. Contract remains non-promotable while broader companion-gap row `GAP-WATBAL-002` is open. |
