...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-23` |  | ARCH22 amendment added typed production-surface authority for covered hillslope/watershed integration interfaces (`HillslopeProduction*Symbol`, `WatershedProduction*Symbol`) while preserving deterministic publication and existing failure-class/message continuity; PL14R amendment added rerun reproducibility authority requiring explicit required-include staging and persisted comparator/provenance hash evidence (`INV-SYSTEM-014`). |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-23` |  | ARCH22 amendment added typed production-surface authority for covered WB11/WB12/WB14/WB15/WB16 interfaces (`HillslopeProduction*Symbol`) while preserving existing typed guard-family/message continuity; PL14R amendment added strict replay rerun include-surface completeness authority for candidate staging (`INV-WATBAL-014`). |
