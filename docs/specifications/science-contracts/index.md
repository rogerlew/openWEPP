...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `in_review` | `draft` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `runtime` | `2026-07-31` |  | v4 defines the exact libsnobal total-mass `<=1 kg m^-2` suspension and resolved-pack lower-mass `<1` one-volume collapse while preserving CoE snow mass; EB-04C runtime review and verification pass. |
