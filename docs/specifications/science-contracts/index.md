...
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-23` |  | WB17 amendment updated hydrology authority to WB17 equation-driven ET execution while preserving WB11 percolation/lateral/drain phases, including ET component outputs (`Ep`, `Es`, `Er`) and explicit runtime alias mapping in closure-accounting context; PL14R/PL15R replay governance requirements remain active. |
