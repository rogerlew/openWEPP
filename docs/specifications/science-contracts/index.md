...
| `SC-VEGETATION-001` | Native Vegetation State and Cross-Domain Boundary Contract | `in_review` | `draft` | openWEPP maintainers + forest ecohydrology/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-VEGETATION-001.md` | `static` | `2026-08-08` |  | Native stratum topology, Stage A/B/C custody, shared ledgers, strict licensed-source compatibility boundary, and non-promotable constitutive/parameter gaps; no runtime implementation. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-08-08` |  | Lifecycle row includes hydrology-owned vegetation Stage B arbitration. |
