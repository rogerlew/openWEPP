...
| `SC-HYDRAULICS-001` | Overland Hydraulics Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-HYDRAULICS-001.md` | `static` | `2026-05-24` |  | WS12 amendment added impoundment physics-equivalence consumer-coupling authority so downstream consumers treat impoundment payloads as continuity/regime outputs (not headroom-surrogate reconstructions) while preserving `WKERNEL-WS10-IMPOUNDMENT-E-001..003` continuity; ARCH22 and EROD11/EROD12 closure posture remain active. |
...
| `SC-ROUTE-001` | Watershed Routing and Channel Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-ROUTE-001.md` | `static` | `2026-05-23` |  | ARCH22 typed production-surface authority and WS10 guard-family continuity remain active; EROD11/EROD12 closure amendments dispositioned `GAP-ROUTE-001`..`GAP-ROUTE-004` to `closed` and canonicalized cross-domain ownership/guard semantics for required erosion-lane routing boundaries. Contract remains non-promotable while applicability guard row `GAP-ROUTE-005` is open. |
...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-24` |  | WS12 amendment added impoundment physics-equivalence integration authority (continuity/regime routing with parser-projected coefficient-family requirements and WS10 guard-family continuity); CLI02 replay-surface authority, WB20, ARCH22, and EROD12 governance posture remain active and `GAP-SYSTEM-001` remains non-promotable for broader non-Wave-0 watershed release posture. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-24` |  | CLI02 amendment replaced required replay include-surface authority from legacy/bootstrap candidate files to simulation-driven interchange surfaces (`interchange/H.wat.parquet`, `interchange/H.pass.parquet`) while preserving canonical 25-column WB13 schema authority and broader companion-gap posture (`GAP-WATBAL-002`). |
