...
| `SC-COUPLEDTIME-001` | Coupled Time Support, Event, and Atomic Chronology Contract | `approved` | `active` | openWEPP maintainers + time/numerics + transaction/restart reviewers | `docs/specifications/science-contracts/contracts/SC-COUPLEDTIME-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-25` |  | v3 remains released; candidate v4 prospectively binds current-search support and is preserved; held v5 remains historical. Candidate v6 defines the closed Batch/event wire DAG, core-bound zero witness, split prefix/event owner joins and terminal-ingress exclusion; review pending. |
...
| `SC-LANDSURFACEENERGY-001` | Land-Surface Energy-Balance Process Contract | `approved` | `active` | openWEPP maintainers + land-surface-energy/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-25` |  | v8 remains released; candidate v9 prospectively adds terminal event-integrated snow--soil custody and is preserved; held v10 remains historical. Candidate v11 defines corrected forcing classes, arm-generated custody and read-only collocation/rate receipts while retaining the 600 ms floor; review pending. |
...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `approved` | `active` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-25` |  | v18 remains released; candidate v19 prospectively binds covered terminal modes and is preserved; held v20 remains historical. Candidate v21 defines installed-high step-doubling/defect estimators, exact controller/floor and complete SCC/nonlinear authority; review and evidence pending. |
...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-25` |  | v137 prospectively adds canonical snow-owner V4 pending parcels and is preserved; held v138 remains historical. Candidate v139 defines SCC/follower proof, complete owner construction and exact terminal-liquid exclusion from pre-event hydrology/WB14/surface ingress; review pending. |
