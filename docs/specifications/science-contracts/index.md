...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `in_review` | `draft` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `runtime` | `2026-07-30` |  | v3 implements the Marks/SNOBAL active/lower thermal provider; real B/L/S/LS, snow-domain, quick, frost, and Critical full gates pass after EB-03B lifted the validation hold. EB-04 is admitted. |
