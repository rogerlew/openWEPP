...
| `SC-EVAP-001` | Evapotranspiration Stress Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-EVAP-001.md` | `static` | `2026-05-23` |  | WB10 amendment added explicit ET phase-entry routing authority and unsupported-class typed hard-fail posture; remains non-promotable while `GAP-EVAP-002` and `GAP-EVAP-003` are open. |
...
| `SC-PERC-001` | Percolation Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-PERC-001.md` | `static` | `2026-05-23` |  | WB10 amendment added explicit percolation phase-entry routing authority and unsupported-class typed hard-fail posture; remains non-promotable while `GAP-PERC-002` and `GAP-PERC-003` are open. |
...
| `SC-SUBHYD-001` | Subsurface Hydrology and Drainage Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SUBHYD-001.md` | `static` | `2026-05-23` |  | WB10 amendment added explicit lateral/drainage phase-entry routing authority and unsupported-class typed hard-fail posture; remains non-promotable while `GAP-SUBHYD-002` and `GAP-SUBHYD-003` are open (`GAP-SUBHYD-001` and `GAP-SUBHYD-004` are promotable-with-risk). |
...
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-23` |  | WB10 amendment added explicit runoff/storage phase-entry routing authority and unsupported-class typed hard-fail posture; remains non-promotable while `GAP-WATBAL-002` and `GAP-WATBAL-003` are open. |
