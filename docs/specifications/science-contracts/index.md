...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-24` |  | PL14S amendment added semantic replay diagnostics + provenance integrity authority (`INV-SYSTEM-017`, `OBL-SYSTEM-P-006`) and explicit semantic tolerance-profile governance while preserving WS11/WS12, CLI02 replay-surface, WB20, ARCH22, and EROD12 posture; `GAP-SYSTEM-001` remains non-promotable for broader non-Wave-0 watershed release posture. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-24` |  | PL14S amendment added semantic WB13 replay diagnostics authority (`INV-WATBAL-017`) with required investigation-column reporting and semantic guard/disposition posture; CLI02 interchange-surface authority and canonical 25-column WB13 schema posture remain active with broader companion-gap posture (`GAP-WATBAL-002`). |
