...
| `SC-SED-001` | Hillslope Erosion Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SED-001.md` | `static` | `2026-08-09` |  | Revision 62 binds erosion to the source-complete maximum-hour depth-rate peak and a seconds-dimensional rectangular-duration custody check; amendment history lives in the canonical contract. |
