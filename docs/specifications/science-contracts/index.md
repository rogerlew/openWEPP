...
| `SC-HYDRAULICS-001` | Overland Hydraulics Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-HYDRAULICS-001.md` | `static` | `2026-05-25` |  | EROD13 amendment activated Wave-1 hydraulics-to-erosion coupling semantics and guard continuity (`HKERNEL-EROD13-CORE-E-001..003`) for `EROD-BND-002`; WS11/WS12 consumer-coupling authority and ARCH22 typed-surface posture remain active. |
...
| `SC-RUNOFFPART-001` | Surface Runoff Partition Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-RUNOFFPART-001.md` | `static` | `2026-05-25` |  | EROD13 amendment activated Wave-1 runoff producer-coupling authority for `erod13_core_enabled` execution and required WB12/WB16 forcing surfaces with typed hard-fail continuity (`HKERNEL-EROD13-CORE-E-001..003`); contract remains non-promotable while Hortonian-scope governance row `GAP-RUNOFFPART-003` is open. |
| `SC-SED-001` | Hillslope Erosion Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SED-001.md` | `static` | `2026-05-25` |  | EROD13 Wave-1 amendment added pinned-baseline legacy provenance (`param.for`, `erod.for`, `runge.for`) plus runtime algorithm, activation gate, and typed guard semantics (`HKERNEL-EROD13-CORE-E-001..003`) for `INV-SED-001..007` core execution. |
...
| `SC-SYSTEM-001` | System Integration Boundary and Watershed Assembly Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SYSTEM-001.md` | `static` | `2026-05-25` |  | EROD13 amendment added Wave-1 active boundary-carry authority for erosion-core forcing surfaces under `erod13_core_enabled`; SIMIMPL03 execution/provenance governance, WS11/WS12 routing posture, CLI02 replay-surface requirements, and ARCH22 typed-surface authority remain active. |
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-25` |  | EROD13 amendment activated Wave-1 runoff/peak-duration producer-coupling authority for erosion-core ingress under `erod13_core_enabled` with typed hard-fail continuity (`HKERNEL-EROD13-CORE-E-001..003`); SIMIMPL03 governance and canonical WB13 output authority remain active with companion-gap context (`GAP-WATBAL-002`). |
