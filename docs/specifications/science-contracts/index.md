...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-06` |  | v127 preserves one production snow-mass owner while admitting two tagged, default-off, consumer-forbidden evaluation operators; persistence, runtime implementation, and cutover remain held. |
