...
| `SC-VEGETATION-001` | Native Vegetation State and Cross-Domain Boundary Contract | `approved` | `active` | openWEPP maintainers + forest ecohydrology/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-VEGETATION-001.md` | `static` | `2026-08-12` |  | `OPENWEPP_C3_WOODY_V4` shared-state correction admitted; `OPENWEPP_C3_WOODY_V3` and V1/V2 remain immutable historical identities. |
