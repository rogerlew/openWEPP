...
| `SC-ROOTZONEHYDRAULICS-001` | Root-Zone Hydraulic Boundary Contract | `open` | `draft` | openWEPP maintainers + soil/plant hydraulics reviewers | `docs/specifications/science-contracts/contracts/SC-ROOTZONEHYDRAULICS-001.md` | `static` | `2026-08-19` |  | Candidate V1 is HOLD on real explicit root-tissue path input and current-unsaturated conductivity authority; no production implementation. |
...
| `SC-SURFACELIQUID-001` | Persistent Snow-Free Surface-Liquid Hydrology Custody Contract | `approved` | `active` | openWEPP maintainers + hydrology/land-surface-energy reviewer | `docs/specifications/science-contracts/contracts/SC-SURFACELIQUID-001.md` | `static+contract_vectors` | `2026-08-15` |  | v6 adds symmetric bounded binary64 joint-supply rounding; no selector or cutover. |
