...
| `SC-PLANT-001` | Plant Growth Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-PLANT-001.md` | `static` | `2026-07-19` |  | CP-GSI02 defines native GSI canopy/LAI/foliar mass, litter closure, YAML authority, and real-consumer ordering. |
