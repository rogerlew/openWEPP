...
| `SC-SUBHYD-001` | Subsurface Hydrology and Drainage Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SUBHYD-001.md` | `static` | `2026-05-23` |  | WB11 amendment promoted lateral/drainage from routing scaffolding to production-kernel authority with deterministic `q`/`Qdd`/`Qd` guard posture; remains non-promotable while `GAP-SUBHYD-002` and `GAP-SUBHYD-003` are open (`GAP-SUBHYD-001` and `GAP-SUBHYD-004` are promotable-with-risk). |
...
| `SC-WATBAL-001` | Water Balance Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-WATBAL-001.md` | `static` | `2026-05-23` |  | WB11 amendment promoted ET/percolation/lateral/drainage to production-kernel authority with deterministic WB11 writeback and typed guard posture; remains non-promotable while `GAP-WATBAL-002` and `GAP-WATBAL-003` are open. |
