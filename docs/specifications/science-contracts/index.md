...
| `SC-SNOWFREEZE-001` | Snow and Freeze Process Contract | `in_review` | `draft` | openWEPP maintainers + hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md` | `static` | `2026-08-06` |  | v130 corrects Stage 3 predecessor custody by binding all-WY-plus-median reproduction to the exact S/F/Q forcing hash and limiting schema-v4 evidence to aggregate custody; production physics/defaults/outputs, CoE ownership, and all seasonal/terminal/cutover holds remain unchanged. |
