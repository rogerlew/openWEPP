...
| `SC-LANDSURFACEENERGY-001` | Land-Surface Energy-Balance Process Contract | `approved` | `active` | openWEPP maintainers + land-surface-energy/hydrology reviewer | `docs/specifications/science-contracts/contracts/SC-LANDSURFACEENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-08-31` |  | v16 adds a minimal LSE-owned exact per-tile surface-enthalpy companion with immutable V2/V3 high mirrors, exact retained-credit custody, restart/rollback, and real `p61`/native gates; v14 physics, tolerances, and exact 60-second floor remain unchanged. |
...
| `SC-SNOWENERGY-001` | Snow-Surface Energy and Sub-Canopy Longwave Contract | `approved` | `active` | openWEPP maintainers + snow-process reviewer | `docs/specifications/science-contracts/contracts/SC-SNOWENERGY-001.md` | `static+independent_oracle+contract_vectors` | `2026-09-01` |  | v57 keeps at most `1.0e-12 kg m^-2` external-liquid roundoff neutral only to frozen-specialization eligibility while retaining the exact operand in all physics and ledgers, and permits a zero-charge same-budget transition from the first legacy root before V55; exact 60-second floor, physics, physical tolerances, phase/event outcomes, cap, custody, receipts, rollback, and diagnostics remain unchanged. |
...
| `SC-SURFACELIQUID-001` | Persistent Snow-Free Surface-Liquid Hydrology Custody Contract | `approved` | `active` | openWEPP maintainers + hydrology/land-surface-energy reviewer | `docs/specifications/science-contracts/contracts/SC-SURFACELIQUID-001.md` | `static+contract_vectors` | `2026-08-31` |  | v16 binds exact per-tile LSE surface enthalpy to a companion owner with frozen V2/V3 high mirrors, exact named retained tile credits, successor projection/restart/rollback, and unchanged v14 phase/ingress/WB14 chronology, tolerances, and 60-second floor. |
