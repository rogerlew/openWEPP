...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 executing` | The successor `20260821-snow-stage3-v11-covered-consumer-runner-closure-001` is executing from synchronized `40a4bb8b53cea4c6b642c70cb036a1a5e2f3de0a`; close the actual snow-covered V11/Stage-3 consumer, sealed 48-support runner capability, exact-once terminal transaction, complete restart, positive scenarios, and assurance drift before Child 3. |
