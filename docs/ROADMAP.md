...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 next` | Child 2A, Child 2B, and the Child 2C shared-carrier authority checkpoint are terminally released. Resume Child 1 from checkpoint `83cf6eb8e`; production implementation remains separately gated. |
| [`SNOW-STAGE3-TURBULENT-CARRIER-AUTHORITY-CLOSURE`](work-packages/20260821-snow-stage3-shared-carrier-authority-closure-001/package.md) | Snow turbulent-exchange and vegetation-support authority | `complete / Child 2C authority checkpoint` | Released the independently reviewed shared-carrier, exposure, support-aggregation, and event-boundary authority. Fixed forest-wind multipliers and independently evolved aerodynamic carriers are prohibited; default-off implementation is separately scoped. |
