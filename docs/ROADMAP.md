...
| --- | --- | --- | --- |
| [`VEGETATION-SOURCE-PROVENANCE-AND-BOUNDARY-AUTHORITY`](backlog/20260806-rhessys-derived-vegetation-crate.md) | Vegetation/ecohydrology architecture | `next / concept promotion` | Produce the sanitized RHESSys process/state inventory, provenance and licensing dispositions, native-stratum contract, canopy/snow ownership boundary, and typed Stage A/B/C soil-water arbitration contract. Preserve current vegetation, ET, canopy, litter, and hydrology authority until the replacement boundaries are explicit. |
