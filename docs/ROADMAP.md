...
| `SNOW-STAGE3-TURBULENT-CARRIER-AUTHORITY-CLOSURE` | Snow turbulent-exchange and vegetation-support authority | `active / Child 2C` | Define and independently review wind source/exposure, transfer geometry, displacement/roughness, stability coordinates, canopy structure, applicability, flux envelopes, deposition/sublimation bounds, event-boundary coalescing below the admitted LSE support, and snow-covered pre-event V11 evolution with a shared canopy-air/snow-surface carrier. Fixed forest-wind multipliers and independently evolved aerodynamic carriers are prohibited. |
