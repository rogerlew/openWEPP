...
current binding order: Srivastava groundwater/baseflow authority -> single-OFE
and Lane D MOFE groundwater/baseflow implementation -> Lane D active baseflow
export closure -> Lane D watershed HBP hourly water/sediment consumption ->
remaining WSHED hardening.
