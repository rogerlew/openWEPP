...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 2A complete; Child 2B next` | Coupled-time authority is complete. Execute V11 segmented vegetation, then the snow-covered turbulent carrier; resume Child 1 only after 2B and 2C pass. Qualification, assurance, and atomic cutover remain held. |
| [`COUPLED-TIME-AUTHORITY-IMPLEMENTATION`](work-packages/20260820-coupled-time-authority-implementation-001/package.md) | Cross-domain coupled-time authority | `complete / Child 2A` | `SC-COUPLEDTIME-001`, the reusable Rust subsystem, additive restart V2, and the real orchestrator reference consumer passed independent implementation review and focused closure gates. Child 2B and future Richards work must import this authority. |
