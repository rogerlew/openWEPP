...
| --- | --- | --- | --- |
| [`SNOW-SURFACE-EB`](planning/snow-surface-energy-balance-roadmap.md) additive sublimation and sub-canopy longwave | Snow/frost science | `EB-04R next` | EB-04E qualifies all 48 corrected cells, including all 24 prior failures, with independent WAT/trace and physical-ledger closure. Scaffold a fresh preregistered 04R factorial after promotion-grade selector/environment provenance is frozen. No coefficient tuning, guard relaxation, or rewriting of EB-04 is authorized. |
