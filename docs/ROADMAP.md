...
| --- | --- | --- | --- |
| [`LAND-SURFACE-ENERGY-BALANCE-AUTHORITY`](work-packages/20260808-land-surface-energy-balance-authority-001/package.md) | Cross-domain land-surface architecture | `active / contract authority admission` | Define the snow-free radiation, turbulent, evaporation, precipitation, surface-water, unfrozen-soil, soil-temperature, frost, and ET states and ledgers as a first-class subsystem. This authority-only increment must produce an implementation-ready canonical contract without consuming censored snow-terminal handoffs or changing production. |
