...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 executing HOLD` | The active [V11 covered-consumer/runner package](work-packages/20260821-snow-stage3-v11-covered-consumer-runner-closure-001/package.md) first closes canonical BGC debit fold/scope and the open-first/vegetated-second real-consumer fixture. Remaining Child-1 blockers are precipitation/advection custody, snow--soil heat, an independent outcome ledger, positive covered physics, terminal chronology, runner-owned 48-support installation, exact-once terminal liquid, additive restart, and complete scenario/failure/noninterference evidence. Child 3 remains blocked. |
