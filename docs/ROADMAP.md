...
| --- | --- | --- | --- |
| [`RHESSYS-EAST-COAST-COUPLED-VEGETATION-SLICE`](work-packages/20260808-rhessys-east-coast-coupled-vegetation-slice-001/package.md) | Vegetation/ecohydrology architecture | `held / authority admission required` | The completed precursor found required `AUTH-RHEC-001..011` and `014..016` blockers. Close them through reviewed canonical authority before the self-stopping kickoff or any Rust work; licensing and audit completion alone do not release implementation. |
