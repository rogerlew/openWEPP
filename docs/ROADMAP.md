...
| --- | --- | --- | --- |
| [`RHESSYS-EAST-COAST-COUPLED-VEGETATION-SLICE`](work-packages/20260808-rhessys-east-coast-coupled-vegetation-slice-001/package.md) | Vegetation/ecohydrology architecture | `held / authority predecessor executed-hold` | Begin only after a follow-on authority package closes residual `AUTH-RHEC-001..011` plus `AUTH-RHEC-014/015`; implement and test already-admitted `AUTH-RHEC-016` within this successor after its contract-first gate passes. Licensing, audit completeness, or partial schema-form decisions do not release Rust work. |
