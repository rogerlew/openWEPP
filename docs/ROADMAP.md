...
| --- | --- | --- | --- |
| [`SNOW-SURFACE-EB`](planning/snow-surface-energy-balance-roadmap.md) additive sublimation and sub-canopy longwave | Snow/frost science | `EB-04T failure attribution next` | EB-04S closes nonpromotion under its frozen rule, but 11/16 unchanged failures are density/geometry diagnostics and all 16 are invariant across B/L/S/LS. Before EB-05, determine why target mechanisms did not resolve them, assign process ownership and target sensitivity, and assess whether total-failure reduction was fit for this intervention. EB-04T is diagnostic/governance only: no rerun, tuning, retroactive EB-04S pass, or default activation. |
