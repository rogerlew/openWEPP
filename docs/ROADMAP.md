...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-WIND-SOURCE-CUSTODY-AND-EXPOSURE-AUTHORITY`](work-packages/20260807-snow-stage3-wind-source-custody-and-exposure-authority-001/package.md) | Snow surface-energy-balance campaign | `next / scaffolded / authority reconciliation` | Trace exact GRIDMET product/cell/cadence/aggregation into CLI and Stage 3; resolve nominal 10 m forcing versus virtual 5 m geometry and site exposure applicability. Neutral static analysis bounds the direct height mismatch near 10% in friction velocity and 21% in the momentum/heat product, too small alone to resolve the larger magnitude concern. No fitted attenuation, inferred exposure, canopy operator, production correction, persistence, or cutover. |
