...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-FOUR-SITE-CARRIER-TERM-AUDIT`](work-packages/20260806-snow-stage3-four-site-carrier-term-audit-001/package.md) | Snow surface-energy-balance campaign | `active / result-blind freeze` | Frozen same-state support, water-year-first condition-sample aggregation, non-decisive Snowbird development forcing custody, literature context, coverage, independent reconstruction, and no-tuning rule must pass result-blind review before the exact four-site release batch. Internal active/lower conduction stays separate and the absent snow-ground boundary is explicit. |
