...
| `QUALITY-CQR-HANDOFF-01` exact QA evidence consumption | Test/gate architecture | `next` | Execute Order 5; CQR must consume the exact current report without recollection. |
