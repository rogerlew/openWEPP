...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-SHADOW-SOLVER-EXTRACTION-AND-OBSERVABILITY`](work-packages/20260806-snow-stage3-shadow-solver-extraction-and-observability-001/package.md) | Snow surface-energy-balance campaign | `active / contract-first` | Advance v127's no-implementation boundary narrowly to v128, extract the 3,177-line solver, and realize typed default-off paired and bounded-sequential evaluation with schema-v5 per-term lineage while preserving exact disabled schema-v4 and CoE production ownership. |
