...
| --- | --- | --- | --- |
| [`SNOW-COE-STAGE3-MELT-OWNER-AUTHORITY-RECONCILIATION`](work-packages/20260804-snow-coe-stage3-melt-owner-authority-reconciliation-001/package.md) | Snow surface-energy-balance campaign | `held / authority admitted / 21N` | Stage 3 is admitted as the future sole melt owner; current CoE runtime remains byte-identical on implementation hold. Terminal closure requires accountable `ASSURE-06` refresh because the amended contract correctly invalidates the locked report. |
| `ASSURE-06` snow/frost flagship synthesis | Scientific assurance | `next / accountable refresh required` | Roger Lew remains the accountable report lead and a material snow/frost producer. Refresh the manuscript against 21K-21N and v7/v126 authority, issue a new exact review root, and complete independent review before 21N canonical quick/full can pass. |
