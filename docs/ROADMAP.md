...
reduced the remaining current-fixture WAT residual to day-2 `Es` only. R6I is
now scaffolded at
[20260621-r6i-direct-pmet-layer-ulp-parity-001](work-packages/20260621-r6i-direct-pmet-layer-ulp-parity-001/package.md)
to localize and correct the PMET layer-carry ULP divergence without
compatibility-row wrapping.
