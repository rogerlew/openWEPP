...
| **WSHED-W11D** | **Hourly routing numerical defect closure** | Close W11C's material negative storage/generated terminal volume, MC peak/timestep anomaly, non-terminal legacy serial-network publication, and `chan.inp nchnum=0` timestep aliasing through contract-first production corrections. | Pinned KW/MC and event-publication authority; contract-derived anti-alias tests; no clamps/surrogates; corrected real release CLI matrix; independent terminal closure; parser zero-count semantics; dual review/verification and full gates. | **queued 2026-07-10** — package: [work-packages/20260710-wshedw11d-hourly-routing-numerical-defect-closure-001/package.md](work-packages/20260710-wshedw11d-hourly-routing-numerical-defect-closure-001/package.md). |
