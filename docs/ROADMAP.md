...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 executing HOLD` | The active [V11 covered-consumer/runner package](work-packages/20260821-snow-stage3-v11-covered-consumer-runner-closure-001/package.md) has closed BGC and persistent covered physical custody. Remaining Child-1 blockers begin with terminal chronology, then runner-owned just-in-time 48-support installation, exact-once terminal-liquid consumption, additive restart, cross-midnight/reappearance qualification, and complete scenario/failure/noninterference evidence. Child 3 remains blocked. |
