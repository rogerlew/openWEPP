...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 2C next` | Child 2A and Child 2B are terminally released. Execute the independently reviewed snow-covered shared-carrier authority, then resume Child 1 from checkpoint `83cf6eb8e`. |
| [`SNOW-STAGE3-TURBULENT-CARRIER-AUTHORITY-CLOSURE`](work-packages/20260821-snow-stage3-shared-carrier-authority-closure-001/package.md) | Snow turbulent-exchange and vegetation-support authority | `active / Child 2C` | Freeze and independently review wind source/exposure, transfer geometry, displacement/roughness, stability coordinates, canopy structure, applicability, flux envelopes, deposition/sublimation bounds, active-adopter support aggregation, event-boundary coalescing below the admitted LSE support, and snow-covered pre-event V11 evolution with a shared canopy-air/snow-surface carrier. Fixed forest-wind multipliers and independently evolved aerodynamic carriers are prohibited. |
