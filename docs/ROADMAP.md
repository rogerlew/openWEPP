...
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `active / Children 1-2 complete / Child 3 resumed` | Persistent surface-liquid custody is released. Complete the covered forest/litter runtime through the real owner, then begin Child 4 only after Child 3 passes its own reviews and terminal gates. Production remains unchanged. |
