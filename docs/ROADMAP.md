...
| [`WORKSPACE-BASELINE-ASSURANCE-V2-RECONCILIATION`](work-packages/20260826-workspace-baseline-assurance-v2-reconciliation-001/package.md) | Workspace qualification | `next / owner authorized` | Classify and disposition individually the 81 Assurance V2 identity/source failures, nine retained source/registry guards, and protected V9 external-runtime/libcrypto binding. Obtain one exact clean workspace baseline without weakening anti-evasion guards, rebinding rejected terminal candidates, or changing Stage-3 physics or terminal behavior. |
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `held / Child 1 terminal EXECUTED HOLD` | The [parent V11 covered-consumer/runner package](work-packages/20260821-snow-stage3-v11-covered-consumer-runner-closure-001/package.md) is terminally `EXECUTED HOLD`. Both terminal research successors are preserved and all four researched chronology candidates are `NO-GO`; typed unsupported controls and production remains `BelowCarrierDomain`. No endpoint-root, LTE, DAE, Hermite, complementarity, frost-subtype, search-method, successor-contract, Child 3, runner, receiver, restart, Batch V2, or cutover continuation is authorized without new owner direction. |
