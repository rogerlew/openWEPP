...
| --- | --- | --- | --- |
| [`SNOW-SURFACE-EB`](planning/snow-surface-energy-balance-roadmap.md) additive sublimation and sub-canopy longwave | Snow/frost science | `EB-04E next` | EB-04C closes all 22 captured thermal-domain failures, and EB-04D closes both cross-unit layer-geometry failures without tolerance inflation or state deletion. Run 04E corrected-population qualification before a fresh preregistered 04R factorial. No coefficient tuning, guard relaxation, promotion, or rewriting of EB-04 is authorized. |
