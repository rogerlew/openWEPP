...
| --- | --- | --- | --- |
| `GATE-LINT-ADV-02` legacy execution and CI retirement | Agent tooling | `active` | Execute [roadmap Order 4](work-packages/20260727-gate-planner-legacy-execution-ci-retirement-001/package.md): migrate remaining direct consumers and delete the frozen planner/TESTGATE control plane. |
