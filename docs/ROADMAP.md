...
| --- | --- | --- | --- |
| `SNOW-WARM-MIXED-COE-PHYSICS-AUTHORITY-AUDIT` | Snow surface-energy-balance campaign | `next / 21M` | Read-only first-principles audit of warm/mixed CoE melt generation, prioritizing temperature, dewpoint, radiation, and state interactions while preserving 21L's chronology-confounded evidence and admitting no correction before authority adjudication. |
