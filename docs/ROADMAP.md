...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 HOLD; Child 2 next` | Child 1 stopped before runtime edits because partial-support vegetation identity and pre-event snow-covered vegetation evolution lack authority. Child 2 must close that dependency together with turbulent-carrier/forest exposure before Child 1 resumes. Qualification, assurance, and atomic cutover remain held. |
| `SNOW-STAGE3-TURBULENT-CARRIER-AUTHORITY-CLOSURE` | Snow turbulent-exchange and vegetation-support authority | `next / Child 2` | Contract-first resolution of wind source/exposure, transfer geometry, displacement and roughness, stability coordinates, canopy structure, applicability, flux envelopes, deposition/sublimation bounds, snow-covered pre-event vegetation evolution, and nominal-versus-partial V10 transaction support. Fixed forest-wind multipliers, full-step scaling, and configuration rehashing are prohibited. |
