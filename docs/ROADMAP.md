...
| [`ASSURE-06` snow/frost flagship authority refresh](work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md) | Scientific assurance | `DRAFT / review authority returned` | The refreshed source remains unpublished at generation `910ab3d3`; active review and approval roots are empty. A separately authorized, exact-subject human review entry is required before any review or approval can resume. Public report count is zero. |
