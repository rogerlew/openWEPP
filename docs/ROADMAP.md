...
| --- | --- | --- | --- |
| `GATE-LINT-ADV-01` advisory linter thin slice | Agent tooling | `queued / not scaffolded` | Roadmap Order 2 is complete. Order 3 requires explicit user authorization before scaffold; it must deliver only the read-only nonblocking lint surface. |
