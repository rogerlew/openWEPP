...
| --- | --- | --- | --- |
| [`ASSURE-06` snow/frost flagship authority refresh](work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md) | Scientific assurance | `executing / scaffolded` | Refresh the manuscript against 21K-21N and v7/v126 authority, issue a new exact pending-review root, and run campaign-strength gates. Roger Lew remains accountable report lead and material producer; independent human review and approval cannot be inferred. |
| [`SNOW-COE-STAGE3-MELT-OWNER-AUTHORITY-RECONCILIATION`](work-packages/20260804-snow-coe-stage3-melt-owner-authority-reconciliation-001/package.md) | Snow surface-energy-balance campaign | `held / authority admitted / 21N` | Stage 3 is admitted as the future sole melt owner; current CoE runtime remains byte-identical on implementation hold. Terminal closure depends on the executing accountable `ASSURE-06` refresh. |
