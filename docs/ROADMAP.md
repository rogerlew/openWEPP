...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 1 executing HOLD` | The successor retains canonical Stage 3 surface projection and a prospective WB14 parent/child receipt design. Dual reviews held runtime release pending complete-owner integration, dynamic cadence, production-owner parity, and rollback; the 900/60-second pre-physics guard remains. |
