...
| --- | --- | --- | --- |
| [`SNOW-SURFACE-EB`](planning/snow-surface-energy-balance-roadmap.md) additive sublimation and sub-canopy longwave | Snow/frost science | `EB-04 admitted / ready to scaffold` | EB-03A closes the thermal-provider science limitation with the authoritative Marks/SNOBAL active layer, lower-pack conduction, and mass-dependent substeps. EB-03B closes the unrelated CQR/assurance validation blockers; quick 2109/2109, frost 324/324, and Critical full 2158/2158 pass. Scaffold EB-04 from the frozen B/L/S/LS design. |
