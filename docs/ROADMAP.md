...
| --- | --- | --- | --- |
| [`VEGETATION-RADIATION-INTERCEPTION-CONDUCTANCE-SLICE`](work-packages/20260808-vegetation-radiation-interception-conductance-slice-001/package.md) | Vegetation/ecohydrology architecture | `active / authority partial` | Resolve the conductance authority choice exposed by independent literature review: a bounded empirical Jarvis-Stewart route requires primary-source and parameter/scale adjudication, while the stronger mechanistic sources require a prospective photosynthesis/plant-hydraulics scope expansion. Do not begin contract or Rust implementation until one coherent chain is admitted. |
