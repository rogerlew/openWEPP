...
| [`ASSURANCE-SINGLE-APPROVER-DRAFT-RETURN`](work-packages/20260805-assurance-single-approver-draft-return-001/package.md) | Assurance governance | `scaffolded / authorized` | Align producer eligibility language with the one-approver event model and return the snow/frost flagship to DRAFT through typed immutable history before Stage 3 shadow work. |
...
| [`ASSURE-06` snow/frost flagship authority refresh](work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md) | Scientific assurance | `HOLD-INDEPENDENT-HUMAN-REVIEW` | The v7/v126 and 21K-21N refresh, exact pending-review root, and campaign-strength technical gates pass. Roger Lew is accountable report lead and material producer; distinct human scientific, reproduction/publication, and assurance-steward authority remain pending. Public report count is zero. |
| [`SNOW-COE-STAGE3-MELT-OWNER-AUTHORITY-RECONCILIATION`](work-packages/20260804-snow-coe-stage3-melt-owner-authority-reconciliation-001/package.md) | Snow surface-energy-balance campaign | `held / authority admitted / assurance refreshed` | Stage 3 is admitted as the future sole melt owner; current CoE runtime remains byte-identical on implementation hold. ASSURE-06 has refreshed the stale flagship into pending review; later runtime implementation and cutover remain separately unauthorized. |
...
| `ASSURE-06` | Refresh the snow/frost flagship after the selected science work, then carry the new exact manuscript through accountable human scientific review, approval, release transfer, and publication when authorized. | Refresh against 21K-21N and admitted Stage 3 future melt ownership; rebuild; supersede the obsolete review root; then complete independent scientific and reproduction/publication review, finding disposition, three-role approval, release transfer, and publication gates. | `HOLD-INDEPENDENT-HUMAN-REVIEW` under [`20260805-assure06-snow-frost-flagship-refresh-001`](work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md); technical refresh and exact root pass, public report count remains zero. |
