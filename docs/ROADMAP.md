...
| --- | --- | --- | --- |
| [`JENNINGS-DRYAD-HOURLY-LFS` vendoring](work-packages/20260805-jennings-dryad-hourly-archive-lfs-vendoring-001/package.md) | External observed-data custody | `executing / scaffolded` | Track the exact 1.2 GB CC0 hourly archive through path-scoped Git LFS; prove DOI/version/checksum/pointer/object/consumer integrity without changing observations, science, defaults, or ordinary-CI requirements. |
