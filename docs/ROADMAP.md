...
| `TESTGATE-QUALITY-QUALIFY-01` functional workflow qualification | Test/gate architecture | `next` | Execute Orders 6-7: changed-head TESTGATE first, optional QA second, then selection-only CQR intake. |
