...
| --- | --- | --- | --- |
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `active / Children 1-2 complete / Child 3 LSE runtime next` | Implement and independently verify the default-off LSE runtime shadow, then the real hillslope consumer. Preserve production selectors/defaults and reject PMET demand donation, duplicate custody, and synthetic-owner closure. |
