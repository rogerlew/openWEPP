...
| --- | --- | --- | --- |
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `active / Child 1 complete / Child 2 real-owner shadow` | Execute the remaining separately verified children in order: V8 real-hydrology arbitration, LSE runtime shadow, and a real default-off hillslope consumer. Preserve production selectors/defaults and reject PMET demand donation, duplicate custody, and synthetic-owner closure. |
