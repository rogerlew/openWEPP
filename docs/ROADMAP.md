...
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `held / Children 1-2 complete / Child 3 bounded checkpoint retained` | First expose a persistent, restart-serialized hydrology-owned per-OFE/tile forest-floor or surface-liquid store with authorization/debit, signed condensation credit, infiltration/runoff joins and rollback. Then resume Child 3 and, only after its complete forest endpoint passes, begin Child 4. Production remains unchanged. |
