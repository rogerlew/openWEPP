...
| --- | --- | --- | --- |
| `SNOW-STAGE3-FOUR-SITE-CARRIER-TERM-AUDIT` | Snow surface-energy-balance campaign | `next / prospective result-bearing` | Before execution, freeze identical paired-window support, aggregation, literature comparison ranges, coverage rules, and no-tuning disposition. Independently reconstruct term sums and distributions at Mica Creek, Niwot, Paradise, and Snowbird; separate internal active/lower conduction from the external surface/full-column budget and report the absent snow-ground boundary explicitly. |
