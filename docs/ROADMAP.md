...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-EVOLVING-STATE-CARRIER-PLAUSIBILITY-RECONCILIATION`](work-packages/20260807-snow-stage3-evolving-state-carrier-plausibility-reconciliation-001/package.md) | Snow surface-energy-balance campaign | `executed / persistence HOLD / multifactor or inconclusive` | Attempt 004 closes mass/energy reconstruction across 154 water years with zero truncation or active-state failures, but Paradise WY2015 support fails and wind exposure plus physical magnitude/geometry envelopes remain unresolved. User-supplied GRIDMET references identify nominal 10 m wind and 2 m temperature heights; exact product/cell/aggregation/exposure custody remains the first follow-on. No fixed wind multiplier, fitting, production correction, persistence, or cutover. |
