...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-TERMINAL-MELTOUT-LAND-SURFACE-HANDOFF`](work-packages/20260805-snow-stage3-terminal-meltout-soil-handoff-001/package.md) | Snow surface-energy-balance campaign | `scaffolded / reviewed / authority preflight next` | Phase 1 must admit a tolerance-localized implicit/error-controlled terminal solve, actual-state land-surface selector, infiltration-first liquid handoff, and coupled surface/soil/frost shadow before production edits or seasonal claims. Otherwise close `HOLD`. Direct transfer of snow-computed excess to soil is prohibited. |
