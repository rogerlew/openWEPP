...
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `active HOLD / Child 4 dependency lift executing` | Children 1--3 are complete and bounded Child-4 scheduler execution exists. Execute, in order, the [half-hour forcing authority](work-packages/20260817-snow-free-half-hour-forcing-authority-001/package.md), [forcing adapter](work-packages/20260817-snow-free-half-hour-forcing-adapter-implementation-001/package.md), [persisted-restart authority](work-packages/20260817-direct-hydrology-persisted-restart-authority-001/package.md), and [persisted-restart implementation](work-packages/20260817-direct-hydrology-persisted-restart-implementation-001/package.md), then resume Child 4 and close the campaign only after exact terminal PASS. Production remains unchanged. |
