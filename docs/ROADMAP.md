...
| [`ROOT-ZONE-HYDRAULIC-OWNER-AUTHORITY`](work-packages/20260819-root-zone-hydraulic-owner-authority-001/package.md) | Soil/plant hydraulic boundary | `executing / candidate authority and vectors authored` | Review and verify the selected required stratum root-tissue path and live Brooks--Corey retention/conductivity authority. No defaults or WB14/dxroot aliases. |
