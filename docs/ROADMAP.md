...
| [`SNOW-STAGE3-PRODUCTION-CUTOVER-CAMPAIGN`](work-packages/20260819-snow-stage3-production-cutover-campaign-001/package.md) | Snow + vegetation + land-surface campaign | `active / Child 2B HOLD` | Coupled-time authority is complete. V11 full and unequal support are implemented, but the mandatory 1 ns actual LSE solve requires new tiny-support numerical/state authority. Child 2C and Child 1 remain held. |
| [`C3-WOODY-V11-SEGMENTED-SUPPORT`](work-packages/20260820-c3-woody-v11-segmented-support-001/package.md) | Vegetation transaction authority | `HOLD / Child 2B / tiny-support LSE authority` | V11 authority through v24/v13 and the default-off implementation checkpoint are complete for full and unequal support. Release is held because `SC-LANDSURFACEENERGY-001@3` cannot accept the required 1 ns slab without new integrated/compensated storage authority. |
