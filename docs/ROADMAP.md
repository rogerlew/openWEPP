...
| [`SNOW-FREE-LAND-SURFACE-REAL-HYDROLOGY-INTEGRATION`](work-packages/20260814-snow-free-land-surface-real-hydrology-integration-001/package.md) | Cross-domain land-surface architecture | `active HOLD / persisted-restart implementation executing` | Children 1--3 and both forcing/restart authorities are complete. The [persisted-restart implementation](work-packages/20260817-direct-hydrology-persisted-restart-implementation-001/package.md) is executing; forcing-adapter terminal closure, Child 4, and campaign closure follow only after exact terminal PASS. Production remains unchanged. |
