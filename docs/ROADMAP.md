...
| --- | --- | --- | --- |
| [`SNOW-STAGE3-LEGACY-PREDECESSOR-BRIDGE-RECONCILIATION`](work-packages/20260806-snow-stage3-legacy-predecessor-bridge-reconciliation-001/package.md) | Snow surface-energy-balance campaign | `executing / result-blind scaffold review` | Reproduce the frozen Snowbird schema-v5 `+170.2536089 MJ m^-2` legacy estimator from byte-identical daily source and forcing, isolating source revision, daily reset, first projection, substep transition, and active-conduction lineage against schema v6's `+188.8725288 MJ m^-2`. Only after the bridge closes may the campaign adjudicate the four-site `S<0, F<0, Q>0` pattern. No fitting, physics change, persistence, promotion, or ownership change. |
...
| [`ASSURANCE-SINGLE-APPROVER-DRAFT-RETURN`](work-packages/20260805-assurance-single-approver-draft-return-001/package.md) | Assurance governance | `executing / DRAFT returned / full rerun pending` | The one-approver language and typed immutable return are implemented; the later v129 operator-reconciliation source adoption now binds generation `cee22d5f`. Close after exact-head full correctness and its own terminal evidence pass. |
...
| [`ASSURE-06` snow/frost flagship authority refresh](work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md) | Scientific assurance | `DRAFT / review authority returned` | The v129 operator-reconciliation source remains unpublished at generation `cee22d5f`; active review and approval roots are empty. A separately authorized, exact-subject human review entry is required before any review or approval can resume. Public report count is zero. |
