...
| --- | --- | --- | --- |
| [`RHESSYS-EAST-COAST-COUPLED-VEGETATION-SLICE`](work-packages/20260808-rhessys-east-coast-coupled-vegetation-slice-001/package.md) | Vegetation/ecohydrology architecture | `active / licensed-source audit next` | Inventory pinned MIT-licensed RHESSysEastCoast process/state/call dependencies and all GIS2RHESSys vegetation fields/profiles; then admit a coherent default-off slice supporting existing stratum definition files plus deciduous, evergreen, and explicit mixed multistratum forests. Contract-first gates remain binding; source compatibility is not scientific authority or default eligibility. |
