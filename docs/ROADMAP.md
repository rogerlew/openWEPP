...
| --- | --- | --- | --- |
| `TESTGATE-PLAN-01` mechanical planner and receipt verifier | Test/gate architecture | `next` | Build on the completed schema authority; prove deterministic affected-set selection, risk escalation, execution inventory, receipt identity/reuse, and retained-campaign replay in shadow mode. |
