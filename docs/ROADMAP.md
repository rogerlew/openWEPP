...
| --- | --- | --- | --- |
| [`SNOW-SURFACE-EB`](planning/snow-surface-energy-balance-roadmap.md) additive sublimation and sub-canopy longwave | Snow/frost science | `EB-04T diagnostic complete; EB-05 next` | EB-04T finds the total-failure gate mixed but informative: 11/16 failures measure density/geometry or mixed interception debt. The five timing failures are open controls that test sublimation and block combined-LS promotion, but do not identify canopy-longwave efficacy. LS moves 15 exact primary errors away and leaves one unchanged, without a materiality claim. Preserve EB-04S nonpromotion/default-off, route owning residuals separately, and proceed to assurance. |
