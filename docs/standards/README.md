...
| [testing-and-gate-strategy.md](testing-and-gate-strategy.md) | Canonical test selection and gate lifecycle: increment, campaign, release, risk escalation, receipts, CRAP cadence, assurance currency, and CI lanes | Active |
