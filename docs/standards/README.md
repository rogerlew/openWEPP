...
| [testing-and-gate-strategy.md](testing-and-gate-strategy.md) | Canonical test selection and gate lifecycle: increment, campaign, release, risk escalation, receipts, optional observational quality QA, assurance currency, and CI lanes | Active |
