...
|---|---|---|
| [numerical-solver-architecture.md](numerical-solver-architecture.md) | Production solver single authority, physical-regime dispatch, successor deletion, nonconvergence behavior, and anti-accretion evidence | Active |
...
| [testing-and-gate-strategy.md](testing-and-gate-strategy.md) | Canonical direct validation requirements: increment, campaign, release, risk escalation, evidence reuse, optional observational quality QA, and assurance currency | Active |
