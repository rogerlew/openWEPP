...
Last updated: 2026-08-08 (Codex — RHESSys East Coast authority admission executed-hold; successor remains blocked).
...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `blocked` | Author a follow-on authority package; close residual selected schema/value/state and all Gate 2-3 `AUTH-RHEC-*` gaps | The executed-hold admitted acquisition/schema form only. No complete selected manifest, compatible stand state, or constitutive chain releases successor Rust. |
