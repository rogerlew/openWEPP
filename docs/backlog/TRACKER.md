...
Last updated: 2026-08-08 (Codex — completed the RHESSys East Coast audit; coupled implementation remains authority-blocked).
...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `blocked` | Close required `AUTH-RHEC-001..011` and `AUTH-RHEC-014..016` through reviewed canonical authority | The precursor audit is complete and the successor is prospectively amended, but no coherent constitutive/profile/initializer boundary is admitted. Pinned MIT licensing permits source-aware work; it does not make source behavior or profile data scientific authority. |
