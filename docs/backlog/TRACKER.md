...
Last updated: 2026-08-08 (Codex — admitted vegetation boundary authority and staged the independent implementation concept).
...
| [Canopy mutation peak-runoff discontinuity](20260807-canopy-peak-runoff-discontinuity.md) | `concept` | Promote to defect-closure work package; vendor frozen Hill 106 pair; instrument legacy peak-runoff path | High-priority suspected kernel defect: denser canopy increased the 1986-02-15 Hill 106 peak by 82.7x while runoff volume changed only 1.3%; derived `EffDur` collapsed as a consequence. |
...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `researching` | Resolve conductance authority in [`VEGETATION-RADIATION-INTERCEPTION-CONDUCTANCE-SLICE`](../work-packages/20260808-vegetation-radiation-interception-conductance-slice-001/package.md) | Independent review produced radiation/interception/layer candidates but found no coherent in-scope conductance chain. Primary Jarvis-Stewart/Kelliher sources or a prospective photosynthesis/hydraulics scope expansion are required before contract or Rust work; RHESSys source remains prohibited. |
