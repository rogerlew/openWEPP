...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `staged` | Execute [`VEGETATION-RADIATION-INTERCEPTION-CONDUCTANCE-SLICE`](../work-packages/20260808-vegetation-radiation-interception-conductance-slice-001/package.md) | `SC-VEGETATION-001` admits sanitized provenance, native-stratum semantics, and Stage A/B/C boundaries. The scaffolded first slice must independently admit its constitutive chain before default-off implementation; unresolved RHESSys licensing still blocks direct/code-derived translation. |
