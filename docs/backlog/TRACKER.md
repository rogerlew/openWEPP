...
| [Canopy mutation peak-runoff discontinuity](20260807-canopy-peak-runoff-discontinuity.md) | `complete` | — | [Hourly peak-runoff authority closure](../work-packages/20260809-hourly-peak-runoff-authority-closure-001/package.md) passed: modeled hourly runoff is authoritative, soil-water return retains its hour, public units apply area once, and all 1,088 Topanga mutations completed without an unexplained volume-stable peak discontinuity. |
