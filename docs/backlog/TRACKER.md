...
Last updated: 2026-08-08 (Codex — selected the licensed RHESSys East Coast source-aware vegetation path).
...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `staged` | Complete the licensed source/profile audit and contract-first admission in [`RHESSYS-EAST-COAST-COUPLED-VEGETATION-SLICE`](../work-packages/20260808-rhessys-east-coast-coupled-vegetation-slice-001/package.md) | Pinned MIT-licensed RHESSysEastCoast and GIS2RHESSys sources authorize direct source-aware migration. The target supports existing vegetation definitions and deciduous/evergreen/mixed multistratum forests; profile data and source behavior remain provenance/comparator evidence until scientifically adjudicated. |
