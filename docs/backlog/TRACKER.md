...
| [Canopy mutation peak-runoff discontinuity](20260807-canopy-peak-runoff-discontinuity.md) | `staged` | Reconcile ADR-0036 with the [hourly peak-runoff authority closure](../work-packages/20260809-hourly-peak-runoff-authority-closure-001/package.md) | Runtime and SC-* authority are aligned, but ADR-0036 still names an independent analytical WB16 peak. The package is reopened to remove that contradiction and guard it. |
