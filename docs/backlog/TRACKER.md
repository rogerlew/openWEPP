...
Last updated: 2026-08-08 (Codex — inserted the RHESSys East Coast code-to-literature authority-audit precursor).
...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `staged` | Complete [`RHESSYS-EAST-COAST-CODE-LITERATURE-AUTHORITY-AUDIT`](../work-packages/20260808-rhessys-east-coast-code-literature-authority-audit-001/package.md), then release the queued coupled slice | The active precursor must verify code and all 71 fields/32 profiles against primary literature, close or explicitly block authority gaps, and amend the implementation package. Pinned MIT licensing permits source-aware migration but does not make source behavior or profile data scientific authority. |
