...
| [RHESSys-derived vegetation crate](20260806-rhessys-derived-vegetation-crate.md) | `staged` | Independent constitutive authority and [`VEGETATION-RADIATION-INTERCEPTION-CONDUCTANCE-SLICE`](../ROADMAP.md) | `SC-VEGETATION-001` admits sanitized provenance, native-stratum semantics, and Stage A/B/C boundaries. Future implementation must be independently derived and default-off; unresolved RHESSys licensing still blocks direct/code-derived translation. |
