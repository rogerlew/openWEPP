...
This concept broadens the native-vegetation ET problem recorded historically in
`docs/backlog/20260803-native-vegetation-et-process-model.md` at commit
`06dc722c6`. Native ET remains a primary motivation, but it should be delivered
as part of a coherent vegetation state machine rather than as another
stand-alone demand-partition formula.
...
- Historical native-vegetation ET concept at openWEPP commit `06dc722c6`.
