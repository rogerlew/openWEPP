...
| `attempts/attempt-001.json` | `a221c15800c2b956638d9b9c7c553860833cd74f60ccb8ab525cbc2053be60ba` |
...
The root contains no symlinks. Its unindexed
`execution/.work/reconstruction/cargo-target/**` tree is a disposable build
cache, is excluded from the evidence baseline, and must not be cited or
admitted as retained evidence.
...
This root contains no symlinks and no execution evidence. It remains invalid
and must never be admitted as a retry.
