...
Post-fix before Codex re-check: friction tests 6/6, clippy `-D warnings` 0,
suite 154/154 (no code change — CX fixes are fixture/manifest/ADR text).
ADR-0033 remained **Proposed** at disposition time; Codex ratified the narrowed
scope in `review-codex-recheck.md`.
