# CQR B03R Aggregate Closeout

Execution mode: execute both corrected module packages and aggregate end-to-end.

Autonomy: continue through characterization, decomposition, metrics, review,
verification, and one changed-head recovery qualification. Stop only for a
declared hold boundary or a newly exposed tooling defect requiring canonical
correction.
