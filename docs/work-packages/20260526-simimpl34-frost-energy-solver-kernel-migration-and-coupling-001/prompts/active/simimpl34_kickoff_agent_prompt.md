# SIMIMPL34 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260526-simimpl34-frost-energy-solver-kernel-migration-and-coupling-001/package.md`
...
Files:
- `docs/work-packages/20260526-simimpl34-frost-energy-solver-kernel-migration-and-coupling-001/package.md`
- `docs/work-packages/20260526-simimpl34-frost-energy-solver-kernel-migration-and-coupling-001/artifacts/*.md`
- `docs/work-packages/20260526-simimpl34-frost-energy-solver-kernel-migration-and-coupling-001/prompts/active/simimpl34_kickoff_agent_prompt.md`
...
- Do not modify kernel code until prerequisite contract/test/gate evidence
  from SIMIMPL31/SIMIMPL32/SIMIMPL33 is confirmed in package artifacts.
