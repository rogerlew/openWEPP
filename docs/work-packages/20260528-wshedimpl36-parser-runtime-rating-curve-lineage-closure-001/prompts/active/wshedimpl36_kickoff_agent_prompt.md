# WSHEDIMPL36 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL36 objective end-to-end for declared scope, reconciling
parser/runtime watershed-channel rating-curve control lineage so parser
authority for `icntrl==4` payloads is mirrored at WS10 runtime seed boundaries
with typed fail-closed payload-presence/domain rejection.
