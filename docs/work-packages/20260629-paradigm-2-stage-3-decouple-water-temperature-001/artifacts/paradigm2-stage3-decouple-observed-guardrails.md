...
- Real-run elapsed seconds: `113.352`
...
- Output directory: `target/paradigm2_stage3_decouple_water_temperature`
- JSON artifact: `docs/work-packages/20260629-paradigm-2-stage-3-decouple-water-temperature-001/artifacts/paradigm2-stage3-decouple-observed-guardrails.json`
