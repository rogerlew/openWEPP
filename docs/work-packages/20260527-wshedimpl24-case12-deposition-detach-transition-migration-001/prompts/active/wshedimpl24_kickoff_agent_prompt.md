# WSHEDIMPL24 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL24 objective end-to-end for declared scope,
specifically migrating `case12.for` deposition-to-detachment transition
continuation (`xdemax < x(i)` into `detach.for`) and publishing explicit WS24
transition diagnostics coverage.
