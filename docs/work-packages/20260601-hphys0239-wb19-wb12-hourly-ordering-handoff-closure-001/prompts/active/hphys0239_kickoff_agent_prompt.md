...
- `/workdir/openWEPP/docs/work-packages/20260601-hphys0239-wb19-wb12-hourly-ordering-handoff-closure-001/package.md`
...
Task: execute HPHYS0239 objective end-to-end for declared scope by implementing
Dispatch-Group-B immediate handoff closure for WB19->WB12->WB13 ordering and
stale-surface prevention.
