...
| Ready-audit end-to-end verification | Keep in affected/full, but remove redundant live inventory construction | It protects public verifier ordering and verdict behavior. |
