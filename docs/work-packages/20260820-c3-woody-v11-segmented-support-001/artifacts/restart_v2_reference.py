...
def build():
 parent=sha(b"parent-24"); config=sha(b"configuration"); authority=sha(b"authority-v17"); policy=sha(b"controller")
...
def validate(v):
 ...
 if v.get("schema")!="OPENWEPP_C3_WOODY_V11_RESTART_V2" or v.get("authority_sha256")!=sha(b"authority-v17"): raise ValueError("V11-V2-AUTHORITY")
