...
## Objective
Author and disposition `SC-INFILE-SNOW-001` and its paired openWEPP-owned input
specification for surface `infile-snow` (snow.txt).

## Why This Package Exists
The parser input-surface registry marks `infile-snow` as `planned`.
...
- Author/update canonical parser contract:
  - `docs/specifications/science-contracts/contracts/SC-INFILE-SNOW-001.md`
...
- Update parser input-surface registry disposition for `infile-snow`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-SNOW-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/snow.spec.md`.
- Draft/refresh `SC-INFILE-SNOW-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/snow.spec.md` exists and covers this surface.
- `SC-INFILE-SNOW-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-snow` is updated consistently with disposition.
