# REFACTOR012 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260607-refactor012-openwepp-watershed-orchestrator-runtime-inputs-mechanical-modularization-001/package.md`
...
- `docs/work-packages/20260607-refactor012-openwepp-watershed-orchestrator-runtime-inputs-mechanical-modularization-001/artifacts/*.md`

Task: execute REFACTOR012 objective end-to-end for declared scope.
...
Outputs: updated runtime-input modules and complete package artifacts with
`Static`/`Ran` evidence.
...
- Ensure post-refactor `runtime_inputs.rs` falls below 3000 lines.
