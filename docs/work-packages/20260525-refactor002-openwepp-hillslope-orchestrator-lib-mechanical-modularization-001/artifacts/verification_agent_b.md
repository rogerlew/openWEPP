...
- Executed/observed public surface inventory comparison commands against:
  - `HEAD` pre-refactor `crates/openwepp-hillslope-orchestrator/src/lib.rs`
  - post-refactor module files and facade re-exports.
- Confirmed exported surface families (module/enums/structs/functions) remain present via module re-export structure.
