...
| End-of-grid storage sediment disposition | Ratified **deposit-at-grid-end** (conservative, day-mass-closed, lineage-consistent with the REF-ROUTE-JIMF2023-CARRY defect posture); divergent external precedent (HEC-RAS suspended carry) recorded with the revisit condition. | `INV-ROUTE-020(c)` + `GAP-ROUTE-013` |
