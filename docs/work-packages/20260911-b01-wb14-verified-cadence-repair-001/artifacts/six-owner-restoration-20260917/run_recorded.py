...
SOURCE = Path('/workdir/openwepp-experiments/b01-wb14-cadence/six-owner-restoration-20260917')
...
DEADLINE = datetime.datetime.fromisoformat('2026-09-17T04:29:59.999860+00:00')
...
def main():
    ...
    if SOURCE.name not in {"six-owner-restoration-20260917", "deferred-context-admission-20260916", "native-context-restoration-reader-20260916"}:
