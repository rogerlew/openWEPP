"""Preserve the named terminal diagnostic cut and verify reconstruction from preserved S.
...
S = recorded.SOURCE
R = S.parent / "deferred-context-admission-20260916"
ORIGINAL_R = S.parent / "native-context-restoration-reader-20260916"
Q = S.parent / "snowfree-recorder-candidate-20260915"
DEST = Path("/home/roger/openwepp-experiments/b01-wb14-six-owner-restoration-20260917/terminal-reconstruction-v20")
...
def main():
    ...
    assert tree(r) == "ab221bc5280eaee458be9a6066ba628efe292c0a17394ed1e754ff8f265d8eed"
    original_r, _, _ = recorded.RETAINED.snapshot(ORIGINAL_R)
    assert tree(original_r) == "7c04f52e6cae6327202591b37f0c4e7a5fff3ae34a103255a35c49a3dbdf37ab"
    ...
    incremental = HERE / "terminal-incremental-from-S.patch"
    ...
    identity = {
        ...
        "incremental_base": str(R), "S_tree_sha256": tree(r), "R_tree_sha256": tree(original_r), "Q_tree_sha256": tree(q),
        "reconstructed_source": str(DEST), "reconstructed_tree_sha256": tree(reconstructed),
        "reconstruction_equal": True, "source_and_S_unchanged": True,
        "recipe": "Preserved S plus terminal-incremental-from-S.patch. S is retained R plus deferred-context-admission-20260916/terminal-incremental-from-R.patch; see its verified recovery recipe. Do not apply cumulative patches atop S/R/Q.",
