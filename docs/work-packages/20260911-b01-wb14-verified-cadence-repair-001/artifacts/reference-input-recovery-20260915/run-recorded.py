...
if __name__=='__main__':
    ...
    receipt['execution_input_custody']='input-custody.json'
    receipt['execution_input_custody_sha256']=hashlib.sha256((HERE/'input-custody.json').read_bytes()).hexdigest()
    record=HERE/(name+'.json');record.write_text(json.dumps(receipt,indent=2)+'\n')
    deadline=datetime.datetime(2026,9,15,7,17,45,909342,tzinfo=datetime.timezone.utc)
