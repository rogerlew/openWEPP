...
SOURCE = Path('/home/roger/openwepp-experiments/b01-wb14-integrated-promotion-20260917')
BASE = Path('/workdir/openwepp-experiments/b01-wb14-cadence/six-owner-restoration-20260917')
LOGS = Path('/home/roger/openwepp-experiments/b01-wb14-integrated-evidence-20260917')
DEADLINE = dt.datetime.fromisoformat('2026-09-17T08:34:21.606924+00:00')
SPEC = importlib.util.spec_from_file_location('snapshot_tool', HERE.parent / 'execution-discretion-20260915/run-recorded.py')
...
def main():
    ...
    timeout = min(args.timeout, (DEADLINE - dt.datetime.now(dt.timezone.utc)).total_seconds() - 480)
    if timeout <= 0:
