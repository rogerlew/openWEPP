...
SOURCE = Path('/home/roger/openwepp-experiments/b01-wb14-observer-source-cut02-20260918')
LOGS = Path('/home/roger/openwepp-experiments/b01-wb14-file-reader-evidence-20260918')
DEADLINE = dt.datetime.fromisoformat('2026-09-18T22:42:57.793000+00:00')
...
def main():
    ...
    assert source_hash == '85b8314efcd53ccb8111aa97af1f752ed49a99f46b805e754db5a1b2c7059963'
    source_receipt = LOGS / 'starting-verification.json'
