...
SOURCE = Path('/home/roger/openwepp-experiments/b01-wb14-promotion-controls-20260917')
BASE = Path('/workdir/openwepp-experiments/b01-wb14-cadence/six-owner-restoration-20260917')
LOGS = Path('/home/roger/openwepp-experiments/b01-wb14-promotion-evidence-20260917')
DEADLINE = dt.datetime.fromisoformat('2026-09-17T05:47:04.369604+00:00')
...
def main():
    ...
    timeout = min(args.timeout, (DEADLINE - dt.datetime.now(dt.timezone.utc)).total_seconds() - 900)
    if timeout <= 0:
