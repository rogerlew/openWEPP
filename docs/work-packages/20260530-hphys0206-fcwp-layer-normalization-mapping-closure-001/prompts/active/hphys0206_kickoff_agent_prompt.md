...
Task: execute HPHYS0206 objective end-to-end for declared scope:
close remaining FC/WP residuals by aligning corrected-layer normalization and
mapping authority with baseline-authoritative lineage while preserving
