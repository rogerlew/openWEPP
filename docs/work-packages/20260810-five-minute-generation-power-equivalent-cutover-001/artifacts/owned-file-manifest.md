...
Status: `terminal implementation diff reconciled — 87/87 paths owned`

Evidence mode: `Static + Ran`

The exact terminal package-owned set contains 87 changed or added paths. The
...
definition, and their contract regression tests. The only new public serialized surface is
`openwepp-hillslope-wat-subhourly-v1.0`. HBP and routing files are not changed;
