# SIMIMPL33 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260526-simimpl33-frost-energy-runtime-state-topology-and-seam-closure-001/package.md`
...
Files:
- `docs/work-packages/20260526-simimpl33-frost-energy-runtime-state-topology-and-seam-closure-001/package.md`
- `docs/work-packages/20260526-simimpl33-frost-energy-runtime-state-topology-and-seam-closure-001/artifacts/*.md`
- `docs/work-packages/20260526-simimpl33-frost-energy-runtime-state-topology-and-seam-closure-001/prompts/active/simimpl33_kickoff_agent_prompt.md`
...
- SIMIMPL31 + SIMIMPL32 prerequisites must remain authoritative before
  production edits.
