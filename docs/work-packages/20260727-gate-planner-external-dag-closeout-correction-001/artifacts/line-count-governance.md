...
| `publication.rs` | 2,998 | WARN: descriptor-relative recovery plus deterministic race, interruption, and final-baseline fixtures remain below 3,000 |
...
`publication.rs` is within 2 lines of the mandatory threshold and may not grow
