...
#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerAssemblyObservation {
    pub(crate) kind: M1TrustRegionAssemblyKind,
    pub(crate) base_ordinal: u8,
    pub(crate) entered_core: u16,
    pub(crate) entered_hydraulic_blocks: u16,
    pub(crate) entered_subproblems: u8,
}

#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerProposalObservation {
    pub(crate) base_ordinal: u8,
    pub(crate) proposal_ordinal: u8,
    pub(crate) radius_before: f64,
    pub(crate) radius_after: f64,
    pub(crate) disposition: M1TrustRegionProposalDisposition,
    pub(crate) entered_core: u16,
    pub(crate) entered_hydraulic_blocks: u16,
    pub(crate) entered_subproblems: u8,
}
...
#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerObservation {
    pub(crate) assemblies: Vec<M1TrustRegionControllerAssemblyObservation>,
    pub(crate) proposals: Vec<M1TrustRegionControllerProposalObservation>,
...
pub(crate) enum M1TrustRegionControllerFault {
    TrialDomainAtProposal(u8),
    SelectedSideOwnerErrorAtProposal(u8),
    CoreIncompleteAtProposal(u8),
    NoPredictedReductionAtProposal(u8),
    RadiusExhaustion,
    RawResidualAboveThreshold(usize),
    NormalizedResidualAboveThreshold(usize),
    GovernedStepAboveThreshold(usize),
    MaterializerClosureError,
    CoreCapBoundary,
    HydraulicCapBoundary,
    SvdFaceCapBoundary,
    MaterializationCapBoundary,
}
...
#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerBaseEntry {
    pub(crate) base_ordinal: u8,
    pub(crate) accepted_updates: u8,
    pub(crate) core_entries: u16,
    pub(crate) hydraulic_blocks: u16,
    pub(crate) svd_face_factorizations: u16,
    pub(crate) subproblem_entries: u8,
    pub(crate) natural_assemblies: u8,
    pub(crate) selected_reassemblies: u8,
    pub(crate) predictor_selected_probe_entries: u8,
    pub(crate) final_selected_probe_entries: u8,
    pub(crate) raw_jacobian: [[f64; 21]; 21],
    pub(crate) drainage_base: [f64; 2],
    pub(crate) drainage_scaled_step: [f64; 2],
}

#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerProposalTrace {
    pub(crate) proposal_ordinal: u8,
    pub(crate) disposition: M1TrustRegionProposalDisposition,
    pub(crate) radius_before: f64,
    pub(crate) radius_after: f64,
    ...
    pub(crate) frozen_actual_reduction: f64,
    pub(crate) moving_weight_actual_reduction: f64,
    pub(crate) core_entries: u16,
    pub(crate) hydraulic_blocks: u16,
}
...
#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerTrace {
    pub(crate) base_entries: Vec<M1TrustRegionControllerBaseEntry>,
    pub(crate) proposals: Vec<M1TrustRegionControllerProposalTrace>,
    pub(crate) operation_entries: Vec<M1TrustRegionControllerOperationEntry>,
    pub(crate) final_coordinates: [f64; 2],
    pub(crate) initial_owner_bytes: Vec<u8>,
    pub(crate) accepted_owner_bytes: Vec<u8>,
}

#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerResult {
    pub(crate) trace: M1TrustRegionControllerTrace,
}

#[cfg(all(test, feature = "m1-trust-region-controller-stage"))]
#[derive(Clone, Debug)]
pub(crate) struct M1TrustRegionControllerRefusal {
    pub(crate) refusal_kind: M1TrustRegionRefusalKind,
    pub(crate) trace: M1TrustRegionControllerTrace,
}
