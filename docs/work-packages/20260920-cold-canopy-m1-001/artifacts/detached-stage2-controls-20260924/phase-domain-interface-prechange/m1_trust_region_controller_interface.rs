...
pub(crate) trait M1TrustRegionControllerEvaluator {
    ...
    fn select_phase(
        &mut self,
        current: &M1TrustRegionControllerEvaluation<Self::Payload>,
        scaled_step: [f64; M1_TRUST_REGION_CONTROLLER_DIMENSION],
    ) -> Result<Self::Phase, Self::Error>;
    fn selected_side_probe(
        &mut self,
        phase: &Self::Phase,
        candidate: [f64; M1_TRUST_REGION_CONTROLLER_DIMENSION],
    ) -> Result<(), Self::Error>;
    fn materialize(
        &mut self,
        current: &M1TrustRegionControllerEvaluation<Self::Payload>,
...
pub(crate) struct M1TrustRegionControllerTransition {
    ...
    pub(super) actual_reduction: f64,
    pub(super) rho: f64,
    ...
    pub(super) moving_merit: f64,
    pub(super) dynamic_max_normalized_residual: f64,
...
pub(crate) struct M1TrustRegionControllerRun {
    ...
    pub(super) materialized_coordinates: [f64; M1_TRUST_REGION_CONTROLLER_DIMENSION],
