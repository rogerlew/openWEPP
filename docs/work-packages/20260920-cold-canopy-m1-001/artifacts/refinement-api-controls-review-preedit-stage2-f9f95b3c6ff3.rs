...
fn m1_trust_region_refinement_controller_accounting_observes_all_solves_and_errors() {
    ...
    assert_eq!(changed.accounting_observations[0].stage1_calls, 2);
    assert_eq!(
        changed.accounting_observations[0].entered_svd_factorizations,
        2
    );
    ...
    assert_eq!(partial.accounting_observations[0].stage1_calls, 2);
    assert_eq!(
        partial.accounting_observations[0].entered_svd_factorizations,
        2
    );
    ...
    super::m1_trust_region_controller_run_for_test(&mut run)
