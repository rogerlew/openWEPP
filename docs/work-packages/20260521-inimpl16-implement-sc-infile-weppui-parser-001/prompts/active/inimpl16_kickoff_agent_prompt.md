...
- /workdir/openWEPP/docs/work-packages/20260521-inimpl16-implement-sc-infile-weppui-parser-001/package.md


You are executing `20260521-inimpl16-implement-sc-infile-weppui-parser-001`.

Objectives:
1. Implement `SC-INFILE-WEPPUI-001` for `infile-wepp-ui` with strict/compat behavior.
...
Required outputs:
- Parser/model implementation changes for `infile-wepp-ui`.
