...
## Objective
Implement Wave 2 parser surface `SC-INFILE-WEPPUI-001` for `infile-wepp-ui (wepp_ui.txt)` in a dedicated
...
## Scope
### Included
- Implement strict/compat parser behavior for `infile-wepp-ui (wepp_ui.txt)` per `SC-INFILE-WEPPUI-001`.
...
- Assigned worktree path: `/home/workdir/openWEPP/.worktrees/inimpl16-weppui`
- Assigned branch name: `inimpl16/weppui-parser`
...
## Deliverables
1. Parser implementation for `infile-wepp-ui (wepp_ui.txt)` under assigned module ownership.
...
5. Closeout disposition:
   - `artifacts/inimpl16_disposition.md`
...
## Dependencies
- `/home/workdir/openWEPP/docs/specifications/wepp-input-files/specs/wepp-ui.spec.md`
...
- `/home/workdir/openWEPP/docs/work-packages/20260521-inimpl04-implement-sc-infile-soil-parser-001/`

## Intended Write Set
- `crates/openwepp-input-contract/src/parsers/wepp_ui.rs`
- `crates/openwepp-input-contract/src/parsers/mod.rs`
- `tests/integration/infile_weppui_parser_contract.rs`
- surface-local test fixtures under `tests/fixtures/infile/weppui/**`
...
- Implement parser read/parse/validate logic for `infile-wepp-ui (wepp_ui.txt)`.
...
## Exit Criteria
- Contract-mandated parser behaviors for `infile-wepp-ui (wepp_ui.txt)` are implemented.
