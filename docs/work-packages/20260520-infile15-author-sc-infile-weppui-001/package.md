...
## Objective
Author and disposition `SC-INFILE-WEPPUI-001` and its paired openWEPP-owned input
specification for surface `infile-wepp-ui` (wepp_ui.txt).

## Why This Package Exists
The parser input-surface registry marks `infile-wepp-ui` as `planned`.
...
- Update parser input-surface registry disposition for `infile-wepp-ui`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-WEPPUI-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/wepp-ui.spec.md`.
- Draft/refresh `SC-INFILE-WEPPUI-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/wepp-ui.spec.md` exists and covers this surface.
- `SC-INFILE-WEPPUI-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-wepp-ui` is updated consistently with disposition.
