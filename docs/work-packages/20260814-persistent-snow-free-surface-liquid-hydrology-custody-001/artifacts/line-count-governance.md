...
| `direct_runtime/surface_liquid_ingress.rs` | 2,019 | WARN: canonical parcel identity/order plus ingress construction remain cohesive; future campaign split will move dependency-neutral parcel identity into a dedicated boundary module. |
...
| `direct_runtime/surface_liquid_ingress_context_tests.rs` | 85 | PASS; extracted cadence and public exact-context poison tests. |
...
| `land_surface_energy_shadow/mod.rs` | 2,837 | WARN: cohesive default-off arbitration and contextual receiver construction; independent validation, preflight, error completion and framed hashing are extracted. |
| `land_surface_energy_shadow/receiver_validation.rs` | 2,023 | WARN: self-contained expected topology, global arithmetic/structural preflight, exact later-row context, E010/E011 closure taxonomy and complete framed digest encoding; derived arithmetic preflight is extracted. |
...
| `tests/integration/land_surface_energy_real_hydrology_shadow_contract.rs` | 2,955 | WARN: complete unified public-boundary acceptance and receiver taxonomy poison matrix; raw-attempt hash cases are extracted, and no further cases may be added without another cohesive split. |
