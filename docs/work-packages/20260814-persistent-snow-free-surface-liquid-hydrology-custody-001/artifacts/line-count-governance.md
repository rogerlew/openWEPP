...
| `direct_runtime/surface_liquid_owner.rs` | 2,990 | WARN: cohesive owner schema, canonical persistence, D/A/F reconstruction, failure payloads, and candidate validation; below the mandatory threshold. |
...
| `land_surface_energy_shadow/mod.rs` | 2,582 | WARN: cohesive default-off arbitration plus complete receiver reconstruction; strict helpers are decomposed and a future campaign split may separate receiver closure DTOs. |
