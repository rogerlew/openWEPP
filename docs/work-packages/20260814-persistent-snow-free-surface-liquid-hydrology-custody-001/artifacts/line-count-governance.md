...
| `direct_runtime/surface_liquid_ingress.rs` | 1,927 | PASS: ingress construction and canonical validation precedence; crate-local tests were extracted mechanically. |
| `direct_runtime/surface_liquid_ingress_tests.rs` | 1,227 | PASS; focused ingress, multi-record precedence and attribution tests. |
...
| `direct_runtime/surface_liquid_closure.rs` | 1,362 | PASS; shared projection, exhaustive arithmetic preflight and independent validator. |
