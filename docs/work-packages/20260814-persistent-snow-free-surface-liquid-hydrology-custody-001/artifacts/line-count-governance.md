...
|---|---:|---|
| `direct_runtime/00_core_frames.rs` | 2,834 | WARN: optional-owner attachment delegates complete identity preflight and canonical error completion to the extracted attachment module; complete winter-lane domain validation is shared with the LSE boundary. |
...
| `land_surface_energy_shadow/mod.rs` | 2,976 | WARN: cohesive default-off arbitration, delegated complete winter-domain preflight and category-wide cross-input public precedence; independent validation, checked receiver aggregation, error completion and framed hashing are extracted. No further additions are allowed without cohesive extraction. |
...
| `tests/integration/land_surface_energy_real_hydrology_shadow_contract/snow_preflight_tests.rs` | 442 | PASS; complete snow/albedo/layer/frost/fine-layer and runtime-carry E003-before-E004 public-domain matrix. |
