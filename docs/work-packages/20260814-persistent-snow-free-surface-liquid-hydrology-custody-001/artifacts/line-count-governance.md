...
| `direct_runtime/surface_liquid_ingress.rs` | 2,664 | WARN: ingress construction, canonical validation precedence and independently checked parcel/routing arithmetic; a future campaign split may separate routing joins. |
