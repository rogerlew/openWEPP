...
| `direct_runtime/surface_liquid_owner.rs` | 2,334 | WARN: cohesive new owner schema, canonical persistence, D/A/F, and candidate validation; below the mandatory threshold. |
...
| `direct_runtime/surface_liquid_ingress.rs` | 1,693 | PASS. Independent closure was extracted instead of growing this file further. |
| `land_surface_energy_shadow/mod.rs` | 1,118 | PASS. Receiver validation/application helpers satisfy strict Clippy decomposition. |
| `direct_runtime/surface_liquid_closure.rs` | 686 | PASS; dedicated independent validator. |
