...
| `direct_runtime/surface_liquid_ingress_tests.rs` | 1,653 | PASS; focused ingress, mixed-enthalpy, support-order and source-identity tests. |
...
| `direct_runtime/surface_liquid_closure.rs` | 1,793 | PASS; chronological raw-source/post-mix projection and independent validator. |
