...
| `land_surface_energy_shadow/mod.rs` | 2,836 | WARN: cohesive default-off arbitration with receiver-failure, unified-entry preflight and standalone sealing extracted; no further additions are allowed without cohesive extraction. |
...
| `land_surface_energy_shadow/receiver_validation.rs` | 2,601 | WARN: self-contained expected topology, canonical identity/domain/cardinality/bound preflight, frozen rollback-row validation, E003/E010/E011 owner-specific taxonomy and complete framed digest encoding. |
...
| `land_surface_energy_shadow/unified_entry_preflight.rs` | 473 | PASS; complete input-only configuration/state/request/ingress/WB14/soil-source E001/E002 preflight, one complete attempted hash and computed-snapshot provenance before E003/domain checks or callback execution. |
| `tests/integration/land_surface_energy_real_hydrology_shadow_contract.rs` | 2,770 | WARN: complete unified public-boundary acceptance and receiver taxonomy poison matrix; source binding, raw-attempt hash, precedence, sealed-receiver context and winter-domain cases are extracted, and no further cases may be added without another cohesive split. |
...
| `tests/integration/land_surface_energy_real_hydrology_shadow_contract/snow_preflight_tests.rs` | 586 | PASS; complete snow/albedo/layer/frost/fine-layer count, ordering, uniqueness, reciprocal membership, production-cardinality and runtime-carry E003-before-E004 public-domain matrix. |
