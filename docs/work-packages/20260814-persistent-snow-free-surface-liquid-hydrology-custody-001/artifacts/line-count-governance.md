...
| `land_surface_energy_shadow/mod.rs` | 2,799 | WARN: cohesive default-off arbitration and canonical public precedence; independent validation, checked receiver aggregation, error completion and framed hashing are extracted. |
