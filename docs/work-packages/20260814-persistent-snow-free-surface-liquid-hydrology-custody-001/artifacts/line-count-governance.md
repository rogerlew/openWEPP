...
| `direct_runtime/surface_liquid_ingress.rs` | 2,484 | WARN: ingress construction and independently checked parcel/routing arithmetic; a future campaign split may separate routing joins. |
| `land_surface_energy_shadow/mod.rs` | 2,726 | WARN: cohesive default-off arbitration plus complete receiver reconstruction; strict helpers are decomposed and a future campaign split may separate receiver closure DTOs. |
| `direct_runtime/surface_liquid_closure.rs` | 971 | PASS; dedicated independent validator. |
