...
Status: implementation correction, changed-head metric, and renewed dual review
complete; terminal verification pending.
...
Review A and Review B pass at `dcc86c39`. Terminal verification remains
required. No TESTGATE/global closure claim is made here.
