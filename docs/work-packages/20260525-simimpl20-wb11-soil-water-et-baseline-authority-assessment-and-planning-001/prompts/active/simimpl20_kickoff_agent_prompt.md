# SIMIMPL20 Kickoff Agent Prompt
...
Files:
- `docs/work-packages/20260525-simimpl20-wb11-soil-water-et-baseline-authority-assessment-and-planning-001/package.md`
- `docs/work-packages/20260525-simimpl20-wb11-soil-water-et-baseline-authority-assessment-and-planning-001/artifacts/*.md`
...
substitutions; no production code edits in this planning package.
Autonomy: execute package phases end-to-end and update required artifacts
without requesting additional user direction unless hard-blocked.
Outputs: update package artifacts/disposition for all completed phases.

Mandatory sequencing and governance gates:
- This package is assessment/planning only; do not edit production kernel code.
- Canonical `SC-*` files are authoritative; package artifacts are evidence.
- Follow-on queue proposals must encode contract-first sequence:
  1. contract amendments,
  2. contract-derived tests,
  3. pre-implementation contract gate,
  4. production code edits.
- Baseline migration authority for `wb11_soil_water` and `Ep`/`Es`/`Er` must
  trace to `/workdir/wepp-forest_260430_baseline`; do not invent physics.
