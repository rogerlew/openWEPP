# WSHEDIMPL31 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL31 objective end-to-end for declared scope, specifically
migrating baseline `detach.for` lower-boundary rectangular width mutation
semantics into WS23/WS24 closure and WS10 state writeback projection:
