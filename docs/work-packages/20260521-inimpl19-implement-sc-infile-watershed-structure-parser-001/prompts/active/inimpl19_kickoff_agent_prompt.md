...
- /workdir/openWEPP/docs/work-packages/20260521-inimpl19-implement-sc-infile-watershed-structure-parser-001/package.md


You are executing '20260521-inimpl19-implement-sc-infile-watershed-structure-parser-001'.

Objectives:
1. Implement 'SC-INFILE-WATERSHED-STRUCTURE-001' for 'infile-watershed-structure' with strict/compat behavior.
...
Required outputs:
- Parser/model implementation changes for 'infile-watershed-structure'.
