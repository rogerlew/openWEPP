# WSHEDIMPL33 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL33 objective end-to-end for declared scope, specifically
reconciling parser/runtime `ienslp` lineage so watershed channel parser domain
authority (`ienslp in [1,2]`) is mirrored at WS10 runtime seed validation with
typed fail-closed rejection for out-of-domain values.
