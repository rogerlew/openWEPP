...
Ran:
`cargo llvm-cov clean --workspace && cargo llvm-cov --workspace --ignore-run-fail --lcov --output-path docs/work-packages/20260615-cqr26-lateral-drainage-complexity-001/artifacts/lcov_after.info`

Ran:
`cargo crap --workspace --lcov docs/work-packages/20260615-cqr26-lateral-drainage-complexity-001/artifacts/lcov_after.info --min 0 --format json --output docs/work-packages/20260615-cqr26-lateral-drainage-complexity-001/artifacts/crap_after.json`
...
Ran: the after metrics match the before metrics because no production refactor
was required.
