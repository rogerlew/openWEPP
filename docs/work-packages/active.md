...
| --- | --- | --- |
| B01 WB14 ingress red regression (two-cycle hard stop) | [record](20260911-b01-wb14-verified-cadence-repair-001/package.md#adopted-test-only-checkpoint-b01-wb14-ingress-red-regression) | Three compatibility arms applied; earlier context PASS and exact E008 observation on rejected test design. Final regression uncompiled; two unsuccessful cycles exhausted. Ordinary non-prefix/22 controls unrun; correctness BLOCK, QA HOLD; ZERO runner/collector calls. |
