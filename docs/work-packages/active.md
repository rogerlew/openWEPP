...
| --- | --- | --- |
| B01 WB14 ingress red regression (stopped, incomplete) | [record](20260911-b01-wb14-verified-cadence-repair-001/package.md#adopted-test-only-checkpoint-b01-wb14-ingress-red-regression) | Compiled listing blocked by new import error and three inherited non-exhaustive matches in protected tests. No tests/context checks/expected-red executed. Failed cut preserved; correctness BLOCK and QA HOLD. ZERO runner/collector calls; broader cadence HOLD. |
