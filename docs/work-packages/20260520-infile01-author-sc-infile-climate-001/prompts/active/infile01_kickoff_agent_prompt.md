...
- /workdir/openWEPP/docs/work-packages/20260520-infile01-author-sc-infile-climate-001/package.md


You are executing 20260520-infile01-author-sc-infile-climate-001.

Objectives:
1. Author/update `docs/specifications/wepp-input-files/specs/climate-file.spec.md` with openWEPP-owned parser specification.
2. Author/update `SC-INFILE-CLIMATE-001` under canonical contract location.
...
6. Update registry status for `infile-climate-cli` consistently with disposition.
