...
## Objective
Author and disposition `SC-INFILE-TC-001` and its paired openWEPP-owned input
specification for surface `infile-channel-tc` (tc.txt).

## Why This Package Exists
The parser input-surface registry marks `infile-channel-tc` as `planned`.
...
- Author/update canonical specification:
  - `docs/specifications/wepp-input-files/specs/tc.spec.md`
...
- Update parser input-surface registry disposition for `infile-channel-tc`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-TC-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-TC-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-TC-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-TC-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-TC-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-TC-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/tc.spec.md`.
- Draft/refresh `SC-INFILE-TC-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/tc.spec.md` exists and covers this surface.
- `SC-INFILE-TC-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-channel-tc` is updated consistently with disposition.
