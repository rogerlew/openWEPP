# HPHYS0251 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260602-hphys0251-swu-root-uptake-stress-closure-001/package.md`
...
- package artifacts under `docs/work-packages/20260602-hphys0251-swu-root-uptake-stress-closure-001/`

Task: execute package objective end-to-end for declared scope.

Constraints: contract-first sequencing; canonical SC authority; baseline
provenance from `/workdir/wepp-forest_260430_baseline/src/swu.for` at
`dac3c950d8b16cc73774bf5ce2e7e11f80baac70`; typed guards; no silent invalid
...
including dual reviews, dual verification, targeted H1/H13/H39 diagnostics,
full `H1..H39` metrics, and HOLD/GO disposition.
