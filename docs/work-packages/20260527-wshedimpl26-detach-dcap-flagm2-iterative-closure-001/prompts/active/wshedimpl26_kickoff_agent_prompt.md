# WSHEDIMPL26 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL26 objective end-to-end for declared scope, specifically
migrating baseline-authoritative `dcap(flagm=2)` iterative closure behavior and
recording explicit residual `chnero/chnrt/detach` branch-obligation mapping.
