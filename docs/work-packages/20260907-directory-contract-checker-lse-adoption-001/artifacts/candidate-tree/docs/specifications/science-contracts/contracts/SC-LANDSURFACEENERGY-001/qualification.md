...
|---|---|---|---|
| interface.md#interface | all identity/qualification checks | scope and claim limits | whole mechanism chapter |
| dependency-replay.md#dependency-replay | scientific replay/coverage/result claims | graph/custody/errors/forced-complete proof | whole mechanism chapter |
| nonlinear-solve.md#nonlinear-solve | solver scientific result claims | ordered canonical solver | whole mechanism chapter |
