...
|---|---|---|---|
| interface.md#interface | all replay review | authority versus activation | whole mechanism chapter |
| nonlinear-solve.md#nonlinear-solve | all replay correctness | canonical stencils, leaf reuse and errors | whole mechanism chapter |
| surface-energy.md#surface-energy | all replay correctness | longwave/turbulent evaluator dependencies | whole mechanism chapter |
| water-vapor.md#water-vapor | routing/error-order review | liquid chronology | whole mechanism chapter |
| qualification.md#qualification | qualification/admission or experiment review | historical versus EXP-R/PC1/SG1 limits | whole mechanism chapter |
