# CQR Nightly Batch 02 Target 08 Kickoff
...
Required-reading budget: `~120 KiB`, `OK`; map:
...
`crates/openwepp-topology/src/lib.rs` end-to-end. Reduce every eligible
...
- Preserve topology fixture grammar, typed errors, message IDs, graph/reference
...
- Preserve statement order and short-circuit behavior.
