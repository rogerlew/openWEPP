#!/usr/bin/env python3
"""Run the narrow active-plain target-dx fine-reference hold-lift ladder."""
...
RUN_ROOT = ARTIFACTS / "fine-reference-runs"
SUMMARY_JSON = ARTIFACTS / "fine-reference-summary.json"
SUMMARY_MD = ARTIFACTS / "fine-reference-summary.md"
