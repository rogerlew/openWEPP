...
## Objective
Implement Wave 1 parser surface `SC-INFILE-CLIMATE-001` for `infile-climate-cli (.cli)` in a dedicated
...
## Scope
### Included
- Implement strict/compat parser behavior for `infile-climate-cli (.cli)` per `SC-INFILE-CLIMATE-001`.
...
- Assigned worktree path: `/home/workdir/openWEPP/.worktrees/inimpl05-climate`
- Assigned branch name: `inimpl05/climate-parser`
...
## Deliverables
1. Parser implementation for `infile-climate-cli (.cli)` under assigned module ownership.
...
- `/home/workdir/openWEPP/docs/specifications/science-contracts/contracts/SC-INFILE-CLIMATE-001`
...
- Implement parser read/parse/validate logic for `infile-climate-cli (.cli)`.
...
## Exit Criteria
- Contract-mandated parser behaviors for `infile-climate-cli (.cli)` are implemented.
