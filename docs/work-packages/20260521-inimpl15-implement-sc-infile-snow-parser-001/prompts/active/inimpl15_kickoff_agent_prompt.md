...
- /workdir/openWEPP/docs/work-packages/20260521-inimpl15-implement-sc-infile-snow-parser-001/package.md


You are executing `20260521-inimpl15-implement-sc-infile-snow-parser-001`.

Objectives:
1. Implement `SC-INFILE-SNOW-001` for `infile-snow` with strict/compat behavior.
...
Required outputs:
- Parser/model implementation changes for `infile-snow`.
