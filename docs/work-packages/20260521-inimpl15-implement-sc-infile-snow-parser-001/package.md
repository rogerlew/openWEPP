...
## Objective
Implement Wave 2 parser surface `SC-INFILE-SNOW-001` for `infile-snow (snow.txt)` in a dedicated
...
## Scope
### Included
- Implement strict/compat parser behavior for `infile-snow (snow.txt)` per `SC-INFILE-SNOW-001`.
...
- Assigned worktree path: `/home/workdir/openWEPP/.worktrees/inimpl15-snow`
- Assigned branch name: `inimpl15/snow-parser`
...
## Deliverables
1. Parser implementation for `infile-snow (snow.txt)` under assigned module ownership.
...
5. Closeout disposition:
   - `artifacts/inimpl15_disposition.md`
...
## Dependencies
- `/home/workdir/openWEPP/docs/specifications/wepp-input-files/specs/snow.spec.md`
...
- `/home/workdir/openWEPP/docs/work-packages/20260521-inimpl05-implement-sc-infile-climate-parser-001/`

## Intended Write Set
- `crates/openwepp-input-contract/src/parsers/snow.rs`
- `crates/openwepp-input-contract/src/parsers/mod.rs`
- `tests/integration/infile_snow_parser_contract.rs`
- surface-local test fixtures under `tests/fixtures/infile/snow/**`
...
- Implement parser read/parse/validate logic for `infile-snow (snow.txt)`.
...
## Exit Criteria
- Contract-mandated parser behaviors for `infile-snow (snow.txt)` are implemented.
