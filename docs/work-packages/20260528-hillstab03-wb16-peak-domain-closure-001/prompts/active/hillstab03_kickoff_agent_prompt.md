...
- `/workdir/openWEPP/docs/work-packages/20260528-hillstab03-wb16-peak-domain-closure-001/package.md`
...
Task: execute HILLSTAB03 end-to-end by closing `HKERNEL-WB16-PEAK-E-003`
runtime-domain failures with contract-first sequencing, then rerun the broad
