...
Authorized tracked writes are the package tree; `SC-SNOWFREEZE-001`; its
lifecycle index; the new focused contract test; mechanical v126-to-v127
assertions in integration tests; `Cargo.toml` only for that test's explicit
...
No immutable review-event byte is authorized to change.
