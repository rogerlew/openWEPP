# HPHYS0295 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260605-hphys0295-cumulative-storage-budget-ownership-closure-001/package.md`
...
- `Cargo.toml`
- `docs/work-packages/20260605-hphys0295-cumulative-storage-budget-ownership-closure-001/artifacts/*`
- Production WB17/WB18/WB19 files only if diagnostics prove a
  baseline-authoritative owner.
...
snow producer residuals; run dual review and dual verification when tooling
authorization is available, otherwise record the block truthfully.
