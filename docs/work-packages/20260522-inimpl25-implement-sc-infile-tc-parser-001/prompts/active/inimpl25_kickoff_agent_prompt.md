...
- /workdir/openWEPP/docs/work-packages/20260522-inimpl25-implement-sc-infile-tc-parser-001/package.md


You are executing '20260522-inimpl25-implement-sc-infile-tc-parser-001'.

Objectives:
1. Implement 'SC-INFILE-TC-001' for 'infile-tc (tc.txt)' with strict/compat behavior.
...
4. Verify and document applicable Wave 4 decision checks: W4DR-001, W4DR-002, W4DR-003, W4DR-012.
...
Required outputs:
- Parser/model implementation changes for 'infile-tc (tc.txt)'.
