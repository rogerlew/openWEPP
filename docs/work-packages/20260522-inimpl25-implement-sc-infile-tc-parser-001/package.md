...
## Objective
Implement Wave 4 parser surface 'SC-INFILE-TC-001' for 'infile-tc (tc.txt)' in a
...
## Scope
### Included
- Implement strict/compat parser behavior for 'infile-tc (tc.txt)' per 'SC-INFILE-TC-001'.
...
- Capture required Wave 4 decision evidence for: W4DR-001, W4DR-002, W4DR-003, W4DR-012.
...
- Assigned worktree path: '/home/workdir/openWEPP/.worktrees/inimpl25-tc'
- Assigned branch name: 'inimpl25/tc-parser'
...
## Deliverables
1. Parser implementation for 'infile-tc (tc.txt)' under assigned module ownership.
...
5. Closeout disposition:
   - artifacts/inimpl25_disposition.md
...
- surface-local test fixtures under tests/fixtures/infile/tc/**
...
- Map applicable ratified Wave 4 decisions: W4DR-001, W4DR-002, W4DR-003, W4DR-012.

### Phase 1 - Parser Implementation
- Implement parser read/parse/validate logic for 'infile-tc (tc.txt)'.
...
## Exit Criteria
- Contract-mandated parser behaviors for 'infile-tc (tc.txt)' are implemented.
