...
## Objective
Implement Wave 2 parser surface `SC-INFILE-PMETPARA-001` for `infile-pmetpara (pmetpara.txt)` in a dedicated
...
## Scope
### Included
- Implement strict/compat parser behavior for `infile-pmetpara (pmetpara.txt)` per `SC-INFILE-PMETPARA-001`.
...
- Assigned worktree path: `/home/workdir/openWEPP/.worktrees/inimpl11-pmetpara`
- Assigned branch name: `inimpl11/pmetpara-parser`
...
## Deliverables
1. Parser implementation for `infile-pmetpara (pmetpara.txt)` under assigned module ownership.
...
5. Closeout disposition:
   - `artifacts/inimpl11_disposition.md`
...
## Dependencies
- `/home/workdir/openWEPP/docs/specifications/wepp-input-files/specs/pmetpara.spec.md`
...
- `tests/integration/infile_pmetpara_parser_contract.rs`
- surface-local test fixtures under `tests/fixtures/infile/pmetpara/**`
...
- Implement parser read/parse/validate logic for `infile-pmetpara (pmetpara.txt)`.
...
## Exit Criteria
- Contract-mandated parser behaviors for `infile-pmetpara (pmetpara.txt)` are implemented.
