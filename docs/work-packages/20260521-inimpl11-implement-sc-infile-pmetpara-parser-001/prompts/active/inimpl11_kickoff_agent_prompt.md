...
- /workdir/openWEPP/docs/work-packages/20260521-inimpl11-implement-sc-infile-pmetpara-parser-001/package.md


You are executing `20260521-inimpl11-implement-sc-infile-pmetpara-parser-001`.

Objectives:
1. Implement `SC-INFILE-PMETPARA-001` for `infile-pmetpara` with strict/compat behavior.
...
Required outputs:
- Parser/model implementation changes for `infile-pmetpara`.
