...
| B-02 | agent_b | high | accepted | Native authority now requires `imngmt=2`, `jdplt=0`, and `jdstop=0` at schema and runner intake. | schema test and source guard | GSI must advance on every chronological climate day. |
