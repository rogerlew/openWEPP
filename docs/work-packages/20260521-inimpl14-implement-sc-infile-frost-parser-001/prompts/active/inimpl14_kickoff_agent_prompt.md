...
- /workdir/openWEPP/docs/work-packages/20260521-inimpl14-implement-sc-infile-frost-parser-001/package.md


You are executing `20260521-inimpl14-implement-sc-infile-frost-parser-001`.

Objectives:
1. Implement `SC-INFILE-FROST-001` for `infile-frost` with strict/compat behavior.
...
Required outputs:
- Parser/model implementation changes for `infile-frost`.
