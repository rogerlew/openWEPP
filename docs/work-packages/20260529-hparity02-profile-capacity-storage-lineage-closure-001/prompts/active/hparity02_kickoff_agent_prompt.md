...
Task: execute package objective end-to-end for declared scope: close profile
capacity/storage column parity for `ProfileDepth`, `ProfilePorosityCap`,
`ProfileFCStore`, and `ProfileWPStore`.
