# WSHEDIMPL28 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL28 objective end-to-end for declared scope, specifically
migrating baseline-authoritative `chnrt.for` width-boundary semantics in
WS20/WS21 routing lanes (`widb(i-1)` upper boundary and `wida(i)` lower
boundary) and implementing contract-derived WS11 vector closure for this seam.
