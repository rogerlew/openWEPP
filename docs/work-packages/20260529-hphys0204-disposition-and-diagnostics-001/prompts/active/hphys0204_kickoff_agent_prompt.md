...
- `tools/legacy_comparison_suite/**` (only if diagnostics reporting updates are
  required)

Task: execute HPHYS0204 objective end-to-end for declared scope:
run integrated validation/disposition, publish process-authority-first closure
decision, and classify parity residuals as diagnostics.
