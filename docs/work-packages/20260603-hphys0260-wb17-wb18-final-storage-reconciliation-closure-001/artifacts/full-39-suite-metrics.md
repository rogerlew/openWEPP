...
```text
/workdir/wepppy/.venv/bin/python docs/work-packages/20260603-hphys0260-wb17-wb18-final-storage-reconciliation-closure-001/artifacts/hphys0260_diagnostics.py --run-root /tmp/hphys0260_20260603T035231Z
```

Reports:

- Ran: `/tmp/hphys0260_20260603T035231Z/reports/hillslope_semantic_summary.md`.
- Ran: `/tmp/hphys0260_20260603T035231Z/reports/targeted_h1_h7_h39_storage_summary.md`.
...
- Ran: metrics remain unchanged from HPHYS0259 because HPHYS0260 added trace
  evidence propagation and classification, not numerical flux compensation.
