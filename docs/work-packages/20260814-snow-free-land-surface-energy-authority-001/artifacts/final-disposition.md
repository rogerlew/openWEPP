...
It does not implement or activate a runtime, change a selector or default,
publish an output, cut over a production consumer, calibrate parameters, or
make an empirical-validation claim.
