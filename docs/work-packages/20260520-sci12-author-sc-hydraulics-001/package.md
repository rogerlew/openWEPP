...
## Objective
Author and review `SC-HYDRAULICS-001` as a canonical openWEPP science contract for
process-based overland-flow hydraulics, friction partitioning, and shear-boundary behavior.

## Why This Package Exists
SCI-01 identified overland hydraulics as a core process domain in the contract
spine. This package executes the canonical science-contract workflow to
establish `SC-HYDRAULICS-001` with explicit invariants, guard mappings, symbol alias
...
- Define overland hydraulics-domain invariants (`INV-HYDRAULICS-*`) with
  citation anchors.
- Define producer/consumer obligations and overland hydraulics boundary
  dispositions.
...
- Update canonical science-contract registry entry for `SC-HYDRAULICS-001`.

### Explicitly Out of Scope
- Rust kernel implementation changes.
- Contract authoring for non-overland hydraulics domains.
...
1. Canonical contract draft/update:
   - `docs/specifications/science-contracts/contracts/SC-HYDRAULICS-001.md`
2. Artifact bundle:
   - `artifacts/science-contracts/SC-HYDRAULICS-001/contract_ref.md`
   - `artifacts/science-contracts/SC-HYDRAULICS-001/review_agent_a.md`
   - `artifacts/science-contracts/SC-HYDRAULICS-001/review_agent_b.md`
   - `artifacts/science-contracts/SC-HYDRAULICS-001/disposition.md`
   - `artifacts/science-contracts/SC-HYDRAULICS-001/verification_agent_a.md`
   - `artifacts/science-contracts/SC-HYDRAULICS-001/verification_agent_b.md`
...
- `references/50201000/chap10.pdf` (primary)
- Coupled references: `chap4.pdf`, `chap7.pdf`, `chap11.pdf`

## Phase Plan
### Phase 0 - Contract Skeleton and Citation Inventory
- Build/update `SC-HYDRAULICS-001` skeleton with metadata and section scaffolding.
- Capture citation inventory for overland hydraulics boundary constraints.

### Phase 1 - Invariant, Guard, and Boundary Authoring
- Author `INV-HYDRAULICS-*` invariants and boundary dispositions.
...
## Exit Criteria
- Canonical `SC-HYDRAULICS-001` exists and contains required draft sections.
...
- Two verification artifacts are completed with no unresolved high-severity
  findings.
- Registry entry for `SC-HYDRAULICS-001` is present and consistent with contract
  status/maturity.
