...
def collect(binary, output, policy, case, ofes=1, physical=True, timeout=180,
            test=TEST, cases_path=None, checkpoint_day=None, checkpoint=None, resume=None, reuse_run_dir=None, parent_poison_check=False):
...
def main():
    ...
    result = collect(args.binary, args.output, args.policy, args.case, args.ofes,
                     not args.minimal, args.timeout, args.test, args.cases, args.checkpoint_after_day, args.checkpoint, args.resume, args.reuse_run_dir, args.parent_poison_check)
