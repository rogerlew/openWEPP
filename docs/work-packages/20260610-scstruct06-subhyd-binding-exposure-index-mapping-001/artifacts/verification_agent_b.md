...
|---|---|---|
| `SC-SUBHYD-001` edit scope is additive BEI only. | pass | Contract diff adds `## Binding Exposure Index` before `## Gap Register`. |
...
| SCSTRUCT07 handoff is actionable. | pass | Deferred rows have row-specific next evidence gates. |
