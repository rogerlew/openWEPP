...
## Objective
Author and disposition canonical WEPP input specification `SPEC-INFILE-IRRIGATION-FIXEDDATE-001` for
surface `infile-irrigation-fixeddate` (legacy unit 14 fixed-date irrigation file).

## Why This Package Exists
The current canonical specs corpus does not contain `docs/specifications/wepp-input-files/specs/irrigation-fixeddate-file.spec.md` and the
...
- Declare parser-contract handoff mapping to `SC-INFILE-IRRIGATION-FIXEDDATE-001`.

### Explicitly Out of Scope
- Parser contract drafting for `SC-INFILE-IRRIGATION-FIXEDDATE-001`.
...
2. Spec review/disposition bundle:
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/spec_ref.md`
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/review_agent_a.md`
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/review_agent_b.md`
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/disposition.md`
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/verification_agent_a.md`
   - `artifacts/input-specs/SPEC-INFILE-IRRIGATION-FIXEDDATE-001/verification_agent_b.md`
...
- Draft `docs/specifications/wepp-input-files/specs/irrigation-fixeddate-file.spec.md` with complete required section set.
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/irrigation-fixeddate-file.spec.md` exists with all required sections populated.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Handoff mapping to `SC-INFILE-IRRIGATION-FIXEDDATE-001` is explicit.
