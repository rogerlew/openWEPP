# REFACTOR009 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260607-refactor009-openwepp-runner-hillslope-00-runner-intake-and-lane-setup-mechanical-modularization-001/package.md`
...
- `docs/work-packages/20260607-refactor009-openwepp-runner-hillslope-00-runner-intake-and-lane-setup-mechanical-modularization-001/artifacts/*.md`

Task: execute REFACTOR009 objective end-to-end for declared scope.
...
Outputs: updated intake/lane setup modules and complete package artifacts with
`Static`/`Ran` evidence.

Mandatory execution notes:
- Capture pre/post symbol inventories and line counts for touched `.rs` files.
- Ensure post-refactor `00_runner_intake_and_lane_setup.rs` falls below 2000 lines.
