...
## Objective
Author and review `SC-RESIDUE-001` as a canonical openWEPP science contract for
process-based residue partition, decomposition, and management-operation coupling boundaries.

## Why This Package Exists
SCI-01 identified residue management as a core process domain in the contract
spine. This package executes the canonical science-contract workflow to
establish `SC-RESIDUE-001` with explicit invariants, guard mappings, symbol alias
...
- Define residue management-domain invariants (`INV-RESIDUE-*`) with
  citation anchors.
- Define producer/consumer obligations and residue management boundary
  dispositions.
...
- Update canonical science-contract registry entry for `SC-RESIDUE-001`.

### Explicitly Out of Scope
- Rust kernel implementation changes.
- Contract authoring for non-residue management domains.
...
1. Canonical contract draft/update:
   - `docs/specifications/science-contracts/contracts/SC-RESIDUE-001.md`
2. Artifact bundle:
   - `artifacts/science-contracts/SC-RESIDUE-001/contract_ref.md`
   - `artifacts/science-contracts/SC-RESIDUE-001/review_agent_a.md`
   - `artifacts/science-contracts/SC-RESIDUE-001/review_agent_b.md`
   - `artifacts/science-contracts/SC-RESIDUE-001/disposition.md`
   - `artifacts/science-contracts/SC-RESIDUE-001/verification_agent_a.md`
   - `artifacts/science-contracts/SC-RESIDUE-001/verification_agent_b.md`
...
- `references/50201000/chap9.pdf` (primary)
- Coupled references: `chap8.pdf`, `chap5.pdf`, `chap11.pdf`

## Phase Plan
### Phase 0 - Contract Skeleton and Citation Inventory
- Build/update `SC-RESIDUE-001` skeleton with metadata and section scaffolding.
- Capture citation inventory for residue management boundary constraints.

### Phase 1 - Invariant, Guard, and Boundary Authoring
- Author `INV-RESIDUE-*` invariants and boundary dispositions.
...
## Exit Criteria
- Canonical `SC-RESIDUE-001` exists and contains required draft sections.
...
- Two verification artifacts are completed with no unresolved high-severity
  findings.
- Registry entry for `SC-RESIDUE-001` is present and consistent with contract
  status/maturity.
