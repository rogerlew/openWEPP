...
passes 14/14. Cases cover the canonical template shape and batch manifest plus
...
duplicate headings, and an incomplete manifest. Ran: Python byte compilation
