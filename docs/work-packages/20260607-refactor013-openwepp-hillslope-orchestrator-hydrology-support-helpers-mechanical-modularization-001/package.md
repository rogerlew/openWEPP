...
## Objective
Mechanically modularize `crates/openwepp-hillslope-orchestrator/src/hydrology/03_kernel_support_00_support_helpers.rs`
into cohesive hydrology helper modules while preserving API behavior,
typed guard semantics, and existing contract/test outcomes.

## Why This Package Exists
`crates/openwepp-hillslope-orchestrator/src/hydrology/03_kernel_support_00_support_helpers.rs`
is currently a monolithic mixed-concern file at 4842 lines, which exceeds `.rs`
...
by splitting helper concerns into coherent modules without intended semantic
drift.
...
- Conversion of `03_kernel_support_00_support_helpers.rs` into a thin
...
3. Work-package artifacts:
   - `artifacts/refactor013-modularization-plan-report.md`
   - `artifacts/refactor013-public-api-surface-parity-report.md`
   - `artifacts/refactor013-contract-implementation-evidence.md`
   - `artifacts/refactor013-contract-test-implementation-evidence.md`
   - `artifacts/refactor013-preimplementation-contract-gate.md`
   - `artifacts/refactor013-implementation-and-test-evidence.md`
   - `artifacts/refactor013-kernel-profile-compliance-checklist.md`
   - `artifacts/refactor013-line-count-governance-checklist.md`
   - `artifacts/owned-file-manifest.md`
   - `artifacts/gate-results.md`
   - `artifacts/refactor013_disposition.md`
...
## Intended Write Set
- `docs/work-packages/20260607-refactor013-openwepp-hillslope-orchestrator-hydrology-support-helpers-mechanical-modularization-001/**`
...
- Freeze split boundaries by hydrology helper concern.

### Phase B - Mechanical Extraction
- Move cohesive helper sections into dedicated module files.
...
## Exit Criteria
- `03_kernel_support_00_support_helpers.rs` decomposition is complete with
  preserved API and behavior intent.
- `03_kernel_support_00_support_helpers.rs` is reduced below 3000 lines.
- Required gates pass:
  1. `cargo fmt --check`
