# WSHEDIMPL27 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL27 objective end-to-end for declared scope, specifically
migrating baseline-authoritative `enddet.for` bracket-update semantics
(`xdbig/xdsmal` progression) in WS21 case4 enddet closure lanes.
