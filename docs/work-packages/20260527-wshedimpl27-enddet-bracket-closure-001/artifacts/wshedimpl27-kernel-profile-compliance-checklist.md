# WSHEDIMPL27 Kernel Profile Compliance Checklist
...
- [x] Baseline `enddet.for` bracket progression semantics (`xdbig/xdsmal`)
  for WS21 case4 enddet closure lanes migrated.
