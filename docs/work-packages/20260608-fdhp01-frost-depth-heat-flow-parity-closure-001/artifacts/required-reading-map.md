...
Status: scaffolded (initialized at package preparation; executing agent maintains)
...
| docs/defect_closure_execplans.md | Conditional | DC-ExecPlan envelope + HOLD legitimacy | Defect-closure package | Pre-edit | Agent | 2026-06-10 | applies |
| docs/specifications/science-contract-authoring-procedure.md | Conditional | Contract-authoring authority | Contract edits (SC-SNOWFREEZE-001 amendment) | Pre-edit | Agent | 2026-06-10 | applies |
| docs/specifications/science-contracts/kernel-process-contract-profile.md | Conditional | Kernel-profile compliance | Kernel decision-logic edits | Pre-edit | Agent | 2026-06-10 | applies |
| docs/specifications/science-contracts/index.md | Conditional | Contract registry | Contract edits | Pre-edit | Agent | 2026-06-10 | applies |
| docs/decisions/0012-legacy-wepp-260430-baseline-anchor.md | Conditional | Baseline provenance | Legacy parity scope | Pre-edit | Agent | 2026-06-10 | applies |
| docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md | On-demand | Primary mechanism contract (INV-006/-012/-013, GAP-002) | Contract amendment + implementation phases | Phase-local | Agent | 2026-06-10 | ~150 KB; section-targeted |
...
| /workdir/wepp-forest_260430_baseline/src/frostn.for (+ frzng/frznw/frsoil) | On-demand | Legacy heat-flow reference (flag, not target) | Implementation phase | Phase-local | Agent | 2026-06-10 | external to repo budget |
