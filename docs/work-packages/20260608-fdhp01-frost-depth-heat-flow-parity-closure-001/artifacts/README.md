...
- `d3-increment-c2-thaw-arms-20260612.md`: staged Increment C2 landing
  evidence; records the thaw-arm state-machine implementation, local/heavy
  gates, clean `43/43` hourly cohort, retained D2 conservation, and remaining
  freeze-side D3 hold.
...
- `d3-increment-dc1-accounting-repair-20260612.md`: staged Increment Dc1
  landing evidence; records the seasonal lower-front heat, in-hour thaw
  resistance feedback, fine-theta boundary repair, clean local cohort, and
  retained D3 hold.
...
- `pre-implementation-contract-gate.md`: pre-code gate record.
- `implementation-test-evidence.md`: implementation and focused test evidence.
- `kernel-profile-compliance-checklist.md`: profile compliance.
- `owned-file-manifest.md`: touched-file manifest.
- `gate-results.md`: final gate record.
- `line-count-governance-checklist.md`: `.rs` line-count governance disposition.
