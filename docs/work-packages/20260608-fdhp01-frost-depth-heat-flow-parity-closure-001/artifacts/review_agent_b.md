...
|---|---------|-----------------------------------------------------|-----------|
| 1 | Comparator closure overclaim. | accepted; superseded by post-review cohort run | The later Claude review correctly found that unavailable owcmp was not a valid substitute for cohort validation. A fresh release cohort run now shows FDHP01 is executed-hold, and `SC-SNOWFREEZE-001` v55 reopens `GAP-SNOWFREEZE-002`. |
