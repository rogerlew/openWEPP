...
- /workdir/openWEPP/docs/work-packages/20260522-inimpl28-implement-sc-infile-phosphorus-parser-001/package.md


You are executing '20260522-inimpl28-implement-sc-infile-phosphorus-parser-001'.

Objectives:
1. Implement 'SC-INFILE-PHOSPHORUS-001' for 'infile-phosphorus (phosphorus.txt)' with strict/compat behavior.
...
4. Verify and document applicable Wave 4 decision checks: W4DR-001, W4DR-009.
...
Required outputs:
- Parser/model implementation changes for 'infile-phosphorus (phosphorus.txt)'.
