...
## Objective
Implement Wave 4 parser surface 'SC-INFILE-PHOSPHORUS-001' for 'infile-phosphorus (phosphorus.txt)' in a
...
## Scope
### Included
- Implement strict/compat parser behavior for 'infile-phosphorus (phosphorus.txt)' per 'SC-INFILE-PHOSPHORUS-001'.
...
- Capture required Wave 4 decision evidence for: W4DR-001, W4DR-009.
...
- Assigned worktree path: '/home/workdir/openWEPP/.worktrees/inimpl28-phosphorus'
- Assigned branch name: 'inimpl28/phosphorus-parser'
...
## Deliverables
1. Parser implementation for 'infile-phosphorus (phosphorus.txt)' under assigned module ownership.
...
5. Closeout disposition:
   - artifacts/inimpl28_disposition.md
...
- surface-local test fixtures under tests/fixtures/infile/phosphorus/**
...
- Map applicable ratified Wave 4 decisions: W4DR-001, W4DR-009.

### Phase 1 - Parser Implementation
- Implement parser read/parse/validate logic for 'infile-phosphorus (phosphorus.txt)'.
...
## Exit Criteria
- Contract-mandated parser behaviors for 'infile-phosphorus (phosphorus.txt)' are implemented.
