...
with canonical full nextest isolation, and run the package's exact pinned-input
release command through required authority and stability. Do not alter
production, H2637 assertions, fixtures, thresholds, or skip any lane.
