...
## Objective
Author and disposition `SC-INFILE-IRRIGATION-FIXEDDATE-001` and its paired openWEPP-owned input
specification for surface `infile-irrigation-fixeddate` (legacy unit 14 fixed-date irrigation file).

## Why This Package Exists
The parser input-surface registry marks `infile-irrigation-fixeddate` as `planned`.
...
- Update parser input-surface registry disposition for `infile-irrigation-fixeddate`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-FIXEDDATE-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/irrigation-fixeddate-file.spec.md`.
- Draft/refresh `SC-INFILE-IRRIGATION-FIXEDDATE-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/irrigation-fixeddate-file.spec.md` exists and covers this surface.
- `SC-INFILE-IRRIGATION-FIXEDDATE-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-irrigation-fixeddate` is updated consistently with disposition.
