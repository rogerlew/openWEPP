# MOFE10 Kernel Profile Compliance Checklist
...
- [x] Parity lane rerun executed and blocker progression recorded.
- [x] Evidence artifacts include explicit `Static:`/`Ran:` labeling.

Residual:
- [ ] Semantic comparator execution completed.
- Reason: candidate output not emitted due new blocker `HS-RUNTIME-E-050` on
  `oratea`.
