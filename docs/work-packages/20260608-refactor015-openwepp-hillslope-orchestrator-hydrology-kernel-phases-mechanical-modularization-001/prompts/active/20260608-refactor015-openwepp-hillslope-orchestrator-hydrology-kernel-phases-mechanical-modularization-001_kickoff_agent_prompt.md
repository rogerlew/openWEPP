# REFACTOR015 Kickoff Agent Prompt
...
- `docs/work-packages/20260608-refactor015-openwepp-hillslope-orchestrator-hydrology-kernel-phases-mechanical-modularization-001/artifacts/*.md`

Task: execute REFACTOR015 objective end-to-end for declared scope.
...
Outputs: updated kernel-phase modules and complete package artifacts with
`Static`/`Ran` evidence.
...
- Ensure post-refactor `03_kernel_support_01_kernel_phases.rs` falls below 3000 lines.
