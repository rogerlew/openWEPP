# REFACTOR011 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260607-refactor011-openwepp-sim-contract-units-mechanical-modularization-001/package.md`
...
- `docs/work-packages/20260607-refactor011-openwepp-sim-contract-units-mechanical-modularization-001/artifacts/*.md`

Task: execute REFACTOR011 objective end-to-end for declared scope.
...
Outputs: updated unit-registry modules and complete package artifacts with
`Static`/`Ran` evidence.
...
- Ensure post-refactor `units.rs` falls below 3000 lines.
