...
Status: **EXECUTED for the experimental increment; CLOSURE gates for rev-28
ratification remain OPEN** (gate non-deferral: they hold the package, not
...
| **I2 closure: full hybrid Case-4 oracle ladder** | **NOT RUN — OPEN** | required before rev-28 ratification; holds the package |
| **I2 closure: fidelity-tolerance ratification** | **NOT RUN — OPEN** | rev 28 records tolerances UNRATIFIED; holds the package |
