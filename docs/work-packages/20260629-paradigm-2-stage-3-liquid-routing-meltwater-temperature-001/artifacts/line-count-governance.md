...
```text
  ...
  1580 crates/openwepp-hillslope-orchestrator/src/hydrology/support_helpers_mod/runoff_reconciliation.rs
  ...
  3083 docs/specifications/science-contracts/contracts/SC-SNOWFREEZE-001.md
   246 tests/integration/paradigm2_stage3_liquid_routing_meltwater_temperature.rs
   418 tools/snowfreeze_observed/paradigm2_stage3_liquid_routing_meltwater_temperature.py
  9049 total
```
