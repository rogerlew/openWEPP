...
## Objective
Author and disposition `SC-INFILE-LCWB-001` and its paired openWEPP-owned input
specification for surface `infile-channel-lcwb` (lcwb.txt).

## Why This Package Exists
The parser input-surface registry marks `infile-channel-lcwb` as `planned`.
...
- Author/update canonical specification:
  - `docs/specifications/wepp-input-files/specs/lcwb.spec.md`
...
- Update parser input-surface registry disposition for `infile-channel-lcwb`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-LCWB-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/lcwb.spec.md`.
- Draft/refresh `SC-INFILE-LCWB-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/lcwb.spec.md` exists and covers this surface.
- `SC-INFILE-LCWB-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-channel-lcwb` is updated consistently with disposition.
