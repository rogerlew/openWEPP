# SIMIMPL24 Kickoff Agent Prompt
...
- `/workdir/openWEPP/docs/work-packages/20260525-simimpl24-wb11-soil-water-lineage-and-publication-closure-001/package.md`
...
Files:
- `docs/work-packages/20260525-simimpl24-wb11-soil-water-lineage-and-publication-closure-001/package.md`
- `docs/work-packages/20260525-simimpl24-wb11-soil-water-lineage-and-publication-closure-001/artifacts/*.md`
- `docs/work-packages/20260525-simimpl24-wb11-soil-water-lineage-and-publication-closure-001/prompts/active/simimpl24_kickoff_agent_prompt.md`
...
- `tests/**` (SIMIMPL24 lineage/publication closure vectors only)
...
- Before production kernel/output edits, confirm SIMIMPL21/SIMIMPL22/SIMIMPL23
  prerequisite authority, tests, and migration artifacts remain authoritative.
