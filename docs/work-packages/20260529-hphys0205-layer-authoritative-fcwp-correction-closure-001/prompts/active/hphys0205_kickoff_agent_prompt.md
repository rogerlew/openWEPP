...
- `tests/integration/**` (HPHYS0205-specific vectors)

Task: execute HPHYS0205 objective end-to-end for declared scope:
make FC/WP publication remain layer-authoritative while migrating
baseline-corrected lineage into authoritative layer symbols
(`thetfc_####`/`thetdr_####`) and closing the residual introduced in HPHYS0202.
