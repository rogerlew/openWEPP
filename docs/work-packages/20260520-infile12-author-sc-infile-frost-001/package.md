...
## Objective
Author and disposition `SC-INFILE-FROST-001` and its paired openWEPP-owned input
specification for surface `infile-frost` (frost.txt).

## Why This Package Exists
The parser input-surface registry marks `infile-frost` as `planned`.
...
- Author/update canonical specification:
  - `docs/specifications/wepp-input-files/specs/frost.spec.md`
- Author/update canonical parser contract:
  - `docs/specifications/science-contracts/contracts/SC-INFILE-FROST-001.md`
...
- Update parser input-surface registry disposition for `infile-frost`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-FROST-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/frost.spec.md`.
- Draft/refresh `SC-INFILE-FROST-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/frost.spec.md` exists and covers this surface.
- `SC-INFILE-FROST-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-frost` is updated consistently with disposition.
