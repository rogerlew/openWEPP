...
## Objective
Implement Wave 4 parser surface 'SC-INFILE-GWCOEFF-001' for 'infile-gwcoeff (gwcoeff.txt)' in a
...
## Scope
### Included
- Implement strict/compat parser behavior for 'infile-gwcoeff (gwcoeff.txt)' per 'SC-INFILE-GWCOEFF-001'.
...
- Capture required Wave 4 decision evidence for: W4DR-001, W4DR-002, W4DR-007, W4DR-008.
...
- Assigned worktree path: '/home/workdir/openWEPP/.worktrees/inimpl26-gwcoeff'
- Assigned branch name: 'inimpl26/gwcoeff-parser'
...
## Deliverables
1. Parser implementation for 'infile-gwcoeff (gwcoeff.txt)' under assigned module ownership.
...
5. Closeout disposition:
   - artifacts/inimpl26_disposition.md
...
- surface-local test fixtures under tests/fixtures/infile/gwcoeff/**
...
- Map applicable ratified Wave 4 decisions: W4DR-001, W4DR-002, W4DR-007, W4DR-008.

### Phase 1 - Parser Implementation
- Implement parser read/parse/validate logic for 'infile-gwcoeff (gwcoeff.txt)'.
...
## Exit Criteria
- Contract-mandated parser behaviors for 'infile-gwcoeff (gwcoeff.txt)' are implemented.
