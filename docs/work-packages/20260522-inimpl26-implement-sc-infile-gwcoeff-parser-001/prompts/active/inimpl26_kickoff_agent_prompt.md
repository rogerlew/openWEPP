...
- /workdir/openWEPP/docs/work-packages/20260522-inimpl26-implement-sc-infile-gwcoeff-parser-001/package.md


You are executing '20260522-inimpl26-implement-sc-infile-gwcoeff-parser-001'.

Objectives:
1. Implement 'SC-INFILE-GWCOEFF-001' for 'infile-gwcoeff (gwcoeff.txt)' with strict/compat behavior.
...
4. Verify and document applicable Wave 4 decision checks: W4DR-001, W4DR-002, W4DR-007, W4DR-008.
...
Required outputs:
- Parser/model implementation changes for 'infile-gwcoeff (gwcoeff.txt)'.
