# CQR Nightly Batch 02 Target 09 — Slope Parser Prompt
...
Required-reading budget: `126343` bytes, `OK`; map:
...
`crates/openwepp-input-contract/src/parsers/slope.rs` end-to-end. Reduce every
...
commit package hold evidence, and may continue to target 10. Global/process
