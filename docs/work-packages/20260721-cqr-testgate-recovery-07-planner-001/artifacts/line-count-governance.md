...
Static: after characterization and extraction, `planner.rs` is 2,409 lines and
`planner_coverage_tests.rs` is 930 lines. Both remain below the 3,000-line
closure block; only the production host retains the documented WARN.
