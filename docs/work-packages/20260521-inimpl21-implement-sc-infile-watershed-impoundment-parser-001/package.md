...
## Objective
Implement Wave 3 parser surface 'SC-INFILE-WATERSHED-IMPOUNDMENT-001' for 'infile-watershed-impoundment (watershed impoundment (.imp))' in a dedicated
...
## Scope
### Included
- Implement strict/compat parser behavior for 'infile-watershed-impoundment (watershed impoundment (.imp))' per 'SC-INFILE-WATERSHED-IMPOUNDMENT-001'.
...
- Assigned worktree path: '/home/workdir/openWEPP/.worktrees/inimpl21-watershed-impoundment'
- Assigned branch name: 'inimpl21/watershed-impoundment-parser'
...
## Deliverables
1. Parser implementation for 'infile-watershed-impoundment (watershed impoundment (.imp))' under assigned module ownership.
...
5. Closeout disposition:
   - artifacts/inimpl21_disposition.md
...
## Dependencies
- /home/workdir/openWEPP/docs/specifications/wepp-input-files/specs/watershed-impoundment-file.spec.md
...
- surface-local test fixtures under tests/fixtures/infile/watershed_impoundment/**
...
- Implement parser read/parse/validate logic for 'infile-watershed-impoundment (watershed impoundment (.imp))'.
...
## Exit Criteria
- Contract-mandated parser behaviors for 'infile-watershed-impoundment (watershed impoundment (.imp))' are implemented.
