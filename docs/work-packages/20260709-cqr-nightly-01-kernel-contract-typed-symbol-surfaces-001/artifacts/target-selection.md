...
Ran: initial CQR nightly measurement was delegated to `comparator_suite_runner`
and completed before package scaffolding.
...
- Command logs were written under `/home/workdir/openWEPP/artifacts/` by the measurement subagent.
...
|---|---:|---:|---:|
| `crates/openwepp-kernel-contract/src/lib_mod/core_types/01_typed_symbol_surfaces.rs` | 2915.6690906368485 | 3 | 2833.422607238448 |
