...
`docs/work-packages/20260709-cqr-nightly-01-kernel-contract-typed-symbol-surfaces-001/package.md`
...
- `docs/work-packages/20260709-cqr-nightly-01-kernel-contract-typed-symbol-surfaces-001/artifacts/required-reading-map.md`

Conditional:

- Nearest relevant `SC-*` contract only if implementation changes contract
  authority, symbol meaning, output semantics, or runtime guard behavior.
...
Required-reading budget: `101544`, `WARN`; map:
...
- Preserve exact typed symbol strings and dynamic formatting.
