...
## Objective
Author and disposition `SC-INFILE-IRRIGATION-DEPLETION-001` and its paired openWEPP-owned input
specification for surface `infile-irrigation-depletion` (legacy unit 15 depletion irrigation file).

## Why This Package Exists
The parser input-surface registry marks `infile-irrigation-depletion` as `planned`.
...
- Author/update canonical specification:
  - `docs/specifications/wepp-input-files/specs/irrigation-depletion-file.spec.md`
...
- Update parser input-surface registry disposition for `infile-irrigation-depletion`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-IRRIGATION-DEPLETION-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/irrigation-depletion-file.spec.md`.
- Draft/refresh `SC-INFILE-IRRIGATION-DEPLETION-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/irrigation-depletion-file.spec.md` exists and covers this surface.
- `SC-INFILE-IRRIGATION-DEPLETION-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-irrigation-depletion` is updated consistently with disposition.
