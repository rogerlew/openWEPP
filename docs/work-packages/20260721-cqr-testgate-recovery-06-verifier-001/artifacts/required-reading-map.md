...
Static: all applicable required reading was completed. The 323,088-byte budget
...
| `docs/work-packages/20260721-cqr-testgate-recovery-06-verifier-001/package.md` | core | 3,278 | exact scope and gates | this package | READ |
...
| `crates/openwepp-gate-planner/src/verifier.rs` | on-demand | 97,024 | target implementation | production review/edit | READ |
| `crates/openwepp-gate-planner/src/verifier_coverage_tests.rs` | on-demand | 17,695 | test characterization | split created and reviewed | READ |
