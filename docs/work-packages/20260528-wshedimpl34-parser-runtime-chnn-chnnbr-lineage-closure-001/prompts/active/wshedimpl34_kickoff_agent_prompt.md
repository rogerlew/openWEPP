# WSHEDIMPL34 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL34 objective end-to-end for declared scope, specifically
reconciling parser/runtime watershed-channel Manning relation lineage so parser
authority (`chnn >= chnnbr`) is mirrored at WS10 runtime seed validation with
typed fail-closed rejection for `chnn < chnnbr`.
