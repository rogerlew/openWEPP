...
```text
cargo test -p openwepp-climate-runtime-adapter cqr21_shared_climate_runtime_input_error_characterizes  PASS before production refactor
cargo test -p openwepp-climate-runtime-adapter cqr21_shared_climate_runtime_input_error_characterizes  PASS after production refactor
...
markdown-doc lint --path docs/work-packages/README.md --path docs/work-packages/20260615-cqr21-climate-runtime-adapter-complexity-001 --format json  PASS
git diff --check                                                                  PASS
```
