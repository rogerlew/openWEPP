...
- /workdir/openWEPP/docs/work-packages/20260522-inimpl29-implement-sc-infile-lcwb-parser-001/package.md


You are executing '20260522-inimpl29-implement-sc-infile-lcwb-parser-001'.

Objectives:
1. Implement 'SC-INFILE-LCWB-001' for 'infile-lcwb (lcwb.txt)' with strict/compat behavior.
...
4. Verify and document applicable Wave 4 decision checks: W4DR-001, W4DR-003, W4DR-011.
...
Required outputs:
- Parser/model implementation changes for 'infile-lcwb (lcwb.txt)'.
