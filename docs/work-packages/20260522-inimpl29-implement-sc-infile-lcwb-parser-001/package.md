...
## Objective
Implement Wave 4 parser surface 'SC-INFILE-LCWB-001' for 'infile-lcwb (lcwb.txt)' in a
...
## Scope
### Included
- Implement strict/compat parser behavior for 'infile-lcwb (lcwb.txt)' per 'SC-INFILE-LCWB-001'.
...
- Capture required Wave 4 decision evidence for: W4DR-001, W4DR-003, W4DR-011.
...
- Assigned worktree path: '/home/workdir/openWEPP/.worktrees/inimpl29-lcwb'
- Assigned branch name: 'inimpl29/lcwb-parser'
...
## Deliverables
1. Parser implementation for 'infile-lcwb (lcwb.txt)' under assigned module ownership.
...
5. Closeout disposition:
   - artifacts/inimpl29_disposition.md
...
- surface-local test fixtures under tests/fixtures/infile/lcwb/**
...
- Map applicable ratified Wave 4 decisions: W4DR-001, W4DR-003, W4DR-011.

### Phase 1 - Parser Implementation
- Implement parser read/parse/validate logic for 'infile-lcwb (lcwb.txt)'.
...
## Exit Criteria
- Contract-mandated parser behaviors for 'infile-lcwb (lcwb.txt)' are implemented.
