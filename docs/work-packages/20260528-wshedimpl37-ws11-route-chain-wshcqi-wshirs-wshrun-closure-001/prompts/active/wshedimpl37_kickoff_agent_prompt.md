# WSHEDIMPL37 Kickoff Agent Prompt
...
Task: execute WSHEDIMPL37 objective end-to-end for declared scope by migrating
baseline-authoritative WS11 route-chain behavior
(`wshcqi/wshirs/wshrun`) into production watershed runtime lanes with explicit
typed fail-closed guard continuity and contract-derived conformance vectors.
