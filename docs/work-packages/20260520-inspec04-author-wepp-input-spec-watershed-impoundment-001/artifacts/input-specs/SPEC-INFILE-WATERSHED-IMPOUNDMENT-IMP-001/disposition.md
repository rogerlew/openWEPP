...
| `IMP-A-002` | `review_agent_a.md` | medium | amend | Added explicit claim-site `EA-IMP-*` bindings across non-trivial `[DIRECT]` claims in parser grammar, branching, constraints, defaults, invalid examples, and gap rows. | `/home/workdir/openWEPP/docs/specifications/wepp-input-files/specs/watershed-impoundment-file.spec.md:31` | Broad claim-to-source traceability is now explicit at claim site instead of deferred to the evidence index only. |
