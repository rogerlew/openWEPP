...
- /workdir/openWEPP/docs/work-packages/20260520-inspec04-author-wepp-input-spec-watershed-impoundment-001/package.md


You are executing 20260520-inspec04-author-wepp-input-spec-watershed-impoundment-001.

Objectives:
1. Author `docs/specifications/wepp-input-files/specs/watershed-impoundment-file.spec.md` as canonical openWEPP WEPP input specification.
...
6. Declare handoff mapping to parser contract `SC-INFILE-WATERSHED-IMPOUNDMENT-001`.
