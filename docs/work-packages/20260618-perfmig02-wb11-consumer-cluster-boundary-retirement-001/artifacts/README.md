...
- `perfmig02-migration.md` - what was flipped to dense `SymbolId` reads; which materialization was dropped/moved.
- `perfmig02-bit-identity.md` - PERFMIG01 543+8 fixture + H2637 `.hbp`/`wat`/`pass` identity still exact.
