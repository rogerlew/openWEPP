...
- Unrelated pre-existing root artifact scratch files and `usersum/` changes
  remain outside this package and are not part of the write set.
...
| 8 | `crates/openwepp-runner/src/errors.rs` | `402.768` | `6` | `192.899` |
...
- Deduplicated total excess CRAP: `504.9508413968741`.
- Deduplicated functions above CRAP `30`: `7`.
- Max CRAP: `296.51689035535117`.
