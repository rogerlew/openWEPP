...
## Objective
Author and disposition `SC-INFILE-MANAGEMENT-001` and its paired openWEPP-owned input
specification for surface `infile-management-man` (.man).

## Why This Package Exists
The parser input-surface registry marks `infile-management-man` as `planned`.
...
- Update parser input-surface registry disposition for `infile-management-man`.
...
3. Review/disposition artifact bundle:
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/contract_ref.md`
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/review_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/review_agent_b.md`
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/disposition.md`
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/verification_agent_a.md`
   - `artifacts/parser-contracts/SC-INFILE-MANAGEMENT-001/verification_agent_b.md`
...
- Draft/refresh `docs/specifications/wepp-input-files/specs/plant-file.spec.md`.
- Draft/refresh `SC-INFILE-MANAGEMENT-001` with required section set, propagation map,
...
## Exit Criteria
- `docs/specifications/wepp-input-files/specs/plant-file.spec.md` exists and covers this surface.
- `SC-INFILE-MANAGEMENT-001` includes all required parser-contract sections.
...
- Dual verification artifacts are complete with no unresolved high-severity
  findings.
- Registry entry for `infile-management-man` is updated consistently with disposition.
