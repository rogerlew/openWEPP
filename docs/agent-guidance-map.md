...
Paths are scoped explicitly; no new ignore behavior or client-specific exclusion
is introduced. Historical source/evidence stays accessible by its existing path.
