...
| [governance/openwepp-verification-validation-strategy.md](governance/openwepp-verification-validation-strategy.md) | Scientific users and maintainers | V&V philosophy: hard software verification, claim-specific empirical corroboration, decision-owner application fitness, and manuscript-first public reports |
| [governance/scientific-assurance-v2-architecture.md](governance/scientific-assurance-v2-architecture.md) | Scientific users, reviewers, and maintainers | Public report, technical supplement and research objects, internal machine bundle, model narrative, and application-assessment boundaries |
| [governance/scientific-assurance-v2-source-build-contract.md](governance/scientific-assurance-v2-source-build-contract.md) | Maintainers and reproducibility reviewers | Canonical source, identities, dependencies, deterministic builds, review locks, and snapshots |
| [governance/scientific-assurance-dossier-lifecycle.md](governance/scientific-assurance-dossier-lifecycle.md) | Maintainers and scientific reviewers | Report ownership, staging, approval, publication, supersession, release-transfer, and zero-report lifecycle |
| [governance/openwepp-release-procedure-draft.md](governance/openwepp-release-procedure-draft.md) | Maintainers | Draft release runbook and current `ASSURE03-REL-001` automation conflict; candidate assembly remains prohibited |
...
| [standards/scientific-model-evaluation-report.md](standards/scientific-model-evaluation-report.md) | Scientific authors and reviewers | Conventional model-evaluation manuscript structure, quantitative evidence, limitations, reproduction, and review |
| [standards/scientific-assurance-dossier.md](standards/scientific-assurance-dossier.md) | Scientific authors and reviewers | Proposed v1 dossier retirement, interim authoring moratorium, and v2 routing pointer |
