...
| 15 | `SNOW-SURFACE-EB-04T` unchanged-failure attribution and promotion-criterion fitness — **next** | Explain why the 16 forcing-robust failures are unchanged across B/L/S/LS; map each failure family to its governing process, target-mechanism sensitivity, observation operator, and plausible limiting state; then assess whether total-failure reduction was scientifically aligned with longwave/sublimation promotion. | Retained evidence only; no model rerun, tuning, new empirical decision, retroactive EB-04S pass, or default activation. Preserve the frozen EB-04S outcome. Distinguish density/geometry debt from energy/mass-exchange-sensitive timing failures and identify what evidence would support a prospective limited-promotion rule or a new independent-validation campaign. |
| 16 | `SNOW-SURFACE-EB-05` campaign assurance closeout — **deferred pending 04T** | Refresh `ASSURE-06` with the complete iteration, authority reconciliation, admissible retained adjudication, failure attribution, uncertainty, final support/default disposition, and any justified follow-on evidence boundary. | Close after EB-04T determines whether the unchanged-failure gate was mechanistically aligned and recommends supported opt-in, domain-limited prospective validation, broader snow-process correction, or unchanged nonpromotion. Warm-maritime conifer transfer remains withheld. |
...
because failures did not decrease. EB-04T now examines why all 16 failures are
unchanged and whether that requirement was mechanistically aligned; it does not
authorize another calibration/factorial round or change EB-04S. EB-05 follows
that attribution.
