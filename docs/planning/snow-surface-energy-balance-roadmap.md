...
| 21N | [`SNOW-COE-STAGE3-MELT-OWNER-AUTHORITY-RECONCILIATION`](../work-packages/20260804-snow-coe-stage3-melt-owner-authority-reconciliation-001/package.md) — **active / scaffolded / frozen before adjudication** | Decide whether the empirical CoE production claim can be bounded and retained or whether melt ownership must consume existing state-resolved Stage-3 state. | Exact outcome matrix and write set are frozen. Adjudicate authority before the static test; runtime code remains protected. |
