...
| 21N | [`SNOW-COE-STAGE3-MELT-OWNER-AUTHORITY-RECONCILIATION`](../work-packages/20260804-snow-coe-stage3-melt-owner-authority-reconciliation-001/package.md) — **executed / Stage 3 authority admitted / hold-assurance-refresh** | Stage 3 is the admitted future sole melt owner; current CoE remains byte-identical compatibility runtime on implementation hold. Dual science review and focused authority gates pass. | Canonical quick/full correctly reject the stale locked report. Accountable `ASSURE-06` refresh is required before terminal closure; later runtime cutover remains separately unauthorized. |
| 22 | [`ASSURE-06` snow/frost flagship authority refresh](../work-packages/20260805-assure06-snow-frost-flagship-refresh-001/package.md) / `SNOW-SURFACE-EB-05` campaign assurance closeout — **executing / scaffolded** | Refresh the flagship against 21K-21N and admitted v7/v126 authority, then issue a new exact pending-review root. | Distinguish target authority from implemented physics, empirical efficacy, noninferiority, unresolved forcing/process ownership, development-only Snowbird normalization, and default status. Warm-maritime conifer transfer remains withheld; independent human review remains a real authority boundary. |
