...
| 20B | [`SNOW-SURFACE-EB-04W2B`](../work-packages/20260802-snow-surface-eb-04w2b-warm-day-new-snow-activation-closure-001/package.md) warm-day new-snow activation and consumer closure — **executed / HOLD_CROSS_DOMAIN_CORRECTNESS_GATE** | The in-envelope provider/consumer/closure correction and boundary tests pass; the earlier frozen rerun is prerequisite-ineligible and no terminal rerun occurred. | Correct winter hydrology changes the McKenzie burn storm population `227 -> 231` and the hard EROD16 concave-instrument refusals `37 -> 61`, exceeding `20%`. Erosion mechanics/gate authority are outside W2B; no full-profile closure or promotion is admitted. |
| 20C | `SNOW-SURFACE-EB-04W2C` corrected-winter-forcing downstream continuity diagnosis — **authorization needed** | Partition the 24 added EROD16 concave-instrument refusals under corrected warm-mean snowfall, identify numeric/process ownership, and correct mechanics or reconcile the gate only under erosion authority. | Must preserve the snow correction, the EROD16 conservation identity, and the `<=20%` gate unless canonical erosion authority prospectively amends it; return quick/full correctness before W2B resumes. |
| 21 | `SNOW-SURFACE-EB-04X` Harvard depth–SWE geometry/interception investigation — **held after EB-04W2B** | Use paired hardwood/open evidence to test algebraic SWE–density–depth closure, bulk-density trajectory, snowfall-input differences, interception storage/unloading/drip/sublimation, and the residual forest/open energy contrast. | The open lane anchors density/geometry. Only a residual paired forest/open contrast may identify interception or canopy energy. Freeze component-specific longwave, sublimation, and combined-interaction promotion gates before any successor candidate run. |
...
fails the hard downstream EROD16 continuity instrument. Its earlier unchanged
rerun is prerequisite-ineligible; no material albedo-response conclusion is
admitted. EB-04W2C cross-domain resolution must precede any terminal rerun or
EB-04X geometry/interception work. A new result-bearing
