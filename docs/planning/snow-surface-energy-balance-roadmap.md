...
| 7 | `SNOW-SURFACE-EB-04` factorial execution and adjudication — **admitted / ready to scaffold** | Execute the frozen `B/L/S/LS` design across the prespecified lanes and produce human-readable time-series/component figures with Markdown sidecars. | Preserve the frozen coefficients, forcing, lanes, metrics, stop-loss, and closure requirements; report all cells, interactions, failures, uncertainty, and contrary evidence. |
