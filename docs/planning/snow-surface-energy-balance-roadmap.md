...
| 30 | [`SNOW-STAGE3-WIND-SOURCE-CUSTODY-AND-EXPOSURE-AUTHORITY`](../work-packages/20260807-snow-stage3-wind-source-custody-and-exposure-authority-001/package.md) — **next / scaffolded / authority reconciliation** | Admit exact GRIDMET product/version, grid cell, native cadence, aggregation into CLI `w-vl`, nominal 10 m wind height, and site exposure/roughness/displacement authority without fitting or attenuation. | Static neutral analysis predicts about 10% friction-velocity and 21% momentum/heat-product inflation from binding nominal 10 m wind at virtual 5 m geometry—real and correctly directed, but too small alone to resolve a three- to fivefold magnitude concern. Exposure applicability retains the major leverage. |
