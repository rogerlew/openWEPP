...
| 31 | [`SNOW-STAGE3-PARADISE-WY2015-SUPPORT-RESOLUTION`](../work-packages/20260807-snow-stage3-paradise-wy2015-support-resolution-001/package.md) — **active / non-blocking diagnostic resolution** | Resolve the exact dates, terms, statuses, and snow transitions behind 183 unmatched hours, 19 partial hours, and `98.0757 MJ m^-2` omitted magnitude. | Preserve the frozen failure as historical evidence; do not call it noise without causal proof, retune the threshold, or let this single censored row independently block persistence. |
