...
| 4 | [`CANOPY-CAL-04`](../work-packages/20260726-canopy-cal-04-process-calibration-identifiability-001/package.md) — **closed / executed hold**; [`CAL-04A`](../work-packages/20260726-canopy-cal-04a-best-available-evidence-daymet-001/package.md) — **complete / design authority admitted**; [`CAL-04B`](../work-packages/20260727-canopy-cal-04b-calibration-readiness-and-ensemble-execution-001/package.md) — **complete / hold / production path blocked** | CAL-04 preserves the historical pre-candidate authority hold. CAL-04A admits checksum-bound Daymet forcing and the model-result-blind 9,261-vector GSI design. CAL-04B passed its reviewed scaffold gates, then frozen interior vector `GSI-5557` exposed incoherent positive LAI and non-positive post-growth canopy height in the real production consumer. Hubbard did not run and Harvard remains sealed. | Close [`CAL04B-NATIVE-001`](../work-packages/20260727-cal04b-native-gsi-canopy-height-coherence-hold-lift-001/package.md) through its queued contract-first production coupling package, then rerun CAL-04B from a freshly reviewed empty root. Order 4 remains blocked until the deterministic ensemble, independent reconstruction, readiness stages, freeze, and one-time Harvard evaluation pass. |
