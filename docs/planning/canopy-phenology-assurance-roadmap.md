...
| 4 | [`CANOPY-CAL-04`](../work-packages/20260726-canopy-cal-04-process-calibration-identifiability-001/package.md) — **closed / executed hold**; [`CAL-04A`](../work-packages/20260726-canopy-cal-04a-best-available-evidence-daymet-001/package.md) — **complete / design authority admitted**; [`CAL-04B`](../work-packages/20260727-canopy-cal-04b-calibration-readiness-and-ensemble-execution-001/package.md) — **complete / historical hold / production prerequisite resolved** | CAL-04 preserves the historical pre-candidate authority hold. CAL-04A admits checksum-bound Daymet forcing and the model-result-blind 9,261-vector GSI design. [`CAL04B-NATIVE-001`](../work-packages/20260727-cal04b-native-gsi-canopy-height-coherence-hold-lift-001/package.md) and its assurance/TESTGATE correction chain now pass the frozen native replay and exact full workspace profile. Attempt 004 remains evidence, not a calibration result; Hubbard did not run and Harvard remains sealed. | Rerun CAL-04B from a freshly reviewed empty root. Order 4 remains blocked until the deterministic ensemble, independent reconstruction, readiness stages, freeze, and one-time Harvard evaluation pass. |
