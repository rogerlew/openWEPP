...
| 4 | `CANOPY-CAL-04` process calibration and identifiability — authority admission prerequisite [scaffolded](../work-packages/20260726-canopy-cal-04-05-authority-evidence-admission-001/package.md) | Evaluate GSI thresholds, `Bf,max`, `Bs`, `fe`, `xmxlai`, `Cs`, and `bb` in process order after quantitative calibration and independent timing-holdout authority is admitted. | Timing, amplitude, biomass partition, and canopy closure pass without hydrologic fitting. |
| 5 | `CANOPY-CAL-05` litter-source and decomposition adjudication — authority admission prerequisite [scaffolded](../work-packages/20260726-canopy-cal-04-05-authority-evidence-admission-001/package.md) | Test leaf-only CP2, cohort reconstruction, needle turnover, fine-woody input, and decomposition equifinality after compatible source-flux and forest-floor-stock authority is admitted. | Decide whether CP2 is sufficient or a contract amendment is required; no missing source is hidden in decay. |
